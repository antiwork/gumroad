...
const LEGS = [
  ['subscription_card_declined-card-control',         'pr-6738-r4-declined-card-control', 'Your card was declined.',                'attempted to charge your card'],
  ['subscription_card_declined-upi',                  'pr-6738-r4-declined-upi',          'Your payment method needs attention.',   'saved UPI payment method'],
  ['subscription_card_declined_warning-card-control', 'pr-6738-r4-warning-card-control',  'Your card was declined.',                'attempted to charge your card'],
  ['subscription_card_declined_warning-upi',          'pr-6738-r4-warning-upi',           'Your payment method needs attention.',   'saved UPI payment method'],
];
