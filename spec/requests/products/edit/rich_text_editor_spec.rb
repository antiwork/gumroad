...
#   describe "Product tab image attachments" do
#       it "shows a persistent remove button for inserted images" do
#         visit edit_link_path(@product)

#         editor = find("[aria-label='Description']")

#         attach_file file_fixture("smilie.png") do
#           click_on "Insert image"
#         end

#         expect(editor).to have_selector("img")
#         expect(editor).to have_button("Remove") # or your aria-label / test id
#       end

#       it "removes the image when remove button is clicked" do
#         visit edit_link_path(@product)
...
#         find("[aria-label='Remove image']").click

#         expect(editor).to_not have_selector("img")
#       end
#   end
