...
describe "Collabs - Mobile", type: :system, js: true, mobile_view: true do
  ...
  it "shows Sales and Revenue labels in the collab products table footer" do
    create(:product, :is_collab, user: seller)
  ...
  it "shows Members and Revenue labels in the collab memberships table footer" do
    create(:subscription_product, :is_collab, user: seller)
