...
describe "Checkout with Google Pay", :js, type: :system do
  ...
  context "when Google Pay is available" do
    it "shows Google Pay option with brand icon" do
    ...
    it "hides card input fields when Google Pay is selected" do
      visit product.long_url
      add_to_cart(product)
    ...
    it "shows Pay button when Google Pay is selected" do
      visit product.long_url
      add_to_cart(product)
