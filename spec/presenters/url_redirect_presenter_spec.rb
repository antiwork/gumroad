...
describe UrlRedirectPresenter do
  ...
  describe "#download_attributes" do
    it "returns all necessary attributes for the download page" do
      ...
      allow(s3_object).to receive(:presigned_url).and_return("#{AWS_S3_ENDPOINT}/#{S3_BUCKET}/attachments/4768692737035/bb69798a4a694e19a0976390a7e40e6b/original/chapter1.srt?X-Amz-Signature=test")
