...
describe CheckPaymentAddressWorker do
  describe "payment address checks" do
    before do
      ...
      @blocked_email_object = PlatformBlock.create!(object_type: BLOCKED_OBJECT_TYPES[:email], object_value: "fraudulent_email@zombo.com", blocked_at: Time.current)
    end
  ...
  describe "stripe fingerprint checks" do
    ...
    it "flags the user for fraud if a blocked fingerprint object exists" do
      ...
      PlatformBlock.create!(object_type: BLOCKED_OBJECT_TYPES[:charge_processor_fingerprint], object_value: "blocked_fingerprint", blocked_at: Time.current)
    ...
    it "flags if any of the user's fingerprints is blocked" do
      ...
      PlatformBlock.create!(object_type: BLOCKED_OBJECT_TYPES[:charge_processor_fingerprint], object_value: "blocked_fingerprint_xyz", blocked_at: Time.current)
