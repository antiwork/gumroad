  ...
  describe "GET show" do
    ...
    it "renders the page" do
      ...
      expect(props[:users]).to match_array([
                                             hash_including(id: user_1.external_id),
                                             hash_including(id: user_2.external_id),
                                             hash_including(id: user_3.external_id)
                                           ])
    end
    ...
    it "renders the page with pagination" do
      ...
      expect(props[:users]).to contain_exactly(hash_including(id: user_3.external_id))
    end
  end
end
