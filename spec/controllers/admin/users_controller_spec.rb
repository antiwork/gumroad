...
describe Admin::UsersController do
  ...
  describe "GET #purchase_history" do
    ...
    it "filters purchases by product title when search term provided" do
      get :purchase_history, params: { id: user.id, product_title: "Amazing" }
    ...
    it "shows empty state when no purchases match search" do
      get :purchase_history, params: { id: user.id, product_title: "Nonexistent" }
    ...
    it "shows empty state when user has no purchases" do
      ...
      get :purchase_history, params: { id: user_without_purchases.id }
    ...
    it "paginates results when user has many purchases" do
      ...
      get :purchase_history, params: { id: user_with_purchases.id }
