...
describe Admin::PayoutsController, type: :controller, inertia: true do
  ...
  describe "GET show" do
    ...
    it "shows a payout with external_id" do
      sign_in admin_user
      get :show, params: { id: payment.external_id }
  ...
  describe "POST retry" do
    it "retries a failed payout" do
      ...
      sign_in admin_user
      post :retry, params: { id: failed_payment.external_id }
  ...
  describe "POST cancel" do
    it "cancels an unclaimed paypal payout" do
      ...
      sign_in admin_user
      post :cancel, params: { id: unclaimed_payment.external_id }
  ...
  describe "POST fail" do
    it "marks a processing payout as failed" do
      ...
      sign_in admin_user
      post :fail, params: { id: processing_payment.external_id }
  ...
  describe "POST sync" do
    it "syncs a paypal payout" do
      ...
      sign_in admin_user
      post :sync, params: { id: paypal_payment.external_id }
