...
describe UtmLinksController, inertia: true do
  ...
  describe "GET new" do
    ...
    it "renders Analytics/UtmLinks/New with Inertia and correct props" do
      ...
      expect(inertia.props[:form_static]).to be_present
      expect(inertia.props[:form_static][:destination_options]).to be_an(Array)
      expect(inertia.props[:form_static][:short_url]).to be_present
      expect(inertia.props[:form_static][:utm_fields_values]).to be_present
      expect(inertia.props[:form_dynamic]).to be_present
      expect(inertia.props[:utm_link]).to be_nil
    end
