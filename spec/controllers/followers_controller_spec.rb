...
describe FollowersController, inertia: true do
  ...
  context "within consumer area" do
    ...
    describe "POST create" do
      ...
      it "redirects with alert when seller_id is invalid" do
        post :create, params: { email: "follower@example.com", seller_id: "invalid" }
        expect(response).to redirect_to(custom_domain_subscribe_path)
        expect(response).to have_http_status(:see_other)
      ...
      describe "logged in" do
        ...
        it "redirects with notice for confirmed follower" do
