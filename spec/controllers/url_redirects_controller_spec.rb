...
describe UrlRedirectsController do
  ...
  describe "GET 'confirm_page'", inertia: true do
    ...
    it "renders the Inertia component with correct props" do
      ...
      expect(inertia.props[:token]).to be_present
      expect(inertia.props[:redirect_id]).to be_present
      expect(inertia.props[:terms_page_url]).to be_present
      expect(inertia.props[:purchase]).to be_present
      expect(inertia.props[:creator]).to be_present
    end
    ...
    context "when params[:destination] is set" do
      it "includes destination in confirmation_info" do
    ...
    context "when params[:destination] is not set" do
      context "when the purchased product has rich content" do
        ...
        it "defaults destination to 'download_page'" do
          get :confirm_page, params: { id: @url_redirect.token }
