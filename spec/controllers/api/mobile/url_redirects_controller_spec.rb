...
describe Api::Mobile::UrlRedirectsController do
  ...
  describe "GET stream" do
    ...
    it "returns subtitle file information if any subtitle exists" do
      ...
      # Called twice per file, once to generate the expected paths and once in the controller action
      allow(s3_object).to receive(:presigned_url).and_return(subtitle_en_file_path, subtitle_fr_file_path, subtitle_en_file_path, subtitle_fr_file_path)
