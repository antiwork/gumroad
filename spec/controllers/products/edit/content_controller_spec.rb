...
describe Products::Edit::ContentController, inertia: true do
  ...
  describe "GET show" do
    it "renders the Products/Edit/Content Inertia component with expected props" do
  ...
  describe "PUT update" do
    ...
    context "with valid params" do
      it "updates the product and redirects" do
        ...
        expect(response).to redirect_to(products_edit_content_path(product.unique_permalink))
