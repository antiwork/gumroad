...
describe "PurchaseInstallments", :vcr do
  ...
  describe "#product_installments" do
    ...
    describe "mobile api" do
      ...
      it "does not return the creator posts the buyer is entitled to see" do
        ...
        expect(json_data).not_to have_key(:product_updates_data)
        expect(json_data).not_to have_key(:updates_data)
      end
