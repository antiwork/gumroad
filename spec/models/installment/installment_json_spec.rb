...
describe "InstallmentJson"  do
  ...
  describe "#installment_mobile_json_data" do
    before do
      @product_file_1 = create(:product_file, installment: @installment, link: nil)
      @product_file_2 = create(:product_file, installment: @installment, link: nil, url: "#{AWS_S3_ENDPOINT}/#{S3_BUCKET}/attachments/2/original/chapter2.mp4")
