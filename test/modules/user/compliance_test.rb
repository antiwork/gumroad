...
class UserComplianceTest < ActiveSupport::TestCase
  self.described_class = User::Compliance



  context_ User::Compliance do
  context_ "native_payouts_supported?" do
  test "returns true for US, CA, AU, and UK creators" do
  ...
  test "returns true for creators from EU, HK, NZ, SG, and CH" do
  ...
  test "returns true for creators from BG, DK, and HU" do
  ...
  test "returns true for Puerto Rico creators (onboarded as US-side Stripe accounts)" do
        creator = create(:user)
        create(:user_compliance_info_empty, user: creator, country: "Puerto Rico")
        expect(creator.native_payouts_supported?).to be true
      end

  test "returns false for other countries" do
  ...
  test "accepts country_code as optional argument" do
  ...
  context_ "signed_up_from_united_states?" do
      before do
        @us_user = create(:user)
  ...
  test "returns true if from united_kingdom" do
        expect(@uk_user.signed_up_from_united_kingdom?).to be true
        expect(@uk_user.compliance_country_has_states?).to be false
      end
    end

  context_ "signed_up_from_australia?" do
  test "returns true if from australia" do
  ...
  context_ "signed_up_from_hong_kong?" do
  test "returns true if from hong kong" do
  ...
  context_ "signed_up_from_singapore?" do
  test "returns true if from singapore" do
  ...
  context_ "signed_up_from_new_zealand?" do
  test "returns true if from new zealand" do
  ...
  context_ "signed_up_from_switzerland?" do
  test "returns true if from switzerland" do
  ...
  context_ "signed_up_from_bulgaria?" do
  test "returns true if from bulgaria" do
  ...
  context_ "signed_up_from_denmark?" do
  test "returns true if from denmark" do
  ...
  context_ "signed_up_from_czechia?" do
  test "returns true if from Czech Republic" do
  ...
  test "returns true if from Czechia" do
        cz_creator = create(:user)
  ...
  context_ "signed_up_from_bulgaria?" do
  test "returns true if from hungary" do
  ...
  context_ "signed_up_from_south_korea?" do
  test "returns true if from Korea, Republic of" do
  ...
  test "returns true if from South Korea" do
        kr_creator = create(:user)
  ...
  context_ "signed_up_from_united_arab_emirates?" do
  test "returns true if from uae" do
  ...
  context_ "signed_up_from_israel?" do
  test "returns true if from israel" do
  ...
  context_ "signed_up_from_trinidad_and_tobago?" do
  test "returns true if from trinidad and tobago" do
  ...
  context_ "signed_up_from_philippines?" do
  test "returns true if from philippines" do
  ...
  context_ "signed_up_from_argentina?" do
  test "returns true if from argentina" do
  ...
  context_ "signed_up_from_peru?" do
  test "returns true if from peru" do
  ...
  context_ "signed_up_from_europe?" do
  test "returns true if from one of the listed EU countries else false" do
  ...
  context_ "signed_up_from_romania?" do
  test "returns true if from romania" do
        creator = create(:user)
  ...
  context_ "signed_up_from_sweden?" do
  test "returns true if from sweden" do
        creator = create(:user)
  ...
  context_ "signed_up_from_mexico?" do
  test "returns true if from mexico" do
        creator = create(:user)
  ...
  context_ "signed_up_from_india?" do
  test "returns true if from India" do
  ...
  context_ "signed_up_from_pakistan?" do
  test "returns true if from Pakistan" do
  ...
  context_ "signed_up_from_turkiye?" do
  test "returns true if from Turkey" do
  ...
  context_ "signed_up_from_south_africa?" do
  test "returns true if from South Africa" do
  ...
  context_ "signed_up_from_kenya?" do
  test "returns true if from Kenya" do
  ...
  context_ "signed_up_from_egypt?" do
  test "returns true if from Egypt" do
  ...
  context_ "signed_up_from_colombia?" do
  test "returns true if from Colombia" do
  ...
  context_ "signed_up_from_saudi_arabia?" do
  test "returns true if from Saudi Arabia" do
  ...
  context_ "signed_up_from_angola?" do
  test "returns true if from Angola" do
  ...
  context_ "signed_up_from_niger?" do
  test "returns true if from Niger" do
  ...
  context_ "signed_up_from_san_marino?" do
  test "returns true if from San Marino" do
  ...
  context_ "signed_up_from_uruguay?" do
  test "returns true if from Uruguay" do
  ...
  context_ "signed_up_from_botswana?" do
  test "returns true if from Botswana" do
  ...
  context_ "signed_up_from_mauritius?" do
  test "returns true if from Mauritius" do
  ...
  context_ "signed_up_from_madagascar?" do
  test "returns true if from Madagascar" do
  ...
  context_ "country_supports_iban?" do
  test "returns true for a Madagascar creator" do
        mg_creator = create(:user)
        create(:user_compliance_info_empty, user: mg_creator, country: "Madagascar")
        expect(mg_creator.country_supports_iban?).to be true
      end

  test "returns false for a US creator" do
  ...
  context_ "signed_up_from_jamaica?" do
  test "returns true if from Jamaica" do
  ...
  context_ "signed_up_from_antigua_and_barbuda?" do
  test "returns true if from Antigua and Barbuda" do
  ...
  context_ "signed_up_from_namibia?" do
  test "returns true if from Namibia" do
  ...
  context_ "signed_up_from_tanzania?" do
  test "returns true if from Tanzania" do
  ...
  context_ "signed_up_from_rwanda?" do
  test "returns true if from Rwanda" do
  ...
  context_ "signed_up_from_bangladesh?" do
  test "returns true if from Bangladesh" do
  ...
  context_ "signed_up_from_bhutan?" do
  test "returns true if from Bhutan" do
  ...
  context_ "signed_up_from_lao_people_s_democratic_republic?" do
  test "returns true if from Lao People's Democratic Republic" do
  ...
  context_ "signed_up_from_mozambique?" do
  test "returns true if from Mozambique" do
  ...
  context_ "signed_up_from_ethiopia?" do
  test "returns true if from Ethiopia" do
  ...
  context_ "signed_up_from_brunei_darussalam?" do
  test "returns true if from Brunei Darussalam" do
  ...
  context_ "signed_up_from_guyana?" do
  test "returns true if from Guyana" do
  ...
  context_ "signed_up_from_guatemala?" do
  test "returns true if from Guatemala" do
  ...
  context_ "signed_up_from_ecuador?" do
  test "returns true if from Ecuador" do
  ...
  context_ "signed_up_from_ghana?" do
  test "returns true if from Ghana" do
  ...
  context_ "signed_up_from_oman?" do
  test "returns true if from Oman" do
  ...
  context_ "signed_up_from_armenia?" do
  test "returns true if from Armenia" do
  ...
  context_ "signed_up_from_sri_lanka?" do
  test "returns true if from Sri Lanka" do
  ...
  context_ "signed_up_from_kuwait?" do
  test "returns true if from Kuwait" do
  ...
  context_ "signed_up_from_dominican_republic?" do
  test "returns true if from Dominican Republic" do
  ...
  context_ "signed_up_from_uzbekistan?" do
  test "returns true if from Uzbekistan" do
  ...
  context_ "signed_up_from_bolivia?" do
  test "returns true if from Bolivia" do
  ...
  context_ "signed_up_from_moldova?" do
  test "returns true if from Moldova" do
  ...
  context_ "signed_up_from_panama?" do
  test "returns true if from Panama" do
  ...
  context_ "signed_up_from_el_salvador?" do
  test "returns true if from El Salvador" do
  ...
  context_ "signed_up_from_paraguay?" do
  test "returns true if from Paraguay" do
  ...
  context_ "signed_up_from_iceland?" do
  test "returns true if from Iceland" do
  ...
  context_ "signed_up_from_qatar?" do
  test "returns true if from Qatar" do
  ...
  context_ "signed_up_from_bahamas?" do
  test "returns true if from Bahamas" do
  ...
  context_ "signed_up_from_saint_lucia?" do
  test "returns true if from Saint Lucia" do
  ...
  context_ "signed_up_from_cambodia?" do
  test "returns true if from Cambodia" do
  ...
  context_ "signed_up_from_mongolia?" do
  test "returns true if from Mongolia" do
  ...
  context_ "signed_up_from_algeria?" do
  test "returns true if from Algeria" do
  ...
  context_ "signed_up_from_macao?" do
  test "returns true if from Macao" do
  ...
  context_ "signed_up_from_benin?" do
  test "returns true if from Benin" do
  ...
  context_ "signed_up_from_cote_d_ivoire?" do
  test "returns true if from Cote d'Ivoire" do
  ...
  context_ "compliance_country_code" do
  context_ "user with an alive compliance info" do
        before do
          @uk_user = create(:user)
          @user_compliance_info = create(:user_compliance_info_empty, user: @uk_user,
                                                                      first_name: "edgar", last_name: "gumstein", street_address: "123 main", city: "sf", state: "ca",
  ...
  test "returns the country code of the currently active user compliance record" do
          expect(@uk_user.compliance_country_code).to eq(Compliance::Countries::GBR.alpha2)
        end
      end

  context_ "user with no (alive) compliance info" do
        before do
          @uk_user = create(:user)
          @user_compliance_info = create(:user_compliance_info_empty, user: @uk_user,
                                                                      first_name: "edgar", last_name: "gumstein", street_address: "123 main", city: "sf", state: "ca",
  ...
  context_ "user with no compliance info" do
        before do
          @user = create(:user)
        end
