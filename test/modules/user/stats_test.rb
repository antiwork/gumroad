...
class UserStatsTest < ActiveSupport::TestCase
  ...
  test "returns the 1-based rank when the seller is present" do
        allow(PurchaseSearchService).to receive(:search).and_return(response)

        expect(@user.rank(year:)).to eq(2)
      end

  test "returns nil when the seller is not in the top buckets" do
  ...
  test "returns nil and logs when search fails" do
  ...
  context_ "scopes" do
  context_ ".by_sales_revenue" do
  test "excludes not_charged purchases from revenue total" do
  ...
  context_ "analytics data" do
  context_ "fees_cents_for_balances" do
        before do
          @user = create(:user)
  ...
  test "calculates the fees for the given balances properly" do
  ...
  test "calculates the fees for the given balances that includes a refund" do
  ...
  test "calculates the fees correctly for the given balances which include a chargeback" do
          purchase = Purchase.last
  ...
  test "calculates the fees correctly for the given balances which include a chargeback with a partial refund on same purchase" do
          purchase = Purchase.last
  ...
  test "calculates the fees correctly for the given balances which include a refund and a chargeback" do
  ...
  context_ "refunds_cents_for_balances" do
        before do
          @user = create(:user)
          link = create(:product, user: @user, price_cents: 20_00)
          (0..5).each do |weeks_count|
  ...
  test "calculates the refunds when no refunds exist" do
          balance_ids = @user.unpaid_balances.map(&:id)
          refunds_cents_for_balances = @user.refunds_cents_for_balances(balance_ids)
          expect(refunds_cents_for_balances).to eq 0
        end

  test "calculates the refunds for the given balances that includes a full refund" do
          purchase = Purchase.last
          purchase.refund_and_save!(nil)
  ...
  test "calculates the refunds for the given balances that includes a partial refund" do
          purchase = Purchase.last
  ...
  test "calculates the refunds for the given balances that includes a partial refund and a full refund" do
  ...
  context_ "affiliate_credit_cents_for_balances" do
        before do
          seller = create(:user)
  ...
  test "calculates the affiliate credit cents for the given balances properly" do
          balance_ids = @user.unpaid_balances.map(&:id)
  ...
  test "calculates the affiliate fees for the given balances that includes a refund of an old sale" do
          purchase = Purchase.last
  ...
  test "calculates the affiliate fees correctly for the given balances which include a chargeback of an old sale" do
          purchase = Purchase.last
          purchase.stripe_transaction_id = "ch_zitkxbhds3zqlt"
          purchase.save!
          purchase.balance_transactions.each do |bt|
  ...
  test "calculates the affiliate fees correctly for the given balances which include a refund and a chargeback of old sales" do
          purchases = Purchase.last(2)
  ...
  context_ "affiliate_fee_cents_for_balances" do
        before do
          @user = create(:user)
          link = create(:product, user: @user, price_cents: 20_00)
  ...
  test "calculates the affiliate fees for the given balances properly" do
          balance_ids = @user.unpaid_balances.map(&:id)
  ...
  context_ "#chargebacks_cents_for_balances" do
        before do
  ...
  test "calculates chargebacks when no chargebacks exist" do
          balance_ids = @user.unpaid_balances.map(&:id)
  ...
  test "calculates chargebacks with full chargeback" do
          purchase = Purchase.last
  ...
  test "calculates chargebacks with partial chargeback" do
          purchase = Purchase.last
          purchase.refund_partial_purchase!(9_00, @user.id)
          purchase.update!(stripe_transaction_id: "ch_zitkxbhds3zqlt")
          event = build(:charge_event_dispute_formalized, charge_id: "ch_zitkxbhds3zqlt", flow_of_funds: nil)
  ...
  test "calculates chargebacks for multiple balance transactions" do
          purchases = Purchase.last(2)
  ...
  context_ "#credits_cents_for_balances" do
        before do
  ...
  test "does not include the stripe loan repayment credits" do
          balance_ids = @user.unpaid_balances.map(&:id)
  ...
  context_ "#loan_repayment_cents_for_balances" do
        before do
          create(:merchant_account_stripe, user: @user)
          5.times do
  ...
  test "calculates the total loan repayment deduction made by stripe" do
          balance_ids = @user.unpaid_balances.map(&:id)
  ...
  context_ "#paypal_sales_in_duration" do
  test "returns successful sales from the duration" do
  ...
  context_ "#paypal_refunds_in_duration" do
  test "returns refunds from the duration" do
  ...
  context_ "#paypal_sales_chargebacked_in_duration" do
  test "returns the disputes from the duration" do
  ...
  context_ "#paypal_sales_cents_for_duration" do
  test "returns total paypal direct sales amount from the duration" do
  ...
  context_ "#paypal_refunds_cents_for_duration" do
  test "returns total paypal direct refunded amount from the duration" do
  ...
  context_ "#paypal_chargebacked_cents_for_duration" do
  test "returns total paypal direct chargedbacked amount from the duration" do
  ...
  context_ "#paypal_fees_cents_for_duration" do
  test "returns net fees amount from paypal direct sales from the duration" do
  ...
  context_ "#paypal_returned_fees_due_to_refunds_and_chargebacks" do
  test "returns fees amount from paypal direct sales that has been returned during the duration" do
  ...
  context_ "#paypal_taxes_cents_for_duration" do
  test "returns net tax amount from paypal direct sales during the duration" do
  ...
  context_ "#paypal_returned_taxes_due_to_refunds_and_chargebacks" do
  test "returns tax amount from paypal direct sales that has been returned during the duration" do
  ...
  context_ "#paypal_affiliate_fee_cents_for_duration" do
  test "returns net affiliate fee amount from paypal direct sales during the duration" do
  ...
  context_ "#paypal_returned_affiliate_fee_cents_due_to_refunds_and_chargebacks" do
  test "returns affiliate fee amount from paypal direct sales that has been returned during the duration" do
  ...
  context_ "#paypal_sales_data_for_duration" do
  test "returns overall sales stats from paypal direct sales during the duration" do
  ...
  context_ "#paypal_payout_net_cents" do
  test "returns affiliate fee amount from paypal direct sales that has been returned during the duration" do
            paypal_sales_data = @creator.paypal_sales_data_for_duration(start_date: @payout_start_date, end_date: @payout_end_date)
  ...
  context_ "#paypal_revenue_by_product_for_duration" do
  test "returns affiliate fee amount from paypal direct sales that has been returned during the duration" do
  ...
  context_ "Stripe Connect stats" do
        before :each do
          @creator = create(:user)
  ...
  context_ "#stripe_connect_sales_in_duration" do
  test "returns successful sales from the duration" do
  ...
  context_ "#stripe_connect_refunds_in_duration" do
  test "returns refunds from the duration" do
  ...
  context_ "#stripe_connect_sales_chargebacked_in_duration" do
  test "returns the disputes from the duration" do
  ...
  context_ "#stripe_connect_sales_cents_for_duration" do
  test "returns total Stripe Connect direct sales amount from the duration" do
  ...
  context_ "#stripe_connect_refunds_cents_for_duration" do
  test "returns total Stripe Connect direct refunded amount from the duration" do
  ...
  context_ "#stripe_connect_chargebacked_cents_for_duration" do
  test "returns total Stripe Connect direct chargedbacked amount from the duration" do
  ...
  context_ "#stripe_connect_fees_cents_for_duration" do
  test "returns net fees amount from Stripe Connect direct sales from the duration" do
  ...
  context_ "#stripe_connect_returned_fees_due_to_refunds_and_chargebacks" do
  test "returns fees amount from Stripe Connect direct sales that has been returned during the duration" do
  ...
  context_ "#stripe_connect_taxes_cents_for_duration" do
  test "returns net tax amount from Stripe Connect direct sales during the duration" do
  ...
  context_ "#stripe_connect_returned_taxes_due_to_refunds_and_chargebacks" do
  test "returns tax amount from Stripe Connect direct sales that has been returned during the duration" do
  ...
  context_ "#stripe_connect_affiliate_fee_cents_for_duration" do
  test "returns net affiliate fee amount from Stripe Connect direct sales during the duration" do
  ...
  context_ "#stripe_connect_returned_affiliate_fee_cents_due_to_refunds_and_chargebacks" do
  test "returns affiliate fee amount from Stripe Connect direct sales that has been returned during the duration" do
  ...
  context_ "#stripe_connect_sales_data_for_duration" do
  test "returns overall sales stats from Stripe Connect direct sales during the duration" do
  ...
  context_ "#stripe_connect_payout_net_cents" do
  test "returns affiliate fee amount from Stripe Connect direct sales that has been returned during the duration" do
            stripe_connect_sales_data = @creator.stripe_connect_sales_data_for_duration(start_date: @payout_start_date, end_date: @payout_end_date)
  ...
  context_ "#stripe_connect_revenue_by_product_for_duration" do
  test "returns affiliate fee amount from Stripe Connect direct sales that has been returned during the duration" do
  ...
  context_ "active?" do
  test "reports users active who have created links in the last x days" do
        user = create(:user)
        create(:product, user:, created_at: 10.days.ago)
        expect(user.active?(30)).to be(true)
      end

  test "reports users active who have made sales in the last x days" do
        user = create(:user)
  ...
  test "reports users inactive who have not made sales or created links in the last x days" do
        user = create(:user)
        link = create(:product, user:, created_at: 45.days.ago)
  ...
  context_ "#total_amount_made_cents" do
  test "totals all the balances" do
        @user = build(:user)
  ...
  context_ "#products_for_creator_analytics" do
  test "does not include deleted products that don't have sales" do
        product = create(:product, user: @user)
  ...
  test "includes deleted products if they've had sales" do
  ...
  test "does not include archived products that don't have sales" do
        product = create(:product, user: @user)
        expect(@user.products_for_creator_analytics).to eq [product]
  ...
  test "includes archived products if they've had sales" do
  ...
  context_ "#last_weeks_sales" do
  test "only includes successful purchases" do
        product = create(:product, user: @user)
  ...
  context_ "#gross_sales_cents_total_as_seller", :sidekiq_inline, :elasticsearch_wait_for_refresh do
  test "does not take into account refunded or not charged purchases" do
  ...
  test "does take recommended purchase into account" do
        product = create(:product, price_cents: 500, user: @user)
        create(:purchase, link: product)
  ...
  test "takes only purchases that are recommended when specified" do
  ...
  context_ "#active_subscribers?" do
  test "returns true if there are active subscriptions that are being charged using the given charge processor, else false" do
  ...
  test "returns true if there are active subscriptions that are being charged using the given charge processor and merchant account, else false" do
  ...
  test "does not consider free subscriptions" do
        subscription_product = create(:subscription_product, user: @user)
        subscription_using_paypal = create(:subscription, link: subscription_product, user: nil,
                                                          credit_card: create(:credit_card, chargeable: create(:native_paypal_chargeable)))
  ...
  context_ "#active_preorders?" do
  test "returns true if there are preorders that are pending to be charged using the given charge processor, else false" do
  ...
  context_ "#first_sale_created_at_for_analytics" do
  test "returns the created_at of the first sale considered in analytics" do
        product = create(:product, user: @user)
  ...
  context_ "#archived_products_count" do
  context_ "when the user has no products" do
  test "returns 0" do
          expect(@user.archived_products_count).to eq(0)
        end
      end

  context_ "when the user has products" do
        before do
  ...
  test "counts the number of visible archived products" do
          expect(@user.archived_products_count).to eq(1)
        end
      end
    end

  context_ "#lost_chargebacks", :sidekiq_inline, :elasticsearch_wait_for_refresh do
  context_ "when the user has sales" do
        before do
  ...
  test "returns the correct volume and count percentages" do
  ...
  context_ "when the user has no sales" do
  test "returns 'NA' for both volume and count" do
          result = @user.lost_chargebacks
  ...
  context_ "when the user has no paid sales" do
        before do
          create(:purchase, link: create(:product, price_cents: 0, user: @user))
        end

  test "returns '0.0%' for count and 'NA' for volume" do
          result = @user.lost_chargebacks
          expect(result[:volume]).to eq("NA")
  ...
  context_ "#all_sales_count" do
  test "returns the number of unique customers" do
  ...
  context_ "#active_members_count" do
  test "returns the non-unique number of members for all products" do
  ...
  context_ "#monthly_recurring_revenue" do
  test "returns the monthly recurring revenue of all products" do
          product_1 = create(:membership_product, user: @user)
          product_2 = create(:membership_product, user: @user)
          create(:membership_product, user: @user, deleted_at: Time.current)
          create(:membership_product)
