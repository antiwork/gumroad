...
class ModulesObfuscateIdsTest < ActiveSupport::TestCase
  ...
  context_ "numeric encryption of id" do
  ...
  test "raises an error if the id is greater than the max value" do
