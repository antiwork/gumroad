...
class ModulesProductSearchableFilteredSearchTest < ActiveSupport::TestCase



  context_ "Product::Searchable - Filtered search scenarios" do
  context_ "filters adult products for recommendable products" do
      before do
  ...
  test "does not filter products when user_id is given" do
