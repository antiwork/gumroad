...
class PurchasePingNotificationTest < ActiveSupport::TestCase
  self.described_class = Purchase::PingNotification
  self.rspec_metadata = { vcr: true }



  context_ Purchase::PingNotification, :vcr do
  context_ "#payload_for_ping_notification" do
  test "contains the correct resource_name" do
  ...
  test "contains the 'refunded' key if the input resource_name is 'refunded'" do
        purchase = create(:purchase, stripe_refunded: true)
  ...
  test "contains the 'disputed' key set to true if purchase is chargebacked, else false" do
  ...
  test "contains the 'dispute_won' key set to true if purchase is chargeback_reversed, else false" do
  ...
  test "has the correct value for 'discover_fee_charged'" do
  ...
  test "has the correct value for 'can_contact'" do
  ...
  test "has the correct value for 'referrer'" do
  ...
  test "has the correct value for 'gumroad_fee'" do
  ...
  test "has the correct value for 'card'" do
  ...
  test "has the correct link information" do
        purchase = create(:purchase)
  ...
  context_ "when purchase has custom fields set" do
          before do
            purchase.purchase_custom_fields << build(:purchase_custom_field, name: "name", value: "Amy")
          end

  test "includes the purchase's custom fields" do
  ...
  context_ "when the purchase does not have custom fields set" do
  context_ "and is not a subscription purchase" do
  test "does not include the 'custom_fields' key" do
              params = purchase.payload_for_ping_notification(resource_name: ResourceSubscription::SALE_RESOURCE_NAME)
  ...
  context_ "and is a subscription purchase" do
  ...
  test "includes the subscription's 'custom_fields'" do
  ...
  context_ "is_multiseat_license" do
  context_ "when the purchased product is licensed" do
  test "includes the 'is_multiseat_license' key" do
  ...
  context_ "when the purchased product is not licensed" do
  test "does not include the 'is_multiseat_license' key" do
  ...
  context_ "when the product is physical with variants" do
  ...
  test "includes sku_id in the payload" do
