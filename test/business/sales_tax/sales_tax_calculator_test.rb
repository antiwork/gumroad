...
class SalesTaxCalculatorTest < ActiveSupport::TestCase
  self.described_class = SalesTaxCalculator



  context_ SalesTaxCalculator do
  context_ "input validation" do
  ...
  test "returns zero tax if product is physical and in the EU" do
  ...
  test "does not call TaxJar and returns zero tax when customer zip code is invalid" do
          expect_any_instance_of(TaxjarApi).not_to receive(:calculate_tax_for_order)
  ...
  context_ "when collect_tax_is feature flag is off" do
  ...
  context_ "when collect_tax_is feature flag is on" do
          before do
  ...
  context_ "when collect_tax_jp feature flag is off" do
  ...
  context_ "when collect_tax_jp feature flag is on" do
          before do
  ...
  context_ "when collect_tax_nz feature flag is off" do
  ...
  context_ "when collect_tax_nz feature flag is on" do
          before do
  ...
  context_ "when collect_tax_za feature flag is off" do
  ...
  context_ "when collect_tax_za feature flag is on" do
          before do
  ...
  context_ "when collect_tax_ch feature flag is off" do
  ...
  context_ "when collect_tax_ch feature flag is on" do
          before do
  ...
  context_ "United Arab Emirates VAT" do
  ...
  context_ "when collect_tax_ae feature flag is off" do
  ...
  context_ "when collect_tax_ae feature flag is on" do
          before do
  ...
  context_ "when collect_tax_in feature flag is off" do
  ...
  context_ "when collect_tax_in feature flag is on" do
          before do
  ...
  context_ "when collect_tax_bh feature flag is off" do
  ...
  context_ "when collect_tax_bh feature flag is on" do
          before do
  ...
  context_ "when collect_tax_by feature flag is off" do
  ...
  context_ "when collect_tax_by feature flag is on" do
          before do
  ...
  context_ "when collect_tax_cl feature flag is off" do
  ...
  context_ "when collect_tax_cl feature flag is on" do
          before do
  ...
  context_ "when collect_tax_co feature flag is off" do
  ...
  context_ "when collect_tax_co feature flag is on" do
          before do
  ...
  context_ "when collect_tax_cr feature flag is off" do
  ...
  context_ "when collect_tax_cr feature flag is on" do
          before do
  ...
  context_ "when collect_tax_ec feature flag is off" do
  ...
  context_ "when collect_tax_ec feature flag is on" do
          before do
  ...
  context_ "when collect_tax_eg feature flag is off" do
  ...
  context_ "when collect_tax_eg feature flag is on" do
          before do
  ...
  context_ "when collect_tax_ge feature flag is off" do
  ...
  context_ "when collect_tax_ge feature flag is on" do
          before do
  ...
  context_ "when collect_tax_kz feature flag is off" do
  ...
  context_ "when collect_tax_kz feature flag is on" do
          before do
  ...
  context_ "when collect_tax_ke feature flag is off" do
  ...
  context_ "when collect_tax_ke feature flag is on" do
          before do
  ...
  context_ "Malaysia Service Tax" do
  ...
  context_ "when collect_tax_my feature flag is off" do
  ...
  context_ "when collect_tax_my feature flag is on" do
          before do
  ...
  context_ "when collect_tax_md feature flag is off" do
  ...
  context_ "when collect_tax_md feature flag is on" do
          before do
  ...
  context_ "when collect_tax_ma feature flag is off" do
  test "does not assess VAT" do
            product = create(:product, user: @seller)
            expected_sales_tax = SalesTaxCalculation.zero_tax(100)
  ...
  context_ "when collect_tax_ma feature flag is on" do
          before do
  ...
  context_ "when collect_tax_ng feature flag is off" do
  test "does not assess VAT" do
            product = create(:product, user: @seller)
            expected_sales_tax = SalesTaxCalculation.zero_tax(100)
  ...
  context_ "when collect_tax_ng feature flag is on" do
          before do
  ...
  context_ "when collect_tax_om feature flag is off" do
  test "does not assess VAT" do
            product = create(:product, user: @seller)
            expected_sales_tax = SalesTaxCalculation.zero_tax(100)
  ...
  context_ "when collect_tax_om feature flag is on" do
          before do
  ...
  context_ "when collect_tax_ru feature flag is off" do
  test "does not assess VAT" do
            product = create(:product, user: @seller)
            expected_sales_tax = SalesTaxCalculation.zero_tax(100)
  ...
  context_ "when collect_tax_ru feature flag is on" do
          before do
  ...
  context_ "when collect_tax_sa feature flag is off" do
  test "does not assess VAT" do
            product = create(:product, user: @seller)
            expected_sales_tax = SalesTaxCalculation.zero_tax(100)
  ...
  context_ "when collect_tax_sa feature flag is on" do
          before do
  ...
  context_ "when collect_tax_rs feature flag is off" do
  test "does not assess VAT" do
            product = create(:product, user: @seller)
            expected_sales_tax = SalesTaxCalculation.zero_tax(100)
  ...
  context_ "when collect_tax_rs feature flag is on" do
          before do
  ...
  context_ "when collect_tax_kr feature flag is off" do
  test "does not assess VAT" do
            product = create(:product, user: @seller)
            expected_sales_tax = SalesTaxCalculation.zero_tax(100)
  ...
  context_ "when collect_tax_kr feature flag is on" do
          before do
  ...
  context_ "when collect_tax_tz feature flag is off" do
  test "does not assess VAT" do
            product = create(:product, user: @seller)
            expected_sales_tax = SalesTaxCalculation.zero_tax(100)
  ...
  context_ "when collect_tax_tz feature flag is on" do
          before do
  ...
  context_ "when collect_tax_th feature flag is off" do
  test "does not assess VAT" do
            product = create(:product, user: @seller)
            expected_sales_tax = SalesTaxCalculation.zero_tax(100)
  ...
  context_ "when collect_tax_th feature flag is on" do
          before do
  ...
  context_ "when collect_tax_tr feature flag is off" do
  test "does not assess VAT" do
            product = create(:product, user: @seller)
            expected_sales_tax = SalesTaxCalculation.zero_tax(100)
  ...
  context_ "when collect_tax_tr feature flag is on" do
          before do
  ...
  context_ "when collect_tax_ua feature flag is off" do
  test "does not assess VAT" do
            product = create(:product, user: @seller)
            expected_sales_tax = SalesTaxCalculation.zero_tax(100)
  ...
  context_ "when collect_tax_ua feature flag is on" do
          before do
  ...
  context_ "when collect_tax_uz feature flag is off" do
  test "does not assess VAT" do
            product = create(:product, user: @seller)
            expected_sales_tax = SalesTaxCalculation.zero_tax(100)
  ...
  context_ "when collect_tax_uz feature flag is on" do
          before do
  ...
  context_ "when collect_tax_vn feature flag is off" do
  test "does not assess VAT" do
            product = create(:product, user: @seller)
            expected_sales_tax = SalesTaxCalculation.zero_tax(100)
  ...
  context_ "when collect_tax_vn feature flag is on" do
          before do
  ...
  test "assesses VAT for physical products in EU country" do
          product = create(:physical_product, user: @seller)
          expected_tax_rate = create(:zip_tax_rate, country: "IT", state: nil, zip_code: nil, combined_rate: 0.22, is_seller_responsible: false)
  ...
  context_ "EU VAT controls for merchant migrated account" do
        before do
