...
class StripeMerchantAccountManagerTest < ActiveSupport::TestCase
  self.described_class = StripeMerchantAccountManager
  self.rspec_metadata = { vcr: true }



  context_ StripeMerchantAccountManager, :vcr do
  ...
  context_ "#create_account" do
  context_ "all info provided of an individual" do
  ...
  test "creates an account at stripe with all the params" do
  ...
  test "returns a merchant account" do
          merchant_account = subject.create_account(user, passphrase: "1234")
  ...
  context_ "when user compliance info contains whitespaces" do
  ...
  test "strips out params whitespaces" do
            expect(Stripe::Account).to receive(:create).with(expected_account_params).and_call_original
            merchant_account = subject.create_account(user, passphrase: "1234")
            expect(merchant_account.charge_processor_id).to eq(StripeChargeProcessor.charge_processor_id)
            expect(merchant_account.charge_processor_merchant_id).to be_present
  ...
  context_ "all info provided of an individual with a US Debit card" do
        let(:user_compliance_info) { create(:user_compliance_info, user:) }
  ...
  test "creates an account at stripe with all the account params" do
          expect(Stripe::Account).to receive(:create).with(expected_account_params).and_call_original
          subject.create_account(user, passphrase: "1234")
        end
  ...
  context_ "all info provided of an individual but their bank account doesn't match the default currency of the country" do
        before do
  ...
  context_ "all info provided of an individual and empty string business fields" do
  ...
  context_ "all info provided of a business" do
  ...
  context_ "all info provided of an individual (non-US)" do
  ...
  context_ "all info provided of a business (non-US)" do
        let(:user_compliance_info) do
  ...
  context_ "all info provided of an individual (UK/EU)" do
  ...
  context_ "all info provided of a business (UK/EU)" do
        let(:user_compliance_info) do
  ...
  context_ "all info provided of an FR individual" do
  ...
  test "creates an account at stripe with all the params and returns the corresponding merchant account" do
          expect(Stripe::Account).to receive(:create).with(expected_account_params).and_call_original
  ...
  context_ "all info provided of an DE business" do
  ...
  context_ "all info provided of an HK individual" do
  ...
  context_ "all info provided of an SG business" do
        let(:user_compliance_info) do create(:user_compliance_info_business, user:,
  ...
  context_ "all info provided of a Japanese individual" do
  ...
  context_ "all info provided of an NZ individual" do
  ...
  context_ "all info provided of an CH business" do
        let(:user_compliance_info) do create(:user_compliance_info_business, user:,
  ...
  context_ "all info provided of a Kazakhstan individual" do
  ...
  context_ "all info provided of an Ecuadorian individual" do
  ...
  context_ "all info provided of an TH individual" do
  ...
  context_ "all info provided of a KR individual" do
  ...
  context_ "all info provided of an Indian individual" do
  ...
  test "raises a user not ready error because new India accounts are blocked" do
  ...
  context_ "when new India account creation is not blocked" do
  ...
  context_ "all info provided of a Taiwanese individual" do
  ...
  context_ "all info provided of a Vietnamese individual" do
  ...
  context_ "all info provided of a South African individual" do
  ...
  context_ "all info provided of a Kenyan individual" do
  ...
  context_ "all info provided of a Egyptian individual" do
  ...
  context_ "all info provided of a Uruguayan individual" do
  ...
  context_ "all info provided of a Mauritian individual" do
  ...
  context_ "all info provided of a Jamaican individual" do
  ...
  context_ "all info provided of a Colombian individual" do
  ...
  context_ "all info provided of an Indonesian individual" do
  ...
  context_ "all info provided of a Costa Rican individual" do
  ...
  context_ "all info provided of a Moldova individual" do
  ...
  context_ "all info provided of a Panama individual" do
  ...
  context_ "all info provided of an El Salvador individual" do
  ...
  context_ "when the seller stored a plain account number instead of an IBAN" do
  ...
  test "constructs an IBAN from the SWIFT/BIC and account number before sending to Stripe" do
            captured_params = nil
  ...
  context_ "all info provided of a Chile individual" do
  ...
  context_ "all info provided of a Saudi Arabian individual" do
  ...
  context_ "all info provided of a Pakistani individual" do
  ...
  context_ "all info provided of a Turkish individual" do
  ...
  context_ "all info provided of a Tunisian individual" do
  ...
  context_ "all info provided of a North Macedonian individual" do
        let(:user_compliance_info) do
  ...
  context_ "all info provided of a Madagascar individual" do
  ...
  context_ "all info provided of a Senegal individual" do
  ...
  context_ "all info provided of a UAE business" do
  ...
  context_ "all info provided of a Dominican Republic individual" do
  ...
  context_ "all info provided of a Gabon individual" do
  ...
  context_ "all info provided of a Monaco individual" do
  ...
  context_ "all info provided of an Uzbekistan individual" do
  ...
  context_ "all info provided of a Ethiopia individual" do
  ...
  context_ "all info provided of a Brunei individual" do
  ...
  context_ "all info provided of a Guyana individual" do
  ...
  context_ "all info provided of a Guatemala individual" do
  ...
  context_ "all info provided of a Bolivian individual" do
  ...
  context_ "all info provided of a IL individual" do
  ...
  context_ "all info provided of a TT individual" do
  ...
  context_ "all info provided of a PH individual" do
  ...
  context_ "all info provided of a Ghanaian individual" do
        let(:user_compliance_info) do
  ...
  context_ "all info provided of an RO individual" do
  ...
  context_ "all info provided of a GI individual" do
  ...
  context_ "all info provided of a SE individual" do
  ...
  context_ "all info provided of a MEX business" do
  ...
  context_ "all info provided of an AR individual" do
  ...
  context_ "all info provided of a Bosnia and Herzegovina individual" do
  ...
  context_ "all info provided of an PE individual" do
  ...
  context_ "all info provided of an Rwanda individual" do
  ...
  context_ "all info provided of an Norwegian individual" do
  ...
  context_ "all info provided of a Botswana individual" do
  ...
  context_ "all info provided of an Liechtenstein individual" do
  ...
  context_ "all info provided of a Antigua and Barbuda individual" do
  ...
  context_ "all info provided of a Tanzanian individual" do
  ...
  context_ "all info provided of a Namibian individual" do
  ...
  context_ "all info provided of a Moroccan individual" do
  ...
  context_ "all info provided of a Serbian individual" do
  ...
  context_ "all info provided of a Malaysian individual" do
  ...
  context_ "all info provided of an Albanian individual" do
  ...
  context_ "all info provided of a Angola individual" do
  ...
  context_ "all info provided of a Niger individual" do
  ...
  context_ "all info provided of a San Marino individual" do
  ...
  context_ "all info provided of a Bahraini individual" do
  ...
  context_ "all info provided of a Bangladeshi individual" do
  ...
  context_ "all info provided of a Bhutan individual" do
  ...
  context_ "all info provided of a Laos individual" do
  ...
  context_ "all info provided of a Mozambique individual" do
  ...
  context_ "all info provided of a Nigerian individual" do
  ...
  context_ "all info provided of a Jordanian individual" do
  ...
  context_ "all info provided of a Azerbaijani individual" do
  ...
  context_ "all info provided of a Paraguayan individual" do
  ...
  context_ "all info provided of an Omani individual" do
  ...
  context_ "all info provided of an Armenian individual" do
  ...
  context_ "all info provided of a Sri Lankan individual" do
  ...
  context_ "all info provided of a Kuwaiti individual" do
  ...
  context_ "all info provided of a Qatari individual" do
  ...
  context_ "all info provided of a Bahamas individual" do
  ...
  context_ "all info provided of an Icelandic individual" do
  ...
  context_ "all info provided of a Saint Lucian individual" do
  ...
  context_ "all info provided of a Cambodian individual" do
  ...
  context_ "all info provided of a Mongolian individual" do
  ...
  context_ "all info provided of an Algerian individual" do
  ...
  context_ "all info provided of a Macao individual" do
  ...
  context_ "all info provided of a Benin individual" do
  ...
  context_ "all info provided of a Cote d'Ivoire individual" do
  ...
  context_ "user doesn't have a country specified" do
  ...
  test "raises a user not ready error" do
          expect { subject.create_account(user, passphrase: "1234") }.to raise_error(MerchantRegistrationUserNotReadyError)
        end
      end

  context_ "user's country doesn't have a default currency" do
  ...
  context_ "user has an invalid bank account" do
  ...
  context_ "Stripe account cleanup when create_person fails" do
        let(:user_compliance_info) { create(:user_compliance_info_business, user:) }
        let(:bank_account) { create(:ach_account_stripe_succeed, user:) }
        let(:tos_agreement) { create(:tos_agreement, user:) }
  ...
  test "deletes the Stripe account and marks the merchant account as deleted" do
  ...
  test "still marks the merchant account as deleted when Stripe account deletion fails" do
  ...
  context_ "user doesn't have compliance info" do
  test "raises a user not ready error" do
          expect { subject.create_account(user, passphrase: "1234") }.to raise_error(MerchantRegistrationUserNotReadyError)
        end
      end

  context_ "user doesn't have all required compliance info" do
        before do
  ...
  context_ "user has not agreed to TOS" do
        before do
  ...
  context_ "user already has a stripe merchant account" do
        let(:user_compliance_info) { create(:user_compliance_info, user:) }
        let(:bank_account) { create(:ach_account_stripe_succeed, user:) }
        let(:tos_agreement) { create(:tos_agreement, user:) }
  ...
  context_ "create account is called a second time" do
  test "raises error" do
            expect { subject.create_account(user, passphrase: "1234") }.to raise_error(MerchantRegistrationUserAlreadyHasAccountError)
          end

  test "raises error even if charge_processor_alive_at is nil for the existing merchant account" do
  ...
  test "allows admin to create another account if the existing account does not have charge_processor_alive_at timestamp set" do
            existing_merchant_account = user.merchant_accounts.alive.last
            existing_merchant_account.update!(charge_processor_alive_at: nil)
  ...
  context_ "Puerto Rico seller onboarded onto a US-side Stripe Connect account" do
        let(:user_compliance_info) do
          create(:user_compliance_info, user:,
  ...
  test "sends country: 'US' to Stripe and stores the merchant account with country 'US'" do
          merchant_account = subject.create_account(user, passphrase: "1234")
  ...
  test "follows US SSN semantics when submitting the personal tax ID" do
          subject.create_account(user, passphrase: "1234")
  ...
  context_ "Puerto Rico business seller" do
          let(:user_compliance_info) do
            create(:user_compliance_info_business, user:,
                                                   country: "Puerto Rico", state: "PR", city: "San Juan", zip_code: "00921",
  ...
  test "remaps company.address.country to US so Stripe accepts the business address" do
            subject.create_account(user, passphrase: "1234")
  ...
  context_ "#update_account" do
  context_ "all info provided" do
  ...
  test "updates an account at stripe with just the params that have changed" do
  ...
  context_ "all info provided for a creator in a cross-border payout country" do
  ...
  test "updates an account at stripe with just the params that have changed and cross border payouts only capabilities" do
          original_stripe_account_retrieve = Stripe::Account.method(:retrieve)
          expect(Stripe::Account).to receive(:retrieve).with(merchant_account.charge_processor_merchant_id) do |*args|
            stripe_account = original_stripe_account_retrieve.call(*args)
            stripe_account["metadata"]["user_compliance_info_id"] = user_compliance_info_1.external_id
  ...
  context_ "updating business type" do
        let(:user_compliance_info_1) { create(:user_compliance_info, user:) }
        let(:tos_agreement) { create(:tos_agreement, user:) }
        let(:merchant_account) { subject.create_account(user, passphrase: "1234") }
  ...
  context_ "when updating from individual to company" do
          let(:user_compliance_info_1) { create(:user_compliance_info, user:) }
          let(:user_compliance_info_2) { create(:user_compliance_info_business, user:) }

  test "does not include individual details in the params" do
            original_stripe_account_retrieve = Stripe::Account.method(:retrieve)
            expect(Stripe::Account).to receive(:retrieve).with(merchant_account.charge_processor_merchant_id) do |*args|
              stripe_account = original_stripe_account_retrieve.call(*args)
              stripe_account["metadata"]["user_compliance_info_id"] = user_compliance_info_1.external_id
  ...
  context_ "when updating from company to individual" do
  ...
  test "does not include company details in params and sets the company name to first and last name" do
            original_stripe_account_retrieve = Stripe::Account.method(:retrieve)
            expect(Stripe::Account).to receive(:retrieve).with(merchant_account.charge_processor_merchant_id) do |*args|
              stripe_account = original_stripe_account_retrieve.call(*args)
              stripe_account["metadata"]["user_compliance_info_id"] = user_compliance_info_1.external_id
  ...
  context_ "when the previous business type was sole proprietorship" do
  ...
  test "clears the company structure in a separate call before updating business type" do
              original_stripe_account_retrieve = Stripe::Account.method(:retrieve)
              expect(Stripe::Account).to receive(:retrieve).with(merchant_account.charge_processor_merchant_id) do |*args|
                stripe_account = original_stripe_account_retrieve.call(*args)
                stripe_account["metadata"]["user_compliance_info_id"] = user_compliance_info_1.external_id
  ...
  context_ "when updating to sole proprietorship" do
            let(:user_compliance_info_1) { create(:user_compliance_info_business, user:) }
  ...
  test "includes the sole proprietorship structure in company params" do
              original_stripe_account_retrieve = Stripe::Account.method(:retrieve)
              expect(Stripe::Account).to receive(:retrieve).with(merchant_account.charge_processor_merchant_id) do |*args|
                stripe_account = original_stripe_account_retrieve.call(*args)
                stripe_account["metadata"]["user_compliance_info_id"] = user_compliance_info_1.external_id
  ...
  context_ "when updating from sole proprietorship to a different business type" do
            let(:user_compliance_info_1) { create(:user_compliance_info_business, user:, business_type: UserComplianceInfo::BusinessTypes::SOLE_PROPRIETORSHIP) }
  ...
  test "sets the structure to nil in company params" do
              original_stripe_account_retrieve = Stripe::Account.method(:retrieve)
              expect(Stripe::Account).to receive(:retrieve).with(merchant_account.charge_processor_merchant_id) do |*args|
                stripe_account = original_stripe_account_retrieve.call(*args)
                stripe_account["metadata"]["user_compliance_info_id"] = user_compliance_info_1.external_id
  ...
  context_ "updating part of dob" do
        let(:tos_agreement) { create(:tos_agreement, user:) }
        let(:merchant_account) { subject.create_account(user, passphrase: "1234") }
  ...
  test "updates an account at Stripe with the full DOB, not just the parts that have changed" do
  ...
  context_ "mismatch of last 4 digits of SSN" do
        let(:merchant_account) { subject.create_account(user, passphrase: "1234") }
  ...
  test "does not send the last 4 digits of an old SSN to Stripe" do
  ...
  test "sends the new full SSN to Stripe" do
  ...
  context_ "person info changed" do
  ...
  test "updates person with correct diff attributes based on previous compliance info" do
          original_stripe_account_retrieve = Stripe::Account.method(:retrieve)
          expect(Stripe::Account).to receive(:retrieve).with(merchant_account.charge_processor_merchant_id) do |*args|
            stripe_account = original_stripe_account_retrieve.call(*args)
            stripe_account["metadata"]["user_compliance_info_id"] = user_compliance_info_1.external_id
  ...
  context_ "updating capabilities" do
        before do
          create(:user_compliance_info, user:)
          create(:ach_account_stripe_succeed, user:)
  ...
  context_ "when account is missing required capabilities" do
  ...
  test "requests the missing capabilities during an update" do
  ...
  context_ "when account has some missing, some outdated, and some extra capabilities" do
          before do
            stripe_account = Stripe::Account.retrieve(@merchant_account.charge_processor_merchant_id)
  ...
  context_ "#update_bank_account" do
      let(:user_compliance_info) { create(:user_compliance_info, user:) }
      let(:tos_agreement) { create(:tos_agreement, user:) }
  ...
  context_ "all info provided, bank account changed" do
  ...
  test "updates an account at stripe with all the params" do
  ...
  context_ "invalid account number provided" do
          before do
  ...
  context_ "account number provided has history of payment failures" do
          before do
  ...
  context_ "account holder name rejected by Stripe" do
          before do
  ...
  test "emails the creator about the rejected name" do
            expect do
              subject.update_bank_account(user, passphrase: "1234")
  ...
  context_ "Stripe rejects the external account with a CardError" do
          before do
  ...
  test "emails the creator, records a payout note, and returns :card_not_supported" do
            result = nil
            expect do
  ...
  context_ "all info provided previously, bank account not changed" do
  test "does not update an account at stripe with all the params" do
  ...
  test "syncs to Stripe when the account holder name has changed for JP accounts" do
  ...
  context_ "bank accounts without routing numbers" do
  ...
  test "does not throw error and updates correctly" do
  ...
  context_ "user no longer has an ACH account" do
        before do
          bank_account_1.update!(deleted_at: Time.current)
        end
  ...
  context_ "cross-border SEPA IBAN payouts" do
  ...
  context_ "when a Bulgaria-based creator submits a Lithuanian IBAN (the issue case)" do
        let(:user_compliance_info) do
  ...
  test "creates a Stripe account in BG and registers the LT IBAN as an EUR external account" do
  ...
  context_ "when a Bulgaria-based creator with an existing BG IBAN switches to a Lithuanian IBAN" do
        let(:user_compliance_info) do
          create(:user_compliance_info, user:, city: "Sofia", street_address: "address_full_match",
                                        state: nil, zip_code: "1000", country: "Bulgaria")
        end
  ...
  test "syncs the LT IBAN with EUR currency to the existing BG Stripe account" do
          expect(Stripe::Account).to receive(:update).with(
  ...
  context_ "when a Denmark-based creator submits a Lithuanian IBAN (Stripe's stated cross-border SEPA example)" do
        let(:user_compliance_info) do
  ...
  test "creates a Stripe account in DK with DKK default currency but registers the LT IBAN as an EUR external account" do
          expect(Stripe::Account).to receive(:create).with(
            hash_including(
              country: "DK",
  ...
  context_ "when a Bulgaria-based creator submits a Bulgarian IBAN (regression: same-country still works)" do
        let(:user_compliance_info) do
          create(:user_compliance_info, user:, city: "Sofia", street_address: "address_full_match",
                                        state: nil, zip_code: "1000", country: "Bulgaria")
        end
  ...
  test "creates a Stripe account in BG and registers the BG IBAN as an EUR external account" do
          expect(Stripe::Account).to receive(:create).with(
            hash_including(
              country: "BG",
              default_currency: "eur",
  ...
  context_ "when a Denmark-based creator submits a Danish IBAN (regression: same-country still works)" do
        let(:user_compliance_info) do
          create(:user_compliance_info, user:, city: "Copenhagen", street_address: "address_full_match",
                                        state: nil, zip_code: "1050", country: "Denmark")
        end
  ...
  test "creates a Stripe account in DK and registers the DK IBAN as a DKK external account" do
          expect(Stripe::Account).to receive(:create).with(
            hash_including(
              country: "DK",
              default_currency: "dkk",
  ...
  context_ "when a Bulgaria-based creator submits a Saudi IBAN (non-SEPA)" do
  test "is rejected at the model layer before any Stripe call" do
          allow(Rails.env).to receive(:production?).and_return(true)
  ...
  context_ ".save_stripe_bank_account_info" do
      let(:user) { create(:named_user) }
      let(:bank_account) { create(:japan_bank_account, user:) }
  ...
  test "persists Stripe metadata without revalidating a legacy invalid holder name" do
        expect(bank_account).not_to be_valid
  ...
  context_ ".handle_stripe_info_requirements" do
  ...
  test "captures the active bank once before enqueueing the retry worker" do
        expect do
  ...
  test "captures the active bank once before reading card sync state" do
  ...
  context_ ".handle_stripe_event" do
      before do
        create(:user_compliance_info, user:)
      end

  context_ "event: account.updated" do
  context_ "for an account not in our system" do
          let(:stripe_event) do
            {
  ...
  context_ "for a standard stripe connect account" do
          let(:stripe_event) do
            {
  ...
  test "does not raise an error if merchant account is not present" do
            expect { described_class.handle_stripe_event(stripe_event) }.not_to raise_error
          end

  test "does nothing and returns" do
  ...
  context_ "for a merchant account that was not fully set up in Stripe" do
  ...
  context_ "for a USA creator" do
          before do
            create(:user_compliance_info, user:, country: Compliance::Countries::USA.common_name)
          end

  context_ "SSN requested" do
  context_ "only the last 4 SSN is requested" do
  ...
  test "it should create a user compliance info request record" do
                described_class.handle_stripe_event(stripe_event)
  ...
  test "does not email the creator if their account is deleted" do
                user.mark_deleted!
  ...
  test "does not email the creator if their account is suspended" do
  ...
  test "records the email being sent on the requests for user compliance info" do
  ...
  test "results in the requests having a last contact at time of when the contact was made" do
                frozen_time = Time.current.change(usec: 0)
  ...
  context_ "only the full SSN is requested" do
              let(:merchant_account) { create(:merchant_account, user:) }
  ...
  context_ "charges_enabled status" do
  context_ "in the request charges are newly disabled" do
              let(:merchant_account) { create(:merchant_account, user:) }
  ...
  test "emails the creator if charges are disabled due to pending info requirement" do
  ...
  test "does not email the creator if charges are disabled due to a reason other than pending info requirement" do
                expect do
                  described_class.handle_stripe_event(stripe_event)
  ...
  test "does not email the creator if there is no pending info requirement" do
  ...
  test "does not email the creator if charges_enabled was previously not set" do
  ...
  test "does not email the creator if they are suspended" do
  ...
  test "does not email the creator if the merchant account is deleted" do
  ...
  context_ "in the request charges were disabled" do
              let(:merchant_account) { create(:merchant_account, user:) }
  ...
  test "persists the Stripe disabled_reason on the merchant account" do
  ...
  test "clears the disabled_reason when Stripe stops reporting one" do
  ...
  context_ "charges are not explicitly enabled or disabled" do
              let(:merchant_account) { create(:merchant_account, user:) }
  ...
  test "does not email the creator about their payments status" do
                expect do
                  described_class.handle_stripe_event(stripe_event)
                end.not_to have_enqueued_mail(MerchantRegistrationMailer, :stripe_charges_disabled)
              end
  ...
  context_ "payouts_enabled status" do
  context_ "in the request payouts are disabled" do
              let(:merchant_account) { create(:merchant_account, user:) }
  ...
  test "pauses payouts on the account and notifies the creator by email if payouts are disabled due to info requirement" do
  ...
  test "does not overwrite the payout pause source if payouts are already paused internally" do
  ...
  test "does not email the creator if payouts are already paused" do
  ...
  test "does not email the creator if payouts are disabled due to a reason other than info requirement" do
                expect(user.reload.payouts_paused_internally?).to be false
                expect do
                  described_class.handle_stripe_event(stripe_event)
                end.not_to have_enqueued_mail(MerchantRegistrationMailer, :stripe_payouts_disabled)
  ...
  context_ "payouts are not explicitly enabled or disabled" do
              let(:merchant_account) { create(:merchant_account, user:) }
  ...
  test "does not pause payouts or email the creator about their payouts status" do
                expect do
                  described_class.handle_stripe_event(stripe_event)
                end.not_to have_enqueued_mail(MerchantRegistrationMailer, :stripe_payouts_disabled).with(user.id)
  ...
  test "does not resume payouts or email the creator about their payouts status" do
                user.update!(payouts_paused_internally: true)
  ...
  context_ "payouts are enabled" do
              let(:merchant_account) { create(:merchant_account, user:) }
  ...
  test "resumes payouts on the account if payouts are paused internally by stripe" do
  ...
  test "does not resume payouts if payouts are paused internally by admin" do
                user.update!(payouts_paused_internally: true, payouts_paused_by: User.last.id)
                expect(user.reload.payouts_paused_internally?).to be true
                expect(user.payouts_paused_by).to eq(User.last.id)
                expect(user.payouts_paused_by_source).to eq(User::PAYOUT_PAUSE_SOURCE_ADMIN)
  ...
  test "does not resume payouts if payouts are paused internally by system" do
  ...
  context_ "future requirements" do
            let(:merchant_account) { create(:merchant_account, user:) }
  ...
  test "adds user compliance info request for future requirements and send kyc email to the creator" do
              expect do
                expect do
                  described_class.handle_stripe_event(stripe_event)
                end.to have_enqueued_mail(ContactingCreatorMailer, :more_kyc_needed).with(user.id, %w[individual_tax_id])
  ...
  context_ "alternative fields due" do
            let(:merchant_account) { create(:merchant_account, user:) }
  ...
  test "adds user compliance info request for alternative fields due and sends kyc email to the creator" do
              expect do
                expect do
                  described_class.handle_stripe_event(stripe_event)
  ...
  context_ "multiple fields needed for verification that map to one field internally" do
          let(:merchant_account) { create(:merchant_account, user:) }
  ...
  context_ "person's fields need verification when company account" do
          let(:merchant_account) { create(:merchant_account, user:) }
  ...
  test "creates user compliance info request records" do
            described_class.handle_stripe_event(stripe_event)
            user_compliance_info_requests = UserComplianceInfoRequest.all
            expect(user_compliance_info_requests[0].user).to eq(user)
            expect(user_compliance_info_requests[0].field_needed).to eq(UserComplianceInfoFields::Individual::DATE_OF_BIRTH)
  ...
  context_ "multiple requests for information" do
          let(:merchant_account) { create(:merchant_account, user:) }
  ...
  test "it creates a user compliance info request record" do
  ...
  test "records the email being sent on the requests for user compliance info when the information is requested" do
            frozen_time = Time.current.change(usec: 0)
  ...
  context_ "same set of information requested again" do
            let(:merchant_account) { create(:merchant_account, user:) }
  ...
  test "sends the kyc email again if it has been over 3 months since the last kyc email was sent for the same info" do
  ...
  test "does not resend kyc email if last kyc email for the same info was sent less than 1 month ago" do
  ...
  context_ "request for information without a due by" do
          let(:merchant_account) { create(:merchant_account, user:) }
  ...
  test "creates a user compliance info request record" do
            described_class.handle_stripe_event(stripe_event_1)
  ...
  context_ "account.updated event with charges enabled and bank account that needs syncing to Stripe", :vcr do
  ...
  test "syncs bank account details to Stripe" do
            described_class.handle_stripe_event(stripe_event_1)
  ...
  test "removes request for a card bank account if present" do
  ...
  context_ "account.updated event with charges disabled for user with card bank account", :vcr do
          let(:user) { create(:user) }
          let(:user_compliance_info) { create(:user_compliance_info, user:) }
          let(:tos_agreement) { create(:tos_agreement, user:) }
          let(:bank_account) { create(:card_bank_account, user:) }
  ...
  test "does not add request record or send kyc email if only bank account is requested" do
            expect do
              described_class.handle_stripe_event(stripe_event_1)
            end.not_to have_enqueued_mail(ContactingCreatorMailer, :more_kyc_needed)
            expect(UserComplianceInfoRequest.count).to eq 0
  ...
  test "adds request record and sends kyc email for fields other than bank account" do
  ...
  context_ "requests for information including some unrecognized fields" do
  ...
  test "creates a user compliance info request record for all fields emails the creator" do
            expect do
              described_class.handle_stripe_event(stripe_event_1)
  ...
  test "removes all existing user_compliance_info_requests for the user if account is verified" do
  ...
  context_ "when ID is already provided but requested again" do
          let!(:merchant_account) { create(:merchant_account, user:, charge_processor_merchant_id: "ac1") }
  ...
  test "saves the verification error code and the message sent by Stripe" do
  ...
  test "sends the identity verification failed email instead of generic more kyc needed email" do
  ...
  test "sends the document verification failed email instead of generic more kyc needed email if it's a document error" do
            stripe_error_code = "verification_document_failed_test_mode"
            stripe_error_reason = "A test data helper was supplied to simulate verification failure."
            stripe_event["data"]["object"]["requirements"]["errors"] = [
              {
  ...
  test "does not send an email when the user account is deleted" do
            user.mark_deleted!
  ...
  test "does not send an email when the user account is suspended" do
            admin = create(:admin_user)
            user.flag_for_fraud!(author_id: admin.id)
            user.suspend_for_fraud!(author_id: admin.id)
  ...
  test "saves the verification error from future requirements if present" do
              stripe_error_code = "verification_failed_keyed_identity"
              stripe_error_reason = "The identity information you entered cannot be verified. Please correct any errors or upload a document that matches the identity fields (e.g., name and date of birth) that you entered."
  ...
  test "handles stripe event data containing stripe objects correctly and sends kyc email to user" do
  ...
  test "handles stripe event data containing about more kyc but does not notify user if suspended" do
  ...
  test "handles stripe event data containing about more kyc but does not notify user if merchant account inactive" do
  ...
  context_ "risk-related information updates" do
          let(:merchant_account) { create(:merchant_account, user:) }
  ...
  test "adds user compliance info request if supportability fields are due and sends remediation email to the creator" do
            expect do
              expect do
                described_class.handle_stripe_event(stripe_event)
  ...
  test "adds user compliance info request if compliance fields are due and sends remediation email to the creator" do
  ...
  test "adds user compliance info request if credit-related fields are due and sends remediation email to the creator" do
            stripe_event.deep_merge!("data" => {
                                       "object" => {
                                         "requirements" => {
  ...
  test "suspends the account if stripe has rejected account due to compliance issue" do
            stripe_event.deep_merge!("data" => {
                                       "object" => {
                                         "requirements" => {
  ...
  test "suspends the account and notifies the user via email if stripe has rejected account due to supportability issue" do
            stripe_event.deep_merge!("data" => {
                                       "object" => {
                                         "requirements" => {
  ...
  context_ "event: account.application.deauthorized" do
  context_ "for an account not in our system" do
          let(:stripe_event) do
            {
              "api_version" => API_VERSION,
  ...
  context_ "Deauthorization from Stripe Account" do
          let(:merchant_account) { create(:merchant_account, user:) }
  ...
  test "does not email users about the event" do
            expect do
              described_class.handle_stripe_event(stripe_event)
            end.not_to have_enqueued_mail(MerchantRegistrationMailer, :account_deauthorized_to_user)
          end
  ...
  test "emails users about the event" do
              expect do
                described_class.handle_stripe_event(stripe_event)
  ...
  test "deactivates merchant account" do
            described_class.handle_stripe_event(stripe_event)
  ...
  context_ "event: capability.updated" do
  ...
  test "adds user compliance info request and sends kyc email to the creator" do
        expect do
          expect do
            described_class.handle_stripe_event(stripe_event)
  ...
  context_ "when account is not found" do
        let(:stripe_event) do
          {
            "api_version" => API_VERSION,
            "type" => "capability.updated",
  ...
  context_ "handling information update" do
      let(:user) { create(:user) }
      let(:user_compliance_info) { create(:user_compliance_info, user:) }
      let(:bank_account) { create(:ach_account_stripe_succeed, user:) }
      let(:tos_agreement) { create(:tos_agreement, user:) }
  ...
  context_ "creator has a stripe account" do
          let(:merchant_account) { subject.create_account(user, passphrase: "1234") }

          before { merchant_account }

  test "calls update account for the user" do
  ...
  context_ "creator does not have a stripe account" do
  test "calls update account for the user" do
  ...
  context_ "list_persons filters by relationship.representative on Stripe's side" do
  test "queries Stripe with relationship: { representative: true }, limit: 1 — no client-side scanning" do
  ...
  context_ "with the representative on the Stripe account" do
  test "sends only representative: true and lets Stripe preserve owner/title/percent_ownership set via BeneficialOwnersSection" do
          expect(Stripe::Account).to receive(:list_persons)
            .with(stripe_account.id, relationship: { representative: true }, limit: 1)
            .and_return("data" => [representative_person])
  ...
  context_ "when Stripe returns no persons for the account" do
  test "returns early without calling update_person" do
          expect(Stripe::Account).to receive(:list_persons)
            .with(stripe_account.id, relationship: { representative: true }, limit: 1)
            .and_return("data" => [])
  ...
  context_ "individual→company transition" do
  test "seeds owner: true, title, percent_ownership: 100 when transitioning from individual to business" do
