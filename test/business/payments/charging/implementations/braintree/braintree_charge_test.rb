...
class BraintreeChargeTest < ActiveSupport::TestCase
  self.described_class = BraintreeCharge
  self.rspec_metadata = { vcr: true }



  context_ BraintreeCharge, :vcr do
  context_ "charge without fingerprint or card details" do
      before do
  ...
  test "retrieves the card information for a paypal account successfully" do
