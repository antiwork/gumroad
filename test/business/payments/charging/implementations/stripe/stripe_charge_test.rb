...
class StripeChargeTest < ActiveSupport::TestCase
  self.described_class = StripeCharge
  self.rspec_metadata = { vcr: true }



  context_ StripeCharge, :vcr do
  ...
  context_ "with a stripe charge" do
  ...
  test "has the correct #zip_check_result" do
  ...
  test "sets the correct risk_level" do
  ...
  context_ "with a stripe charge with pass zip check" do
        let(:stripe_charge) do
  ...
  context_ "with a destination charge but nil destination payment balance transaction" do
  ...
  test "returns nil flow_of_funds instead of raising NoMethodError" do
  ...
  context_ "with a stripe charge destined for a managed account" do
  ...
  test "does not match the currency the destination received in" do
              expect(settled_amount.currency).not_to eq(stripe_destination_payment.balance_transaction.currency)
            end

  test "matches the amount the destination received" do
  ...
  test "matches the currency that gumroad received the application fee in" do
              expect(gumroad_amount.currency).to eq(stripe_charge.currency)
            end

  test "matches the amount of the application fee received in gumroads account" do
  ...
  test "matches the currency the destination received in" do
  ...
  test "matches the amount the destination received after taking out gumroads application fee" do
