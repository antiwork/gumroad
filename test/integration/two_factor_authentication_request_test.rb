...
class RequestsTwoFactorAuthenticationRequestTest < ActionDispatch::IntegrationTest



  context_ "Two-Factor Authentication endpoint", type: :request do
  ...
  test "is successful with correct params" do
  ...
  test "prioritises user_id in the query string over POST body" do
