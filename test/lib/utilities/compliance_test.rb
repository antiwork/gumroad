...
class ComplianceTest < ActiveSupport::TestCase
  self.described_class = Compliance



  context_ Compliance do
  context_ Countries do
  context_ ".mapping" do
  test "returns a Hash of country codes to countries" do
          expect(Compliance::Countries.mapping).to eq(mapping_expected)
        end
      end

  context_ ".find_by_name" do
  test "returns the country for a country whose name is the same for `countries` gem and `iso_country_codes` gem" do
          expect(Compliance::Countries.find_by_name("Mexico")).to eq(Compliance::Countries::MEX)
        end

  test "returns the country for a country whose name is different for `countries` gem and `iso_country_codes` gem" do
  ...
  test "returns the country for a country whose name is different for `countries` gem and `maxmind/geoip2`" do
  ...
  test "returns nil for a nil country name" do
          expect(Compliance::Countries.find_by_name(nil)).to be_nil
        end

  test "returns nil for an empty country name" do
          expect(Compliance::Countries.find_by_name("")).to be_nil
        end
      end

  context_ ".historical_names" do
  test "returns an empty array for a nil country name" do
          expect(Compliance::Countries.historical_names(nil)).to eq([])
        end

  test "returns the common name and gumroad historical names" do
  ...
  test "returns the common name and gumroad historical names for a country whose name is different for `countries` gem and `iso_country_codes` gem" do
  ...
  test "returns the known names for a country whose name is different for `countries` gem and `maxmind/geoip2`" do
  ...
  context_ ".elsewhere_with_flag" do
  test "returns 'Elsewhere' with globe emoji" do
          expect(Compliance::Countries.elsewhere_with_flag).to eq("🌎 Elsewhere")
        end
      end

  context_ ".subdivisions_for_select" do
  test "returns expected subdivisions for united states" do
  ...
  test "returns expected subdivisions for canada" do
  ...
  test "returns expected subdivisions for australia" do
  ...
  test "returns expected subdivisions for united arab emirates" do
  ...
  test "returns expected subdivisions for mexico" do
  ...
  test "returns expected subdivisions for ireland" do
  ...
  test "raises an ArgumentError for a country we haven't added subdivision support for yet" do
          expect do
  ...
  context_ ".japan_prefectures_for_select" do
  test "returns all 47 Japan prefectures" do
          prefectures = Compliance::Countries.japan_prefectures_for_select
          expect(prefectures.length).to eq(47)
        end

  test "includes value, label, and kana for each prefecture" do
          prefectures = Compliance::Countries.japan_prefectures_for_select
  ...
  test "has kana mappings for all prefectures from ISO3166" do
  ...
  context_ ".japan_prefecture_kana" do
  test "returns the kana reading for a valid prefecture" do
