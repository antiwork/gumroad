...
class CollaboratorInvitationPolicyTest < ActiveSupport::TestCase
  self.described_class = CollaboratorInvitationPolicy



  context_ CollaboratorInvitationPolicy do
  ...
  context_ "when the invitation is for the seller" do
  ...
  context_ "when the invitation is for another seller" do
