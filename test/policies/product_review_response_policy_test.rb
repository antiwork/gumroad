...
class ProductReviewResponsePolicyTest < ActiveSupport::TestCase
  self.described_class = ProductReviewResponsePolicy



  context_ ProductReviewResponsePolicy do
  ...
  context_ "when the response is for the seller's product review" do
  ...
  context_ "when the response is for another seller's product review" do
