...
class ProductReviewVideoPolicyTest < ActiveSupport::TestCase
  self.described_class = ProductReviewVideoPolicy



  context_ ProductReviewVideoPolicy do
  ...
  context_ "when the video is for the seller's product review" do
  ...
  context_ "when the video is for another seller's product review" do
  ...
  context_ "when the video has been approved" do
        let(:record) { product_review_video_for_another_seller }
  ...
  context_ "when the video has not been approved" do
        let(:record) { product_review_video_for_another_seller }
  ...
  context_ "when the video is for the purchaser's product review" do
