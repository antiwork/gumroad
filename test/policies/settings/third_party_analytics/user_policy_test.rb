...
class SettingsThirdPartyAnalyticsUserPolicyTest < ActiveSupport::TestCase
  self.described_class = Settings::ThirdPartyAnalytics::UserPolicy



  context_ Settings::ThirdPartyAnalytics::UserPolicy do
