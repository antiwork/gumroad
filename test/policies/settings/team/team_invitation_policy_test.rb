...
class SettingsTeamTeamInvitationPolicyTest < ActiveSupport::TestCase
  self.described_class = Settings::Team::TeamInvitationPolicy



  context_ Settings::Team::TeamInvitationPolicy do
