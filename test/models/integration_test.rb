...
class IntegrationTest < ActiveSupport::TestCase
  self.described_class = Integration



  context_ Integration do
  context_ "#type_for" do
  test "returns the type for the given integration name" do
  ...
  context_ "#class_for" do
  test "returns the class for the given integration name" do
  ...
  context_ ".enabled_integrations_for" do
  test "returns the enabled integrations on a purchase" do
  ...
  test "does not consider deleted integrations as enabled" do
  ...
  context_ "scopes" do
  context_ "by_name" do
  test "returns collection of integrations of the given integration type" do
  ...
  context_ "has one `product_integration`" do
  test "returns product_integration if exists" do
