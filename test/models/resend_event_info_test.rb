...
class ResendEventInfoTest < ActiveSupport::TestCase
  self.described_class = ResendEventInfo



  context_ ResendEventInfo do
    before do
  ...
  test "includes purchase id and marks as receipt email" do
            event_info = described_class.from_event_json(event_json)
  ...
  test "includes charge id and marks as receipt email" do
              event_info = described_class.from_event_json(event_json)
              expect_headers_presence(
                MailerInfo::FIELD_EMAIL_PROVIDER,
                MailerInfo::FIELD_ENVIRONMENT,
  ...
  context_ "with preorder receipt email", :vcr do
        let(:preorder) do
  ...
  test "marks as receipt email" do
          event_info = described_class.from_event_json(event_json)
          expect_headers_presence(
            MailerInfo::FIELD_EMAIL_PROVIDER,
            MailerInfo::FIELD_ENVIRONMENT,
  ...
  test "includes workflow ids and marks as abandoned cart email" do
          event_info = described_class.from_event_json(event_json)
          expect_headers_presence(
            MailerInfo::FIELD_EMAIL_PROVIDER,
            MailerInfo::FIELD_ENVIRONMENT,
