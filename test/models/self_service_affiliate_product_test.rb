...
class SelfServiceAffiliateProductTest < ActiveSupport::TestCase
  self.described_class = SelfServiceAffiliateProduct



  context_ SelfServiceAffiliateProduct do
  ...
  context_ "when enabled is set to true" do
  test "validates presence of affiliate_basis_points" do
  ...
  context_ "affiliate_basis_points_must_fall_in_an_acceptable_range" do
  ...
  context_ "destination_url_validation" do
  ...
  context_ "product_is_not_a_collab" do
  ...
  context_ "product_user_and_seller_is_same" do
  ...
  test "upserts the given products" do
