...
class ProductReviewVideoTest < ActiveSupport::TestCase
  self.described_class = ProductReviewVideo



  context_ ProductReviewVideo, type: :model do
  context_ "approval status transitions" do
  ...
  test "marks other videos of the same status as deleted" do
