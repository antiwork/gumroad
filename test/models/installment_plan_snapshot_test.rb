...
class InstallmentPlanSnapshotTest < ActiveSupport::TestCase
  self.described_class = InstallmentPlanSnapshot



  context_ InstallmentPlanSnapshot do
  ...
  context_ "number_of_installments" do
  ...
  context_ "payment_option uniqueness" do
  test "allows only one snapshot per payment_option" do
  ...
  context_ "when total divides evenly" do
  test "returns equal payments" do
  ...
  context_ "when total has remainder" do
  test "adds remainder to first payment" do
          snapshot = create(:installment_plan_snapshot,
                            payment_option: payment_option,
                            number_of_installments: 3,
  ...
  context_ "single installment" do
  test "returns full amount" do
          snapshot = create(:installment_plan_snapshot,
                            payment_option: payment_option,
