...
class ModelsPurchasePurchaseSalesTaxTest < ActiveSupport::TestCase
  self.rspec_metadata = { vcr: true }



  context_ "PurchaseSalesTax", :vcr do
  ...
  context_ "with a default (not taxable) seller and a purchase without a zip code" do
  ...
  context_ "with a default (not taxable) seller and a purchase with a zip code" do
        @buyer_zip = "94107"
  ...
  context_ "with a US taxable seller" do
        before(:context) do
  ...
  context_ "when a purchase is made from a non-nexus state" do
          before(:context) do
            @tax_state = "TX"
          end

  test "does not have taxes" do
            expect(@purchase.tax_cents).to be_zero
            expect(@purchase.gumroad_tax_cents).to be_zero
            expect(@purchase.total_transaction_cents).to eq(10_00)
            expect(@purchase.zip_tax_rate).to be_nil
  ...
  context_ "when a purchase is made from a taxable state" do
  context_ "when TaxJar is used for tax calculation" do
            before(:context) do
              @buyer_zip = "98121"
              @was_product_recommended = true
            end

  test "stores purchase_taxjar_info" do
  ...
  context_ "in eligible and successful purchase" do
          before(:context) do
  ...
  test "is VAT eligible and VAT is applied to purchase" do
  ...
  context_ "location verification with available zip tax entry" do
          before(:context) do
            @tax_combined_rate = 0.22
          end

  context_ "IP address in EU , card country in EU, country = ip" do
            before(:context) do
              @tax_country = "GB"
  ...
  context_ "IP address in EU , card country in EU, country = card country" do
            before(:context) do
              @tax_country = "ES"
  ...
  context_ "IP address in EU , card country in EU, country != either and in EU" do
            before(:context) do
              @tax_country = "ES"
            ...
            before(:example) do
              expect(ChargeProcessor).not_to receive(:create_payment_intent_or_charge!).with(anything, anything, chargeable, @purchase_transaction_amount, anything, anything, anything)
            end
  ...
  context_ "IP address in EU , card country in EU, country != either and not in EU" do
            before(:context) do
              @tax_country = "TG"
  ...
  context_ "IP address in EU , card country in EU, IP country = card country, country != either and not in EU" do
            before(:context) do
              @tax_country = "TG"
  ...
  context_ "IP address in EU , card country not in EU, country != either and in EU" do
            before(:context) do
              @tax_country = "ES"
  ...
  context_ "IP address not in EU , card country in EU, country != either and in EU" do
            before(:context) do
              @tax_country = "ES"
  ...
  context_ "IP address non EU , card country non EU, country != either and in EU" do
            before(:context) do
              @tax_country = "ES"
  ...
  test "trusts selected country and applies VAT" do
              expect(@purchase.was_purchase_taxable).to be(true)
              expect(@purchase.was_tax_excluded_from_price).to be(true)
              expect(@purchase.zip_tax_rate).to eq(@zip_tax_rate)
  ...
  context_ "IP address in EU , card country non EU, country != either and not in EU" do
            before(:context) do
              @purchase_country = "Togo"
              @purchase_chargeable_country = "AU"
              @purchase_ip_country = "United Kingdom"
  ...
  context_ "IP address non EU , card country non EU, country != either and not in EU" do
            before(:context) do
              @purchase_country = "Togo"
  ...
  test "no tax is applied to the purchase" do
              expect(@purchase.was_purchase_taxable).to be(false)
  ...
  context_ "IP address in EU, card country in EU, country in non-EU and product is physical" do
            before(:context) do
  ...
  context_ "IP address in EU, card country in nil, country in EU (matching)" do
            before(:context) do
              @purchase_country = "United Kingdom"
              @purchase_chargeable_country = nil
              @purchase_ip_country = "United Kingdom"
  ...
  context_ "IP address EU, card country in nil, country in non-EU" do
            before(:context) do
              @purchase_country = "United States"
              @purchase_chargeable_country = nil
              @purchase_ip_country = "United Kingdom"
  ...
  context_ "IP address non-EU, card country in nil, country in non-EU (matching)" do
            before(:context) do
              @purchase_country = "United States"
              @purchase_chargeable_country = nil
              @purchase_ip_country = "United States"
  ...
  context_ "IP address EU, card country in EU, country is nil" do
            before(:context) do
              @purchase_country = nil
              @purchase_chargeable_country = "GB"
              @purchase_ip_country = "United Kingdom"
  ...
  context_ "IP address Australia, card country in Australia, country is nil" do
            before(:context) do
              @tax_country = "AU"
  ...
  test "is GST eligible and GST is applied to purchase" do
              expect(@purchase.was_purchase_taxable).to be(true)
              expect(@purchase.was_tax_excluded_from_price).to be(true)
              expect(@purchase.zip_tax_rate).to eq(@zip_tax_rate)
  ...
  context_ "validates buyer location election for EU" do
          before(:context) do
            @purchase_country = "United Kingdom"
            @purchase_ip_country = "Spain"
            @purchase_chargeable_country = "ES"
  ...
  test "when purchase country cannot be matched with either ip country or credit card country" do
            expect(@purchase.errors[:base].present?).to be(true)
            expect(@purchase.error_code).to eq(PurchaseErrorCode::TAX_VALIDATION_FAILED)
          end
        end

  context_ "validates buyer location election for Australia" do
          before(:context) do
            @purchase_country = "United States"
            @purchase_ip_country = "Australia"
            @purchase_chargeable_country = "AU"
  ...
  context_ "validates buyer location election for Canada" do
          before(:context) do
            @purchase_country = "United States"
  ...
  test "raises an error when purchase country cannot be matched with either ip country or credit card country" do
            expect(@purchase.errors[:base].present?).to be(true)
            expect(@purchase.error_code).to eq(PurchaseErrorCode::TAX_VALIDATION_FAILED)
          end
        end

  context_ "physical products" do
          before(:context) do
            @product_is_physical = true
            @product_require_shipping = true
          end

  test "does not calculate VAT for a physical product" do
            expect(@purchase.was_purchase_taxable).to be(false)
            expect(@purchase.was_tax_excluded_from_price).to be(false)
            expect(@purchase.zip_tax_rate).to be_nil
