...
class ModelsPurchasePurchaseGiftsTest < ActiveSupport::TestCase
  self.rspec_metadata = { vcr: true }



  context_ "PurchaseGifts", :vcr do
  ...
  test "increments seller's balance only for one purchase" do
        expect do
  ...
  test "sets the state of the giftee purchase to refunded when refunding gifter purchase" do
        @giftee_purchase.mark_gift_receiver_purchase_successful
  ...
  test "creates 1 url_redirect" do
        expect do
          @giftee_purchase.mark_gift_receiver_purchase_successful
          @gifter_purchase.update_balance_and_mark_successful!
        end.to change {
  ...
  test "emails the seller once" do
        mail_double = double
  ...
  context_ "gifts with shipping" do
        before do
  ...
  test "does not apply a price or shipping rate to the giftee purchase" do
  ...
  test "makes one url redirect" do
        expect do
          @giftee_purchase.mark_gift_receiver_purchase_successful
          @gifter_purchase.update_balance_and_mark_successful!
