...
class CallAvailabilityTest < ActiveSupport::TestCase
  self.described_class = CallAvailability


  context_ CallAvailability do
  context_ "normalizations" do
  ...
  context_ "end time is before start time" do
  ...
  context_ ".containing" do
  test "returns call availabilities that strictly contain the given time range" do
