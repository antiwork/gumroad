...
class PurchaseCustomFieldTest < ActiveSupport::TestCase
  self.described_class = PurchaseCustomField



  context_ PurchaseCustomField do
  ...
  context_ "#value_valid_for_custom_field" do
      let(:custom_field) { create(:custom_field) }
      let(:purchase) { create(:purchase) }

      [CustomField::TYPE_TEXT, CustomField::TYPE_LONG_TEXT].each do |type|
  test "requires value for #{type} custom field if required is true" do
  ...
  test "allows blank for an optional #{type} custom field" do
  ...
  test "requires file for file custom field if required is true" do
  ...
  test "allows blank for an optional file custom field" do
  ...
  test "requires value for file custom field to be nil" do
        custom_field.update!(type: CustomField::TYPE_FILE, required: true)
  ...
  context_ ".build_from_custom_field" do
  test "assigns attributes correctly" do
  ...
  context_ "#value" do
  test "returns the value cast to boolean if the field type is a boolean type" do
  ...
  test "returns the value as is if the field type is not a boolean type" do
