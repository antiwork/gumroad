...
class MoldovaBankAccountTest < ActiveSupport::TestCase
  self.described_class = MoldovaBankAccount



  context_ MoldovaBankAccount do
  ...
  test "allows 8 or 11 character SWIFT/BIC codes with MD country code" do
  ...
  test "allows only 24 characters in the correct format" do
