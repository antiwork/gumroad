...
class ConfirmedFollowerEventTest < ActiveSupport::TestCase
  self.described_class = ConfirmedFollowerEvent



  context_ ConfirmedFollowerEvent do
  test "can have documents added to its index" do
  ...
  context_ "Follower Callbacks" do
      before do
  ...
  test "queues job when confirmation state changes" do
