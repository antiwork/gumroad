...
class PreorderTest < ActiveSupport::TestCase
  self.described_class = Preorder
  self.rspec_metadata = { vcr: true }



  context_ Preorder, :vcr do
    before do
      $currency_namespace = Redis::Namespace.new(:currencies, redis: $redis)
    end

  context_ "mobile_json_data" do
  test "returns proper json for a preorder without a url redirect" do
  ...
  test "returns proper json for a preorder with a url redirect post charge" do
  ...
  context_ "authorize! and charge!" do
      before do
  ...
  test "marks the authorization purchase and preorder as invalid because of incorrect cvc" do
  ...
  test "creates both the authorization purchase and the main purchase and their states is properly set" do
  ...
  test "creates both the authorization purchase and the main purchase and their states is properly set - for PayPal as a chargeable" do
  ...
  test "sends the proper preorder emails" do
        mail_double = double
  ...
  test "sends the proper preorder emails for test preorders" do
        mail_double = double
        allow(mail_double).to receive(:deliver_later)
        expect(ContactingCreatorMailer).to receive(:notify).and_return(mail_double)
        expect(CustomerMailer).to receive(:preorder_receipt).and_return(mail_double)
  ...
  test "does not create a url redirect on successful authorization" do
        authorization_purchase = build(:purchase, link: @product, chargeable: @good_card, purchase_state: "in_progress", is_preorder_authorization: true)
        preorder = @preorder_product.build_preorder(authorization_purchase)
        preorder.authorize!
        preorder.mark_authorization_successful

        expect(preorder.url_redirect).not_to be_present
      end

  test "creates both the authorization purchase (successful) and the main purchase (failed)" do
  ...
  test "enqueues activate integrations worker on successful charge" do
        authorization_purchase = build(:purchase, link: @product, chargeable: @good_card, purchase_state: "in_progress", is_preorder_authorization: true)
        preorder = @preorder_product.build_preorder(authorization_purchase)
        preorder.authorize!
        preorder.mark_authorization_successful
  ...
  test "does not enqueue activate integrations worker if charge fails" do
        authorization_purchase = build(:purchase, link: @product, chargeable: @good_card_but_cant_charge,
                                                  purchase_state: "in_progress", is_preorder_authorization: true)
        preorder = @preorder_product.build_preorder(authorization_purchase)
        preorder.authorize!
  ...
  test "does not charge the preorder if a purchase is in progress" do
        authorization_purchase = build(:purchase, link: @product, chargeable: @good_card, purchase_state: "in_progress", is_preorder_authorization: true)
        preorder = @preorder_product.build_preorder(authorization_purchase)
        preorder.authorize!
        expect(preorder.authorization_purchase.purchase_state).to eq "preorder_authorization_successful"
  ...
  test "does not charge the same preorder twice" do
        authorization_purchase = build(:purchase, link: @product, chargeable: @good_card, purchase_state: "in_progress", is_preorder_authorization: true)
        preorder = @preorder_product.build_preorder(authorization_purchase)
        preorder.authorize!
        expect(preorder.authorization_purchase.purchase_state).to eq "preorder_authorization_successful"
  ...
  test "properly cancels the preorder and mark its auth purchase as concluded" do
        authorization_purchase = build(:purchase, link: @product, chargeable: @good_card, purchase_state: "in_progress", is_preorder_authorization: true)
        preorder = @preorder_product.build_preorder(authorization_purchase)
        preorder.authorize!
        expect(preorder.authorization_purchase.purchase_state).to eq "preorder_authorization_successful"
  ...
  test "applies the offer code that was used at the time of the preorder" do
        ...
        expect(ContactingCreatorMailer).not_to receive(:notify)
  ...
  test "applies the variants that were used at the time of the preorder" do
  ...
  test "applies the quantity that was used at the time of the preorder" do
  ...
  test "applies the name, address, shipping_cents, etc. that were used at the time of the preorder" do
  ...
  test "charges the preorder when the product requires shipping but the auth purchase doesn't have shipping info \
  ...
  test "transfers VAT ID and elected tax country from the authorization to the actual charge" do
  ...
  test "does not charge the card if the preorder is free" do
  ...
  test "charges the card if the preorder is free but has a variant with a price" do
        @product.update_attribute(:price_cents, 0)
        category = create(:variant_category, title: "sizes", link: @product)
        variant = create(:variant, name: "small", price_difference_cents: 300, variant_category: category)
        authorization_purchase = build(:purchase, link: @product, chargeable: @good_card, purchase_state: "in_progress", is_preorder_authorization: true)
  ...
  test "charges the card the right amount based on the exchange rate at the time of the charge" do
  ...
  test "charges the card the right amount based on the custom price the buyer entered at preorder time" do
  ...
  test "charges the card the right amount based on the custom price the buyer entered at preorder time - non USD" do
        @product.update!(
  ...
  test "does not count the charge purchase towards the offer code limit" do
  ...
  test "does not count the charge purchase towards the variant quantity limit" do
        category = create(:variant_category, title: "sizes", link: @product)
  ...
  test "does not count the charge purchase towards the product quantity limit" do
  ...
  test "charges the buyer the amount equal to the price at the time of the preorder" do
        authorization_purchase = build(:purchase, link: @product, chargeable: @good_card, purchase_state: "in_progress", is_preorder_authorization: true)
        preorder = @preorder_product.build_preorder(authorization_purchase)
        preorder.authorize!
        preorder.mark_authorization_successful
  ...
  test "charges the buyer the amount equal to the non-integer price at the time of the preorder" do
  ...
  test "charges the buyer the amount equal to the price (in yens) at the time of the preorder" do
        @product.update!(price_currency_type: "jpy", price_cents: 600)
        authorization_purchase = build(:purchase, link: @product, chargeable: @good_card, purchase_state: "in_progress", is_preorder_authorization: true)
        preorder = @preorder_product.build_preorder(authorization_purchase)
        preorder.authorize!
  ...
  test "charges the buyer the right amount regardless of the variant price changes" do
        category = create(:variant_category, title: "sizes", link: @product)
        variant = create(:variant, name: "small", price_difference_cents: 300, variant_category: category)
        authorization_purchase = build(:purchase, link: @product, chargeable: @good_card, purchase_state: "in_progress", is_preorder_authorization: true)
        authorization_purchase.variant_attributes << variant
  ...
  test "charges the buyer even if the product is unpublished" do
        authorization_purchase = build(:purchase, link: @product, chargeable: @good_card, purchase_state: "in_progress", is_preorder_authorization: true)
        preorder = @preorder_product.build_preorder(authorization_purchase)
        preorder.authorize!
        preorder.mark_authorization_successful
  ...
  test "does not create a license for the preorder authorization but it should when the preorder concludes successfully" do
        ...
        charge_purchase = preorder.purchases.last
        expect(charge_purchase.purchase_state).to eq "successful"
        expect(charge_purchase.license).not_to be(nil)
      end

  test "associates the charge to the affiliate if the authorization was associated to the affiliate" do
  ...
  test "has was_product_recommended be true for purchase, charge the extra fee, and update recommended_purchase_info" do
        @product.update!(price_cents: 10_00)
        authorization_purchase = build(:purchase, link: @product, chargeable: @good_card, purchase_state: "in_progress", is_preorder_authorization: true,
