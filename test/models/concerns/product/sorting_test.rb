...
class ProductSortingTest < ActiveSupport::TestCase
  self.described_class = Product::Sorting



  context_ Product::Sorting do
  ...
  test "returns products sorted by successful sales count" do
  ...
  test "returns products sorted by status" do
  ...
  test "returns products sorted by collaborator cut" do
  ...
  test "returns products sorted by whether a taxonomy is present" do
  ...
  test "returns products sorted by whether displaying product reviews is enabled" do
  ...
  test "returns products sorted by revenue" do
        order = [product4, product3, product1, product2].map(&:name)
  ...
  context_ ".elasticsearch_sorted_and_paginated_by" do
  ...
  test "returns products sorted by price" do
  ...
  test "returns products sorted by whether the product is recommendable" do
  ...
  context_ ".elasticsearch_key?" do
  test "returns true only for ElasticSearch sort keys" do
