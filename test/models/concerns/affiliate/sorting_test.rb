...
class AffiliateSortingTest < ActiveSupport::TestCase
  self.described_class = Affiliate::Sorting



  context_ Affiliate::Sorting do
  ...
  context_ "affiliate username is their external_id because a custom username has not been set" do
  test "returns affiliates sorted by the affiliate user's unconfirmed e-mail if present" do
  ...
  test "returns affiliates sorted by the affiliate user's e-mail if unconfirmed e-mail is not present" do
  ...
  test "returns affiliates sorted by the affiliate user's username if name is not present and a custom username is set" do
  ...
  test "returns affiliates sorted by # of products" do
  ...
  test "returns affiliates sorted by the lowest product commission percentage" do
        order = [affiliate_user_3, affiliate_user_2, affiliate_user_1]
  ...
  test "returns affiliates sorted by total sales" do
        order = [affiliate_user_3, affiliate_user_1, affiliate_user_2]
