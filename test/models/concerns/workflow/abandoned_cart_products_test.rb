...
class WorkflowAbandonedCartProductsTest < ActiveSupport::TestCase
  self.described_class = Workflow::AbandonedCartProducts



  context_ Workflow::AbandonedCartProducts do
    include Rails.application.routes.url_helpers

  context_ "#abandoned_cart_products" do
  ...
  context_ "when it is not an abandoned cart workflow" do
  ...
  context_ "when it is an abandoned cart workflow" do
  context_ "when 'bought_products', 'bought_variants', 'not_bought_products', and 'not_bought_variants' are not provided" do
  test "returns all products and variants that are not archived" do
  ...
  test "includes the product if at least one of its variant is selected" do
  ...
  test "includes the product along with all its variants if it is selected and one of its variant is selected" do
