...
class PurchaseCustomFieldsTest < ActiveSupport::TestCase
  self.described_class = Purchase::CustomFields



  context_ Purchase::CustomFields do
  ...
  context_ "when there are custom field records" do
        before do
  ...
  test "returns the custom field records" do
  ...
  context_ "when there are no custom field records" do
