...
class SearchIndexModelCommonTest < ActiveSupport::TestCase
  self.described_class = SearchIndexModelCommon


  context_ SearchIndexModelCommon do
    before do
  ...
  context_ ".search_fields" do
  test "returns a list of search fields for the index" do
