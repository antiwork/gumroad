...
class BillingDetailTest < ActiveSupport::TestCase
  self.described_class = BillingDetail



  context_ BillingDetail do
  ...
  context_ "#to_invoice_address_fields" do
  test "returns the address fields formatted for the invoice presenter" do
  ...
  context_ "User#billing_detail" do
