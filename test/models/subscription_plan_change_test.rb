...
class SubscriptionPlanChangeTest < ActiveSupport::TestCase
  self.described_class = SubscriptionPlanChange



  context_ SubscriptionPlanChange do
  ...
  context_ "scopes" do
  context_ ".applicable_for_product_price_change_as_of" do
  test "returns the applicable product price changes as of a given date" do
  ...
  context_ ".currently_applicable" do
  test "returns the currently applicable plan changes" do
  ...
  context_ "#formatted_display_price" do
  ...
  test "returns the formatted price for a subscription with a set end date" do
