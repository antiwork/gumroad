...
class TeamInvitationTest < ActiveSupport::TestCase
  self.described_class = TeamInvitation



  context_ TeamInvitation do
  ...
  test "allows creating a new record with same email" do
          expect do
  ...
  test "returns apropriate boolean value" do
  ...
  context_ "#from_gumroad_account?" do
  context_ "when seller.gumroad_account? is false" do
        let(:team_invitation) { create(:team_invitation, seller:) }
  ...
  context_ "when seller.gumroad_account? is true" do
