...
class StripeCreateMerchantAccountsWorkerTest < ActiveSupport::TestCase
  self.described_class = StripeCreateMerchantAccountsWorker
  self.rspec_metadata = { vcr: true }



  context_ StripeCreateMerchantAccountsWorker, :vcr do
  context_ "perform" do
  context_ "don't queue users who have merchant accounts already" do
  ...
  test "only queues the users that don't have merchant accounts" do
  ...
  context_ "even if the merchant account has been marked as deleted" do
          before do
            user_2.reload.merchant_accounts.last.mark_deleted!
          end

  test "only queues the users that have never had a merchant account" do
            described_class.new.perform
  ...
  context_ "don't queue users outside of our support stripe connect countries" do
        let(:user_1) { create(:user, user_risk_state: "compliant") }
        let(:user_compliance_info_1) { create(:user_compliance_info, user: user_1) }
        let(:tos_agreement_1) { create(:tos_agreement, user: user_1) }
        let(:bank_account_1) { create(:ach_account, user: user_1) }
  ...
  test "only queues the users in the US and Canada" do
          described_class.new.perform
  ...
  context_ "queue users who have a bank account" do
        let(:user_1) { create(:user, user_risk_state: "compliant") }
        let(:user_compliance_info_1) { create(:user_compliance_info, user: user_1) }
        let(:tos_agreement_1) { create(:tos_agreement, user: user_1) }
        let(:bank_account_1) { create(:ach_account, user: user_1) }
  ...
  test "only queues the users with bank accounts" do
          described_class.new.perform
  ...
  context_ "queue users who have agreed to the tos agreement" do
        let(:user_1) { create(:user, user_risk_state: "compliant") }
        let(:user_compliance_info_1) { create(:user_compliance_info, user: user_1) }
        let(:tos_agreement_1) { create(:tos_agreement, user: user_1) }
        let(:bank_account_1) { create(:ach_account, user: user_1) }
  ...
  test "only queues the users who have agreed to tos" do
          described_class.new.perform
  ...
  context_ "queue users who have received a balance in the last 3 months" do
        let(:user_1) { create(:user, user_risk_state: "compliant") }
        let(:user_compliance_info_1) { create(:user_compliance_info, user: user_1) }
        let(:tos_agreement_1) { create(:tos_agreement, user: user_1) }
        let(:bank_account_1) { create(:ach_account, user: user_1) }
  ...
  test "only queues the users in the US" do
          described_class.new.perform
  ...
  context_ "don't queue users in countries where new merchant account creation is blocked" do
        let(:user_1) { create(:user, user_risk_state: "compliant") }
        let(:user_compliance_info_1) { create(:user_compliance_info, user: user_1) }
        let(:tos_agreement_1) { create(:tos_agreement, user: user_1) }
        let(:bank_account_1) { create(:ach_account, user: user_1) }
  ...
  test "does not enqueue users from blocked countries" do
          described_class.new.perform
  ...
  context_ "queue users who are compliant and not reviewed, and not other users" do
        let(:user_1) { create(:user, user_risk_state: "compliant") }
        let(:user_compliance_info_1) { create(:user_compliance_info, user: user_1) }
        let(:tos_agreement_1) { create(:tos_agreement, user: user_1) }
        let(:bank_account_1) { create(:ach_account, user: user_1) }
