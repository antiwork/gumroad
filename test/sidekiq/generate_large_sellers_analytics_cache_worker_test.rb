...
class GenerateLargeSellersAnalyticsCacheWorkerTest < ActiveSupport::TestCase
  self.described_class = GenerateLargeSellersAnalyticsCacheWorker



  context_ GenerateLargeSellersAnalyticsCacheWorker do
  context_ "#perform" do
      before do
        @user_1 = create(:user)
  ...
  test "calls CreatorAnalytics::CachingProxy#generate_cache on large sellers" do
  ...
  test "rescues and report errors" do
        # user 1
