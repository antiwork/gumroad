...
class RegenerateCreatorAnalyticsCacheWorkerTest < ActiveSupport::TestCase
  self.described_class = RegenerateCreatorAnalyticsCacheWorker



  context_ RegenerateCreatorAnalyticsCacheWorker do
  context_ "#perform" do
  test "runs CreatorAnalytics::CachingProxy#overwrite_cache" do
        user = create(:user)
