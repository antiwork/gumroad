...
class SendWorkflowPostEmailsJobTest < ActiveSupport::TestCase
  self.described_class = SendWorkflowPostEmailsJob
  self.rspec_metadata = { freeze_time: true }



  context_ SendWorkflowPostEmailsJob, :freeze_time do
    before do
  ...
  test "only considers audience members created after the earliest_valid_time" do
  ...
  test "when product_type? is true, it enqueues the expected emails at the right times" do
  ...
  test "when variant_type? is true, it sends the expected emails at the right times" do
  ...
  test "when seller_type? is true, it sends the expected emails at the right times" do
  ...
  test "when follower_type? is true, it sends the expected emails at the right times" do
  ...
  test "when affiliate_type? is true, it sends the expected emails at the right times" do
  ...
  test "when audience_type? is true, it sends the expected emails at the right times" do
          described_class.new.perform(@post.id)
