...
class DeleteProductFilesArchivesWorkerTest < ActiveSupport::TestCase
  self.described_class = DeleteProductFilesArchivesWorker



  context_ DeleteProductFilesArchivesWorker do
    before do
  ...
  context_ ".perform" do
  context_ "when given a product_id" do
  test "deletes the corresponding product and variant archives when the product is deleted" do
  ...
  context_ "when given a variant_id" do
  test "deletes the corresponding variant archives when the variant is deleted" do
