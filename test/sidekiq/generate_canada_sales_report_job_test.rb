...
class GenerateCanadaSalesReportJobTest < ActiveSupport::TestCase
  self.described_class = GenerateCanadaSalesReportJob



  context_ GenerateCanadaSalesReportJob do
    let(:month) { 8 }
    let(:year) { 2022 }
  ...
  test "raises an agrument error if the month is out of bounds" do
  ...
  test "creates a CSV file for Canada sales" do
