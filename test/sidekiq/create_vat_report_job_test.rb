...
class CreateVatReportJobTest < ActiveSupport::TestCase
  self.described_class = CreateVatReportJob



  context_ CreateVatReportJob do
  ...
  test "raises an ArgumentError if the quarter is not within 1 and 4 inclsusive" do
      expect do
  ...
  test "returns a zipped file containing a csv file for every month in the quarter" do
