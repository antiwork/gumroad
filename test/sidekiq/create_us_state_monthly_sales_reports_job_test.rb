...
class CreateUsStateMonthlySalesReportsJobTest < ActiveSupport::TestCase
  self.described_class = CreateUsStateMonthlySalesReportsJob



  context_ CreateUsStateMonthlySalesReportsJob do
  ...
  test "raises an argument error if the subdivision code is not valid" do
  ...
  test "creates CSV files for sales into the state of Washington" do
