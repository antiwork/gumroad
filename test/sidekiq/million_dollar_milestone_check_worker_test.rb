...
class MillionDollarMilestoneCheckWorkerTest < ActiveSupport::TestCase
  self.described_class = MillionDollarMilestoneCheckWorker



  context_ MillionDollarMilestoneCheckWorker do
  context_ "#perform" do
  ...
  test "does not send Slack notification if million dollar milestone is reached but announcement has already been " \
         "sent" do
