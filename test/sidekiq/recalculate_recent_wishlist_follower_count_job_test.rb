...
class RecalculateRecentWishlistFollowerCountJobTest < ActiveSupport::TestCase
  self.described_class = RecalculateRecentWishlistFollowerCountJob



  context_ RecalculateRecentWishlistFollowerCountJob do
  context_ "#perform" do
  ...
  test "updates recent_follower_count for all wishlists" do
        expect do
