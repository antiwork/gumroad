...
class UpdateCachedSalesRelatedProductsInfosJobTest < ActiveSupport::TestCase
  self.described_class = UpdateCachedSalesRelatedProductsInfosJob



  context_ UpdateCachedSalesRelatedProductsInfosJob do
  context_ "#perform" do
      before do
  ...
  test "creates or update cache record of related products sales counts" do
        # creates record
        expect do
