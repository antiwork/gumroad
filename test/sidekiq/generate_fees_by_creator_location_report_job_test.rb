...
class GenerateFeesByCreatorLocationReportJobTest < ActiveSupport::TestCase
  self.described_class = GenerateFeesByCreatorLocationReportJob



  context_ GenerateFeesByCreatorLocationReportJob do
    let(:month) { 8 }
    let(:year) { 2022 }
  ...
  test "creates a CSV file for creator fees by location" do
