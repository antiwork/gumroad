...
class CreateLicensesForExistingCustomersWorkerTest < ActiveSupport::TestCase
  self.described_class = CreateLicensesForExistingCustomersWorker



  context_ CreateLicensesForExistingCustomersWorker do
  context_ "#perform" do
      before(:each) do
  ...
  test "creates licenses for past purchases" do
        expect do
  ...
  test "creates licenses for past purchases only if they do not already exist" do
  ...
  test "creates licenses for giftee purchases but not gifter purchases" do
  ...
  test "creates licenses for only the original purchases of subscriptions and not the recurring charges" do
        user = create(:user)
