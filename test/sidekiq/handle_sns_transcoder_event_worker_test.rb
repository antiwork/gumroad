...
class HandleSnsTranscoderEventWorkerTest < ActiveSupport::TestCase
  self.described_class = HandleSnsTranscoderEventWorker



  context_ HandleSnsTranscoderEventWorker do
  context_ "#perform" do
      before do
  ...
  test "marks the transcoded_video object as completed", :vcr do
  ...
  test "marks the transcoded_video object as failed", :vcr do
