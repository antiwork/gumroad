...
class SendLastPostJobTest < ActiveSupport::TestCase
  self.described_class = SendLastPostJob



  context_ SendLastPostJob do
  context_ "#perform" do
