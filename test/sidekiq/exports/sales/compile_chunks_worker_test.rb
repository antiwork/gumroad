...
class ExportsSalesCompileChunksWorkerTest < ActiveSupport::TestCase
  self.described_class = Exports::Sales::CompileChunksWorker



  context_ Exports::Sales::CompileChunksWorker do
    before do
  ...
  test "destroys export and chunks" do
      @worker.perform(@export.id)
