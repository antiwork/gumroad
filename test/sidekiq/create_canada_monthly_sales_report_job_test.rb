...
class CreateCanadaMonthlySalesReportJobTest < ActiveSupport::TestCase
  self.described_class = CreateCanadaMonthlySalesReportJob



  context_ CreateCanadaMonthlySalesReportJob do
    let(:month) { 1 }
    let(:year) { 2015 }
  ...
  test "creates a CSV file for all sales into Canada" do
