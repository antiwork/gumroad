...
shared_examples_for "authorized oauth v1 api method" do
test "errors out if you aren't authenticated" do
...
shared_examples_for "authorized oauth v1 api method only for edit_products scope" do
test "errors out if you aren't authenticated" do
    raise "no @action in before block of test" unless @action
    raise "no @params in before block of test" unless @params
