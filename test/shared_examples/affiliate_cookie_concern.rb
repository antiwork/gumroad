...
shared_examples_for "AffiliateCookie concern" do
  before do
    @frozen_time = Time.current
    travel_to(@frozen_time)
  end

test "sets affiliate cookie" do
    make_request
...
test "does not set affiliate cookie if affiliate is not alive and is affiliated to other creators" do
...
context_ "when direct affiliate is deleted and other direct affiliates exist" do
test "sets affiliate cookie to last alive direct affiliate" do
