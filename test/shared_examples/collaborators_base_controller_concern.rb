...
shared_examples_for "inherits from Collaborators::BaseController" do
  it_behaves_like "inherits from Sellers::BaseController"

test "inherits from Collaborators::BaseController and uses inertia layout" do
...
shared_examples_for "collaborator disabled reason sent" do |verb, action|
test "on #{verb}: #{action}" do
...
shared_examples_for "invalid collaborator records" do |verb, action|
test "returns not found for invalid collaborator records" do
