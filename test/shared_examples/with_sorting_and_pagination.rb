...
shared_examples_for "an API for sorting and pagination" do |action|
test "correctly sorts and paginates the records" do
...
shared_examples_for "a table with sorting" do |table_name|
test "correctly sorts the records" do
...
shared_context "with products and memberships" do |archived: false|
