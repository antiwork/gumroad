...
shared_examples_for "a product with 'Download all' buttons on file embed groups" do
  before do
...
test "shows 'Download all' buttons on file embed groups" do
    visit(url)
...
test "downloads the individual file when pressing 'Download all' for a file embed group with only 1 downloadable file" do
...
test "shows 'Zipping files...' when the folder archive is not ready when pressing 'Download all'" do
...
test "saves the files to Dropbox when pressing 'Save to Dropbox'" do
    visit(url)
