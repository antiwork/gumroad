...
test "shows the discover layout when the param is passed" do
    visit discover_url
...
test "sorts discover categories using recommended products" do
...
test "navigates to a taxonomy page when clicking a menu item" do
    visit discover_url
