...
class CommunityChatRecapMailerTest < ActionMailer::TestCase
  self.described_class = CommunityChatRecapMailer
  tests CommunityChatRecapMailer



  context_ CommunityChatRecapMailer do
  context_ "community_chat_recap_notification" do
  ...
  context_ "when sending daily recap" do
  ...
  test "emails to user with daily recap" do
  ...
  context_ "when sending weekly recap" do
  ...
  test "emails to user with weekly recap" do
          expect(mail.to).to eq([user.form_email])
  ...
  context_ "when recap spans multiple months" do
  ...
  context_ "when recap spans different months in same year" do
