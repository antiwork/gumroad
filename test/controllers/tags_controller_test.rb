...
class TagsControllerTest < ActionController::TestCase
  self.described_class = TagsController
  tests TagsController



  context_ TagsController do
  context_ "List tags" do
  test "Shows matching tags alphabetically" do
  ...
  test "Shows popular tags first" do
  ...
  test "Shows success false if no text is passed in" do
        get(:index)
