...
class DiscoverSearchAutocompleteControllerTest < ActionController::TestCase
  self.described_class = Discover::SearchAutocompleteController
  tests Discover::SearchAutocompleteController



  context_ Discover::SearchAutocompleteController do
    render_views

  context_ "#delete_search_suggestion" do
  ...
  test "removes the search suggestion for the user" do
  ...
  test "removes the search suggestion for the browser_guid" do
  ...
  test "does not remove search suggestions for other users or browser_guids" do
