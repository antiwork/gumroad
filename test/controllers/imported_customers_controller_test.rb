...
class ImportedCustomersControllerTest < ActionController::TestCase
  self.described_class = ImportedCustomersController
  tests ImportedCustomersController



  context_ ImportedCustomersController do
  ...
  test "returns the correct number of imported customers on first page" do
  ...
  test "returns the correct number of imported customers on last page" do
