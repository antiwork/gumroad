...
class BundlesContentControllerTest < ActionController::TestCase
  self.described_class = Bundles::ContentController
  tests Bundles::ContentController



  context_ Bundles::ContentController, inertia: true do
  ...
  test "renders the Bundles/Content/Edit Inertia component with expected props" do
  ...
  test "updates bundle products and redirects" do
        expect do
          put :update, params: {
  ...
  context_ "adding a call to a bundle" do
        let(:call_product) { create(:call_product, user: seller) }

  test "does not make any changes to the bundle and returns an error" do
          expect do
            put :update, params: {
              bundle_id: bundle.external_id,
              products: [
            ...
            bundle.reload
          end.not_to change { bundle.bundle_products.count }
  ...
  context_ "when adding a product with a single alive variant and no variant_id" do
  ...
  test "updates bundle products successfully" do
          put :update, params: {
            bundle_id: bundle.external_id,
            products: [
              {
  ...
  test "returns the error message when published bundle has no products" do
          put :update, params: {
  ...
  context_ "PUT update_purchases_content" do
  test "updates the purchases content and redirects" do
