...
class BundlesShareControllerTest < ActionController::TestCase
  self.described_class = Bundles::ShareController
  tests Bundles::ShareController



  context_ Bundles::ShareController, inertia: true do
  ...
  context_ "when bundle is published" do
  test "renders the Bundles/Share/Edit Inertia component with expected props" do
  ...
  test "redirects to content page with alert" do
          get :edit, params: { bundle_id: bundle.external_id }
  ...
  test "updates section_ids and redirects" do
        expect do
          put :update, params: {
  ...
  test "updates discover attributes" do
        expect do
          put :update, params: {
            bundle_id: bundle.external_id,
  ...
  context_ "when unpublishing" do
  test "unpublishes and redirects to content page" do
          expect do
            put :update, params: {
              bundle_id: bundle.external_id,
              unpublish: true
