...
class BundlesProductControllerTest < ActionController::TestCase
  self.described_class = Bundles::ProductController
  tests Bundles::ProductController



  context_ Bundles::ProductController, inertia: true do
  ...
  test "renders the Bundles/Product/Edit Inertia component with expected props" do
  ...
  context_ "when the bundle doesn't exist" do
  test "returns 404" do
  ...
  context_ "when bundle is unpublished" do
        let(:bundle) { create(:product, :bundle, :unpublished, user: seller, price_cents: 2000) }

  test "redirects to content page after saving" do
          put :update, params: bundle_params
  ...
  context_ "when bundle is eligible for installment plans" do
  context_ "with no existing plans" do
  test "creates a new installment plan" do
  ...
  context_ "with an existing plan" do
  ...
  context_ "with no existing payment options" do
  ...
  context_ "with existing payment options" do
              before do
  ...
  test "soft deletes the existing plan" do
                params = bundle_params.merge(installment_plan: nil)
  ...
  context_ "when bundle is not eligible for installment plans" do
  ...
  context_ "when bundle has customizable price" do
  ...
  test "updates the bundle refund policy" do
          put :update, params: bundle_params
          bundle.reload
  ...
  context_ "with bundle refund policy enabled" do
          before do
  ...
  context_ "when there is a validation error" do
  test "returns the error message" do
          ...
          end.not_to change { bundle.reload.custom_permalink }
  ...
  context_ "when price_cents exceeds integer limit" do
  test "redirects with an error message" do
  ...
  context_ "product is membership" do
  ...
  context_ "product has variants" do
