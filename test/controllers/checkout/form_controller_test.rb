...
class CheckoutFormControllerTest < ActionController::TestCase
  self.described_class = Checkout::FormController
  tests Checkout::FormController



  context_ Checkout::FormController do
    render_views
  ...
  test "updates the seller's checkout form" do
        expect do
          put :update, params: {
  ...
  test "updates custom fields and deletes ones that aren't included" do
  ...
  context_ "when validation fails" do
  test "redirects with error flash and inertia errors" do
