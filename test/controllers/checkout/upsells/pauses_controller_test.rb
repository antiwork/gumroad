...
class CheckoutUpsellsPausesControllerTest < ActionController::TestCase
  self.described_class = Checkout::Upsells::PausesController
  tests Checkout::Upsells::PausesController



  context_ Checkout::Upsells::PausesController do
  ...
  context_ "when upsell doesn't exist" do
