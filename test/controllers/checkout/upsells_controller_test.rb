...
class CheckoutUpsellsControllerTest < ActionController::TestCase
  self.described_class = Checkout::UpsellsController
  tests Checkout::UpsellsController



  context_ Checkout::UpsellsController do
  ...
  test "returns HTTP success and assigns correct instance variables" do
  ...
  test "returns the upsell's statistics" do
  ...
  context_ "GET cart_item" do
  context_ "product belongs to seller" do
        let(:product) { create(:product, user: seller) }

  test "returns the a cart item for the product" do
  ...
  context_ "product doesn't belong to seller" do
  ...
  test "returns HTTP success and creates an upsell" do
        expect do
          post :create, params: {
            name: "Course upsell",
  ...
  context_ "when the upsell is a cross-sell" do
  test "returns HTTP success and creates an upsell" do
          expect do
            post :create, params: {
              name: "Course upsell",
  ...
  test "returns the associated error message" do
          expect do
            post :create, params: {
              name: "Course upsell",
              text: "Complete course upsell",
  ...
  context_ "when offering a call as upsell" do
  ...
  test "allows updating a cross-sell to an upsell" do
        expect do
          put :update, params: {
  ...
  test "allows updating an upsell to a cross-sell" do
        expect do
          put :update, params: {
  ...
  test "allows updating a cross-sell's offer code" do
        expect do
          put :update, params: {
            id: upsell1.external_id,
