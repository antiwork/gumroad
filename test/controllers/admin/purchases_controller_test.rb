...
class AdminPurchasesControllerTest < ActionController::TestCase
  self.described_class = Admin::PurchasesController
  self.rspec_metadata = { vcr: true }
  tests Admin::PurchasesController



  context_ Admin::PurchasesController, :vcr, inertia: true do
  ...
  test "raises ActionController::RoutingError when purchase is not found" do
        expect { get :show, params: { external_id: "invalid-id" } }.to raise_error(ActionController::RoutingError)
      end

  test "finds the purchase correctly when loaded via external id" do
  ...
  test "finds the purchase correctly when loaded via numeric external id" do
  ...
  test "finds the purchase correctly when loaded via stripe_transaction_id" do
  ...
  test "refunds the purchase and blocks the buyer" do
  ...
  test "returns error when tax refund fails" do
  ...
  test "handles purchase that is already undeleted" do
  ...
  test "handles purchase without purchaser" do
  ...
  context_ "when updating email for subscription purchases" do
