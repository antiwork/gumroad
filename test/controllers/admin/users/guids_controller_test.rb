...
class AdminUsersGuidsControllerTest < ActionController::TestCase
  self.described_class = Admin::Users::GuidsController
  tests Admin::Users::GuidsController



  context_ Admin::Users::GuidsController do
  ...
  test "returns unique browser GUIDs with unique user IDs for the supplied user ID" do
  ...
  test "returns an empty array when no GUIDs are found for the user" do
  ...
  test "returns only GUIDs associated with the specified user" do
