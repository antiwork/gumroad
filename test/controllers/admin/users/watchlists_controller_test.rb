...
class AdminUsersWatchlistsControllerTest < ActionController::TestCase
  self.described_class = Admin::Users::WatchlistsController
  tests Admin::Users::WatchlistsController



  context_ Admin::Users::WatchlistsController do
  ...
  test "adds the user to the watchlist with the given threshold and notes" do
        post :create, params: {
  ...
  test "rejects a missing or non-positive threshold" do
  ...
  test "rejects when the user is already being watched" do
  ...
  test "updates the threshold and notes on the active watch" do
  ...
  test "returns an error when the user is not currently being watched" do
        patch :update, params: {
          user_external_id: user.external_id,
  ...
  test "soft-deletes the active watch" do
