...
class AdminSearchUsersControllerTest < ActionController::TestCase
  self.described_class = Admin::Search::UsersController
  tests Admin::Search::UsersController



  context_ Admin::Search::UsersController, type: :controller, inertia: true do
    render_views
  ...
  test "searches for users with partial email" do
