...
class AdminAffiliatesControllerTest < ActionController::TestCase
  self.described_class = Admin::AffiliatesController
  tests Admin::AffiliatesController



  context_ Admin::AffiliatesController, inertia: true do
    render_views
  ...
  context_ "when there's one matching affiliate in search result" do
        before do
          @affiliate_user = create(:direct_affiliate).affiliate_user
        end

  test "redirects to affiliate's admin page" do
  ...
  context_ "when there are multiple affiliates in search result" do
        before do
  ...
  test "returns JSON response when requested" do
  ...
  context_ "when affiliate account is present" do
        before do
  ...
  test "returns page successfully with external_id" do
  ...
  context_ "when affiliate account is not present" do
