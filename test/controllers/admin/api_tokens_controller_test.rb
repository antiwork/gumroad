...
class AdminApiTokensControllerTest < ActionController::TestCase
  self.described_class = Admin::ApiTokensController
  tests Admin::ApiTokensController



  context_ Admin::ApiTokensController, type: :controller, inertia: true do
    render_views
  ...
  test "lists active admin API tokens with actor and type" do
  ...
  test "revokes an active admin API token for any actor" do
  ...
  test "does not revoke an inactive token" do
