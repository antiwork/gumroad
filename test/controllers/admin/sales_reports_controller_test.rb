...
class AdminSalesReportsControllerTest < ActionController::TestCase
  self.described_class = Admin::SalesReportsController
  tests Admin::SalesReportsController



  context_ Admin::SalesReportsController, type: :controller, inertia: true do
    render_views
  ...
  test "enqueues a GenerateSalesReportJob with string dates" do
  ...
  test "stores job details in Redis" do
  ...
  test "303 redirects to the sales reports page with a success message" do
        post :create, params: params
  ...
  test "converts dates to strings before passing to job" do
  ...
  context_ "when the form is invalid" do
        let(:params) do
          {
            sales_report: {
              country_code: "",
  ...
  test "302 redirects to the sales reports page with an error message" do
          post :create, params: params
