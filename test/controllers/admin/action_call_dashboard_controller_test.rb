...
class AdminActionCallDashboardControllerTest < ActionController::TestCase
  self.described_class = Admin::ActionCallDashboardController
  tests Admin::ActionCallDashboardController



  context_ Admin::ActionCallDashboardController, type: :controller, inertia: true do
    render_views
  ...
  test "renders the inertia page with admin_action_call_infos ordered by call_count descending" do
