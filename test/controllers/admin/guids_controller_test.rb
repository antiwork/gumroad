...
class AdminGuidsControllerTest < ActionController::TestCase
  self.described_class = Admin::GuidsController
  tests Admin::GuidsController



  context_ Admin::GuidsController, type: :controller, inertia: true do
    render_views
  ...
  test "returns unique users for the supplied browser GUID" do
        get :show, params: { id: browser_guid }
  ...
  test "returns an empty array when no users are found for the GUID" do
  ...
  test "returns only users with events for the specific GUID" do
