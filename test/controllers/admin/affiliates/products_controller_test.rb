...
class AdminAffiliatesProductsControllerTest < ActionController::TestCase
  self.described_class = Admin::Affiliates::ProductsController
  tests Admin::Affiliates::ProductsController



  context_ Admin::Affiliates::ProductsController, inertia: true do
    render_views
