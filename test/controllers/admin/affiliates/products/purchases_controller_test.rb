...
class AdminAffiliatesProductsPurchasesControllerTest < ActionController::TestCase
  self.described_class = Admin::Affiliates::Products::PurchasesController
  tests Admin::Affiliates::Products::PurchasesController



  context_ Admin::Affiliates::Products::PurchasesController do
  ...
  test "returns purchases and pagination for the affiliate" do
  ...
  test "returns only purchases for the affiliate user" do
  ...
  test "does not return affiliate purchases from other products" do
