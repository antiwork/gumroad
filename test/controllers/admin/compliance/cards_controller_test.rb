...
class AdminComplianceCardsControllerTest < ActionController::TestCase
  self.described_class = Admin::Compliance::CardsController
  tests Admin::Compliance::CardsController



  context_ Admin::Compliance::CardsController do
  ...
  context_ "when stripe_fingerprint is blank" do
  ...
  context_ "when stripe_fingerprint is not blank" do
  ...
  test "only refunds purchases from the last 6 months" do
