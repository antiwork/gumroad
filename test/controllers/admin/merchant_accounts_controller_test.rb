...
class AdminMerchantAccountsControllerTest < ActionController::TestCase
  self.described_class = Admin::MerchantAccountsController
  tests Admin::MerchantAccountsController



  context_ Admin::MerchantAccountsController, type: :controller, inertia: true do
    render_views
  ...
  test "renders the page successfully with external_id" do
  ...
  test "renders the page successfully with charge_processor_merchant_id" do
