...
class AdminPayoutsControllerTest < ActionController::TestCase
  self.described_class = Admin::PayoutsController
  tests Admin::PayoutsController



  context_ Admin::PayoutsController, type: :controller, inertia: true do
  ...
  test "redirects numeric ID to external_id URL" do
        sign_in admin_user
  ...
  context_ "POST retry" do
  test "retries a failed payout" do
  ...
  test "cancels an unclaimed paypal payout" do
  ...
  context_ "POST fail" do
  test "marks a processing payout as failed" do
  ...
  context_ "POST sync" do
  test "syncs a paypal payout" do
