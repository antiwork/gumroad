...
class SettingsTeamControllerTest < ActionController::TestCase
  self.described_class = Settings::TeamController
  tests Settings::TeamController



  context_ Settings::TeamController, type: :controller, inertia: true do
  ...
  context_ "when user does not have an email" do
        before do
          seller.update!(
            provider: :twitter,
            twitter_user_id: "123",
