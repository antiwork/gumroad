...
class SettingsAuthorizedApplicationsControllerTest < ActionController::TestCase
  self.described_class = Settings::AuthorizedApplicationsController
  tests Settings::AuthorizedApplicationsController



  context_ Settings::AuthorizedApplicationsController, type: :controller, inertia: true do
