...
class SettingsTeamMembersControllerTest < ActionController::TestCase
  self.described_class = Settings::Team::MembersController
  tests Settings::Team::MembersController



  context_ Settings::Team::MembersController do
  ...
  test "marks record as deleted" do
  ...
  test "removes the is_team_member flag from the user" do
          delete :destroy, params: { id: team_membership.external_id }, as: :json
  ...
  test "marks record as not deleted" do
