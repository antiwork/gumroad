...
class SettingsThirdPartyAnalyticsControllerTest < ActionController::TestCase
  self.described_class = Settings::ThirdPartyAnalyticsController
  tests Settings::ThirdPartyAnalyticsController



  context_ Settings::ThirdPartyAnalyticsController, type: :controller, inertia: true do
  ...
  context_ "when all of the fields are valid" do
  ...
  context_ "when a field is invalid" do
  test "returns an error response and doesn't persist changes" do
          put :update, params: {
            user: {
              disable_third_party_analytics: false,
  ...
  test "returns an error response for invalid TikTok Pixel ID" do
          put :update, params: {
            user: {
  ...
  context_ "when updating throws an error" do
