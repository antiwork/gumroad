...
class ProductsOtherRefundPoliciesControllerTest < ActionController::TestCase
  self.described_class = Products::OtherRefundPoliciesController
  tests Products::OtherRefundPoliciesController



  context_ Products::OtherRefundPoliciesController do
  ...
  test "returns an array of ordered refund policies for visible and not archived products" do
