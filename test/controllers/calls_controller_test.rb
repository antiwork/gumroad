...
class CallsControllerTest < ActionController::TestCase
  self.described_class = CallsController
  tests CallsController



  context_ CallsController do
  ...
  context_ "when the update is successful" do
  test "updates the call and returns no content" do
          expect do
  ...
  context_ "when the call doesn't exist" do
