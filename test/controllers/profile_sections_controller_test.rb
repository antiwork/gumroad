...
class ProfileSectionsControllerTest < ActionController::TestCase
  self.described_class = ProfileSectionsController
  tests ProfileSectionsController



  context_ ProfileSectionsController do
  ...
  test "creates a product section" do
  ...
  test "creates a posts section" do
  ...
  test "creates a featured product section" do
  ...
  test "creates a subscribe section" do
        expect do
          post :create, params: {
  ...
  test "creates a rich text section" do
        params = {
  ...
  test "creates a section for a product" do
  ...
  test "creates a wishlists section" do
  ...
  test "updates the profile section" do
        products = create_list(:product, 2)
        patch :update, params: {
  ...
  test "disallows changing the shown_posts of a posts section" do
  ...
  test "throws a 404 error if the section does not exist" do
        expect do
          patch :update, params: { id: "no", header: "B!" }, as: :json
        end.to raise_error ActiveRecord::RecordNotFound
      end

  test "throws a 404 error if the section does not belong to the seller" do
        expect do
          patch :update, params: { id: create(:seller_profile_products_section).external_id, header: "B!" }, as: :json
        end.to raise_error ActiveRecord::RecordNotFound
      end

  test "disallows changing the type" do
        patch :update, params: {
  ...
  test "disallows changing the product id" do
        patch :update, params: {
  ...
  test "invokes SaveContentUpsellsService" do
  ...
  test "deletes the profile section" do
