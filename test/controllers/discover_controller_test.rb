...
class DiscoverControllerTest < ActionController::TestCase
  self.described_class = DiscoverController
  tests DiscoverController



  context_ DiscoverController, type: :controller, inertia: true do
  ...
  context_ "#index" do
  test "renders the Discover Inertia page with recommendation props" do
        get :index
  ...
  test "sets black friday page props when offer code is provided" do
  ...
  context_ "nav first render" do
  test "renders discover inertia payload for iPhone user-agent" do
  ...
  test "renders discover inertia payload for desktop user-agent" do
  ...
  context_ "when fetching recommendation props via inertia partial data" do
        before do
          request.headers["X-Inertia"] = "true"
          request.headers["X-Inertia-Partial-Component"] = "Discover/Index"
        end

  test "returns recommended products in partial props" do
  ...
  test "returns recommended wishlists in partial props" do
  ...
  test "only fetches search_results when filtering without taxonomy change" do
  ...
  context_ "autocomplete_results partial reload" do
  test "returns autocomplete results with empty query" do
  ...
  test "returns autocomplete results with products matching query" do
  ...
  test "stores the search query as autocomplete" do
  ...
  test "does not store search query when query is blank" do
            request.headers["X-Inertia-Partial-Data"] = "autocomplete_results"
  ...
  test "returns recent searches based on browser_guid" do
            sign_out @buyer
            cookies[:_gumroad_guid] = "custom_guid"
  ...
  test "returns recent searches for logged in user" do
  ...
  test "stores the search query" do
        cookies[:_gumroad_guid] = "custom_guid"
  ...
  context_ "when curated products fetch times out" do
  test "renders the page with empty curated products" do
  ...
  context_ "when curated products fetch raises an error" do
  test "renders the page with empty curated products" do
  ...
  test "sets the proper meta tags with no extra parameters" do
          get :index
  ...
  test "sets the proper meta tags when a search query was submitted" do
  ...
  test "sets the proper title when only taxonomy is present" do
  ...
  test "sets the proper title when tags and taxonomy are present" do
  ...
  test "sets the proper meta tags when a specific tag has been selected" do
  ...
  test "sets the proper meta tags when a specific tag has been selected with different formatting" do
          get :index, params: { tags: "3d      - mODELs" }
  ...
  context_ "meta description total count" do
  ...
  test "sets the correct total search result size in the meta description" do
            get :index, params: { tags: "3d models" }
