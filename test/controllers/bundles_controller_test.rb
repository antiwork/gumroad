...
class BundlesControllerTest < ActionController::TestCase
  self.described_class = BundlesController
  tests BundlesController



  context_ BundlesController, inertia: true do
  ...
  test "redirects to the edit product page" do
  ...
  context_ "GET create_from_email" do
  ...
  test "creates the bundle and redirects to the edit page" do
