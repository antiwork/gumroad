...
class ShipmentsControllerTest < ActionController::TestCase
  self.described_class = ShipmentsController
  self.rspec_metadata = { vcr: true }
  tests ShipmentsController



  context_ ShipmentsController, :vcr  do
  context_ "POST verify_shipping_address" do
  context_ "US address" do
        before do
          @params = {
  ...
  context_ "valid address" do
  test "calls EasyPost" do
  ...
  test "returns correct response" do
            post :verify_shipping_address, params: @params
  ...
  context_ "valid address but with minor corrections" do
            before do
  ...
  context_ "needs more information" do
          before do
  ...
  context_ "unverified address" do
          before do
  ...
  test "returns needs more information response" do
            post :verify_shipping_address, params: @params
            expect(response.parsed_body["success"]).to be(false)
  ...
  context_ "international address" do
        before do
          @params = {
  ...
  context_ "POST mark_as_shipped" do
  ...
  test "no shipment exists - should mark a purchase as shipped" do
  ...
  test "shipment exists - should mark a purchase as shipped" do
  ...
  context_ "tracking information" do
  test "no shipment exists - should mark a purchase as shipped" do
