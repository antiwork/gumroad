...
class WishlistsControllerTest < ActionController::TestCase
  self.described_class = WishlistsController
  tests WishlistsController



  context_ WishlistsController, type: :controller, inertia: true do
    render_views
  ...
  context_ "when html is requested" do
  test "renders Wishlists/Index with Inertia and non-deleted wishlists for the current seller" do
  ...
  context_ "when json is requested" do
  test "returns wishlists with the given ids" do
  ...
  test "creates a wishlist with the given name" do
  ...
  test "returns an error when name is blank" do
  ...
  test "creates a wishlist and redirects with notice" do
  ...
  test "renders Wishlists/Show with Inertia, public props, and favicon meta tags" do
  ...
  context_ "when layout is profile" do
  ...
  context_ "when layout is discover" do
  ...
  context_ "when the wishlist is deleted" do
  ...
  test "updates the wishlist name and description" do
  ...
  test "marks the wishlist and followers as deleted" do
