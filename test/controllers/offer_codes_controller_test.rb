...
class OfferCodesControllerTest < ActionController::TestCase
  self.described_class = OfferCodesController
  tests OfferCodesController



  context_ OfferCodesController do
  context_ "#compute_discount" do
  ...
  test "returns an error in response when offer code is invalid" do
  ...
  test "returns sold_out error in response when offer code is sold out" do
  ...
  test "doesn't return error in response when offer code discount is greater than the original price of the product but applicable to other product in a bundle" do
