...
class OauthAuthorizationsControllerTest < ActionController::TestCase
  self.described_class = Oauth::AuthorizationsController
  tests Oauth::AuthorizationsController



  context_ Oauth::AuthorizationsController, type: :controller do
    render_views
  ...
  context_ "GET new" do
  test "renders an unchecked admin authorization checkbox for admin users when admin scope is optional" do
  ...
  test "does not render the admin authorization checkbox for non-admin users" do
        sign_in user
  ...
  test "does not change the existing authorization page when admin scope is absent" do
  ...
  test "creates an admin authorization code and redirects with seller and admin codes when admin user opts in" do
        expect do
  ...
  test "redirects with the seller code only when admin user leaves admin authorization unchecked" do
        expect do
  ...
  test "does not create an admin authorization code for non-admin users with tampered params" do
        sign_in user
  ...
  test "keeps existing authorization behavior when admin scope is absent" do
        expect do
