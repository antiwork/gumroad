...
class PayoutsExportablesControllerTest < ActionController::TestCase
  self.described_class = Payouts::ExportablesController
  tests Payouts::ExportablesController



  context_ Payouts::ExportablesController, type: :controller do
  ...
  context_ "when the seller has payouts" do
  ...
  test "returns data with the most recent year if no year is provided" do
          get :index
  ...
  test "returns data with the most recent year if user does not have payouts in the selected year" do
  ...
  test "returns payouts for the selected year" do
  ...
  context_ "when the seller has no payouts" do
  test "populates the year-related attributes with the current year" do
  ...
  context_ "when there are payments that are not completed or not displayable" do
        before do
  ...
  test "only returns data that are both completed and displayable" do
          get :index
