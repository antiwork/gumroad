...
class ApiInternalAdminCursorPaginatedTest < ActionController::TestCase
  self.described_class = Api::Internal::Admin::CursorPaginated



  context_ Api::Internal::Admin::CursorPaginated do
