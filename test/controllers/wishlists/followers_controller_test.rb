...
class WishlistsFollowersControllerTest < ActionController::TestCase
  self.described_class = Wishlists::FollowersController
  tests Wishlists::FollowersController



  context_ Wishlists::FollowersController do
  ...
  test "returns an error if the follower is invalid" do
  ...
  test "deletes the follower and redirects to the wishlist" do
