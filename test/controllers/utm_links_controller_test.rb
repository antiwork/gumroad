...
class UtmLinksControllerTest < ActionController::TestCase
  self.described_class = UtmLinksController
  tests UtmLinksController



  context_ UtmLinksController, type: :controller, inertia: true do
  ...
  test "returns unauthorized response if the :utm_links feature flag is disabled" do
  ...
  test "renders the Inertia page with utm_links" do
  ...
  test "sorts by date in descending order by default" do
        utm_link1 = create(:utm_link, seller:, created_at: 1.day.ago)
  ...
  test "sorts UTM links by the specified column" do
  ...
  test "filters UTM links by search query" do
  ...
  context_ "when fetching only utm_links_stats via partial request" do
  ...
  test "does not call PaginatedUtmLinksPresenter" do
  ...
  test "returns stats for the requested UTM link IDs" do
  ...
  test "returns empty stats when ids param is not provided" do
  ...
  test "renders the Inertia page with form context" do
        get :new
  ...
  test "renders the Inertia page with copy_from data" do
  ...
  context_ "when fetching only additional_metadata via partial request" do
        before do
          request.headers["X-Inertia"] = "true"
  ...
  test "does not compute utm_link or context props" do
  ...
  test "returns a new unique permalink" do
  ...
  test "creates a UTM link and redirects to index" do
  ...
  test "redirects back with errors if validation fails" do
  ...
  test "redirects back with error if target resource id is missing" do
  ...
  test "redirects back with error if permalink is invalid" do
  ...
  test "allows creating a link with same UTM params but different target resource" do
  ...
  test "does not allow creating a link with same UTM params and same target resource" do
  ...
  test "raises error for missing required utm_link param" do
        expect do
          post :create, params: {}
  ...
  test "renders the Inertia page with utm_link data" do
  ...
  test "returns 404 if utm_link does not exist" do
  ...
  test "updates the UTM link and redirects to index" do
  ...
  test "returns 404 if the UTM link does not exist" do
        params[:id] = "does-not-exist"

        expect { patch :update, params: params }.to raise_error(ActionController::RoutingError)
      end

  test "returns 404 if the UTM link does not belong to the seller" do
        utm_link.update!(seller: create(:user))

        expect { patch :update, params: params }.to raise_error(ActionController::RoutingError)
      end

  test "redirects with alert if the UTM link is deleted" do
  ...
  test "soft deletes the UTM link and redirects to index" do
        expect do
  ...
  test "preserves query, page, and sort params in redirect" do
