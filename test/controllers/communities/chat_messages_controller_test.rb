...
class CommunitiesChatMessagesControllerTest < ActionController::TestCase
  self.described_class = Communities::ChatMessagesController
  tests Communities::ChatMessagesController



  context_ Communities::ChatMessagesController do
  ...
  test "raises RecordNotFound when community is not found" do
        sign_in seller
        expect do
  ...
  test "broadcasts the message to the community channel" do
  ...
  test "redirects with errors when content is invalid" do
          expect do
            post :create, params: {
              community_id: community.external_id,
  ...
  test "raises RecordNotFound when message is not found" do
          expect do
  ...
  test "broadcasts the update to the community channel" do
          expect do
            put :update, params: {
              community_id: community.external_id,
              id: message.external_id,
  ...
  test "does not allow updating other's message" do
          buyer = create(:user)
  ...
  test "broadcasts the deletion to the community channel" do
          expect do
            delete :destroy, params: { community_id: community.external_id, id: message.external_id }
          end.to have_broadcasted_to("community:community_#{community.external_id}").with(
  ...
  test "allows deleting member messages" do
          member = create(:user)
  ...
  test "does not allow deleting another user's message" do
