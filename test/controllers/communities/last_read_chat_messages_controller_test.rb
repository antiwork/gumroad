...
class CommunitiesLastReadChatMessagesControllerTest < ActionController::TestCase
  self.described_class = Communities::LastReadChatMessagesController
  tests Communities::LastReadChatMessagesController



  context_ Communities::LastReadChatMessagesController do
  ...
  test "creates a new last read record" do
  ...
  test "updates existing last read record when marking a newer message as read" do
  ...
  test "does not update last read record when marking an older message as read" do
          message1 = create(:community_chat_message, community:, user: seller, created_at: 2.minutes.ago)
          message2 = create(:community_chat_message, community:, user: seller, created_at: 1.minute.ago)
