...
class CommunitiesNotificationSettingsControllerTest < ActionController::TestCase
  self.described_class = Communities::NotificationSettingsController
  tests Communities::NotificationSettingsController



  context_ Communities::NotificationSettingsController do
  ...
  test "creates notification settings when they don't exist" do
          expect do
            put :update, params: {
  ...
  test "updates existing notification settings" do
