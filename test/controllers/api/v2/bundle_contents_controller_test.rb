...
class ApiV2BundleContentsControllerTest < ActionController::TestCase
  self.described_class = Api::V2::BundleContentsController
  tests Api::V2::BundleContentsController



  context_ Api::V2::BundleContentsController do
    before do
      @user = create(:user)
  ...
  test "assigns products to a bundle" do
  ...
  test "updates quantity, selected variant, and position" do
  ...
  test "removes products omitted from the request" do
  ...
  test "rejects invalid bundled products with validation errors" do
  ...
  test "rejects non-bundle products" do
  ...
  test "rejects bundles as bundled products" do
  ...
  test "rejects subscription products as bundled products" do
  ...
  test "rejects call products as bundled products" do
  ...
  test "clears all products from an unpublished bundle" do
  ...
  test "rejects clearing all products from a published bundle" do
          @bundle.bundle_products.create!(product: @bundled_product, quantity: 1, position: 0)
          @params.delete(:products)
  ...
  test "handles multiple products with correct positions" do
  ...
  test "rolls back all changes when one product is invalid" do
          other_user = create(:user)
          other_product = create(:product, user: other_user)
  ...
  test "rejects malformed products param" do
  ...
  test "rejects nonexistent product IDs" do
          @params[:products] = [
  ...
  test "rejects bundles owned by another seller" do
          other_user = create(:user)
  ...
  test "rejects versioned products without a variant" do
          product_with_variants = create(:product_with_digital_versions, user: @user)
