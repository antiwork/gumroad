...
class ApiV2SkusControllerTest < ActionController::TestCase
  self.described_class = Api::V2::SkusController
  tests Api::V2::SkusController



  context_ Api::V2::SkusController do
    before do
      @user = create(:user)
  ...
  test "shows the custom sku name" do
          category1 = create(:variant_category, title: "Size", link: @product)
          create(:variant, variant_category: category1, name: "Small")
          category2 = create(:variant_category, title: "Color", link: @product)
          create(:variant, variant_category: category2, name: "Red")
  ...
  test "shows the variants for a physical product with SKUs disabled" do
