...
class ApiV2LinksControllerTest < ActionController::TestCase
  self.described_class = Api::V2::LinksController
  tests Api::V2::LinksController



  context_ Api::V2::LinksController do
    before do
      @user = create(:user)
  ...
  context_ "when logged in with public scope" do
        before do
  ...
  test "omits detail-only fields from the slim response" do
  ...
  test "paginates results and returns page_key when there are more products" do
  ...
  test "returns the next page of results when page_key is provided" do
  ...
  test "does not include pagination keys when all results fit on one page" do
          get @action, params: @params
  ...
  test "returns an error for an invalid page_key" do
  ...
  context_ "when logged in with sales scope" do
        before do
  ...
  test "batch loads file_attachment and file_blob for covers (not one query per record)" do
  ...
  test "creates a digital product with minimal params" do
          expect do
  ...
  test "marks products created from the CLI and marks the user without dropping other flags" do
  ...
  test "creates a product with all optional params" do
  ...
  test "creates a membership and derives is_recurring_billing from native_type" do
          post @action, params: @params.merge(
  ...
  test "creates a bundle product" do
  ...
  test "creates a coffee product with donate prompt" do
  ...
  test "creates a call product" do
          @user.update!(created_at: 2.months.ago)
  ...
  test "rejects service types when seller is not eligible" do
  ...
  test "rejects commission when commissions feature flag is off" do
  ...
  test "rejects subscription_duration for non-membership products" do
  ...
  test "respects daily creation limit", :enforce_product_creation_limit do
  ...
  test "rejects invalid subscription_duration" do
  ...
  test "rejects invalid price_currency_type" do
  ...
  test "returns validation errors in standard format" do
  ...
  test "starts as a draft with purchase_disabled_at set" do
          post @action, params: @params
  ...
  test "rejects tags with non-string elements" do
  ...
  test "rejects non-array rich_content" do
  ...
  test "rejects rich_content pages with non-object description" do
  ...
  test "rejects rich_content with non-array wrapper content" do
  ...
  test "rejects rich_content with hash wrapper content" do
  ...
  test "rejects rich_content with non-object content nodes in wrapper" do
  ...
  test "rejects rich_content with non-object content nodes in raw array" do
  ...
  test "rejects rich_content with non-object elements" do
          post @action, params: @params.merge(rich_content: ["oops"])
  ...
  test "rejects non-array files" do
  ...
  test "rejects file objects missing url" do
  ...
  test "rejects file urls that are not the seller's S3 path" do
  ...
  test "rejects file urls with path traversal" do
  ...
  test "rejects file urls from another seller's S3 path" do
  ...
  test "rejects files with non-object elements" do
          post @action, params: @params.merge(files: ["oops"])
  ...
  context_ "rejecting legacy upload fields" do
          %i[file preview thumbnail].each do |field|
  test "rejects #{field} sent as a string" do
  ...
  test "rejects #{field} sent as a multipart upload" do
              upload = Rack::Test::UploadedFile.new(Rails.root.join("test/support/fixtures/smilie.png"), "image/png")
  ...
  test "points file rejections to the full presign and complete flow" do
  ...
  test "points preview rejections to the covers endpoint rather than presign" do
  ...
  test "points thumbnail rejections to the thumbnail endpoint rather than presign" do
  ...
  test "ignores #{field} when sent as #{blank_value.inspect}" do
  ...
  test "defaults taxonomy to 'other' when not specified" do
          post @action, params: @params
  ...
  test "uses the seller's currency when currency is omitted" do
  ...
  test "rejects invalid taxonomy_id" do
  ...
  test "creates a product with rich content pages" do
          rich_content = [
            {
  ...
  test "creates a product with files" do
  ...
  test "creates a product with files and rich content referencing those files" do
          temp_id = "temp-file-1"
  ...
  test "processes upsell-card markup in description" do
  ...
  test "returns the product in the response" do
          post @action, params: @params
  ...
  context_ "when logged in with account scope" do
        before do
          @token = create("doorkeeper/access_token", application: @app, resource_owner_id: @user.id, scopes: "account")
          @params.merge!(access_token: @token.token)
        end

  test "creates a product via API key auth" do
          expect do
            post @action, params: @params
          end.to change { @user.links.count }.by(1)
  ...
  context_ "when logged in without view_sales scope" do
        before do
          @token = create("doorkeeper/access_token", application: @app, resource_owner_id: @user.id, scopes: "view_public")
          @params.merge!(access_token: @token.token)
        end
  ...
  context_ "purchasing power parity", :vcr do
          before do
  ...
  test "includes the purchasing power parity prices" do
  ...
  test "excludes the purchasing power parity prices when disabled" do
  ...
  context_ "when the product is a membership product" do
  ...
  context_ "product JSON fields" do
        before do
          @token = create("doorkeeper/access_token", application: @app, resource_owner_id: @user.id, scopes: "view_public")
          @params.merge!(access_token: @token.token)
        end

  test "includes rich_content array" do
  ...
  test "includes has_same_rich_content_for_all_variants" do
          get :show, params: @params
          expect(response.parsed_body["product"]).to have_key("has_same_rich_content_for_all_variants")
        end

  test "includes files array with signed URLs for uploaded files" do
  ...
  test "gracefully skips files with missing S3 objects" do
  ...
  test "includes raw URL for external link files" do
  ...
  test "includes covers array and main_cover_id" do
  ...
  test "includes bundle_products for bundle products" do
  ...
  test "includes empty bundle_products for non-bundle products" do
          get :show, params: @params
          expect(response.parsed_body["product"]["bundle_products"]).to eq([])
        end

  test "includes rich_content in variant options" do
  ...
  context_ "when logged in with view_sales scope" do
        before do
          @token = create("doorkeeper/access_token", application: @app, resource_owner_id: @user.id, scopes: "view_sales")
          @params.merge!(access_token: @token.token)
        end

  test "shows me my products" do
          get :show, params: @params
          expect(response.parsed_body["product"]).to eq(@product.as_json(api_scopes: ["view_sales"]))
        end

  test "includes deprecated `custom_delivery_url` attribute" do
  ...
  test "grants access with the account scope and includes sales data" do
        token = create("doorkeeper/access_token", application: @app, resource_owner_id: @user.id, scopes: "account")
  ...
  context_ "when product is a tiered membership with no default tier" do
        before do
          token = create("doorkeeper/access_token", application: @app, resource_owner_id: @user.id, scopes: "view_public")
  ...
  test "returns product data without raising an error" do
          get :show, params: @params
  ...
  test "updates price via the price param" do
          put @action, params: @params.merge(price: 1099)
          expect(response.parsed_body["success"]).to be(true)
          expect(@product.reload.price_cents).to eq(1099)
        end

  test "rejects price that exceeds the maximum storable value" do
  ...
  test "rejects price for tiered membership products" do
  ...
  test "rejects unsupported price_currency_type" do
          put @action, params: @params.merge(price_currency_type: "xyz")
          expect(response.parsed_body["success"]).to be(false)
          expect(response.parsed_body["message"]).to include("not a supported currency")
        end

  test "processes description through SaveContentUpsellsService" do
  ...
  test "stores custom_summary in json_data" do
  ...
  test "rejects rich_content with string description" do
  ...
  test "rejects file objects missing url when no existing file id is provided" do
  ...
  test "rejects existing file id with a different url" do
  ...
  test "rejects foreign product file id with malicious url" do
  ...
  test "rejects files containing uploaded file objects" do
          upload = Rack::Test::UploadedFile.new(Rails.root.join("test/support/fixtures/smilie.png"), "image/png")
  ...
  test "rejects rich_content containing uploaded file objects" do
          upload = Rack::Test::UploadedFile.new(Rails.root.join("test/support/fixtures/smilie.png"), "image/png")
  ...
  test "points file rejections to the full presign and complete flow and describes the preservation contract" do
  ...
  test "rejects non-array cover_ids" do
  ...
  test "rejects cover_ids containing uploaded file objects" do
          upload = Rack::Test::UploadedFile.new(Rails.root.join("test/support/fixtures/smilie.png"), "image/png")
  ...
  test "rejects files when numeric-keyed params normalize into non-hash elements" do
          upload = Rack::Test::UploadedFile.new(Rails.root.join("test/support/fixtures/smilie.png"), "image/png")
  ...
  test "rejects rich_content when numeric-keyed params normalize into non-hash elements" do
          upload = Rack::Test::UploadedFile.new(Rails.root.join("test/support/fixtures/smilie.png"), "image/png")
  ...
  test "does not change native_type" do
  ...
  test "returns warning when price change invalidates existing offer codes" do
  ...
  test "rolls back all changes on validation failure" do
  ...
  test "does not touch omitted fields (partial update)" do
  ...
  test "updates rich content pages" do
  ...
  test "removes rich content pages not in the request" do
  ...
  test "does not delete existing files when only rich_content changes" do
  ...
  test "does not delete existing rich content when only files change" do
  ...
  test "rejects removing a file still referenced by product-level rich content" do
          file = create(:product_file, link: @product)
  ...
  test "allows removing a file and its embed in the same request" do
          file = create(:product_file, link: @product)
          create(:rich_content, entity: @product, title: "Page", description: [
                   { "type" => "fileEmbed", "attrs" => { "id" => file.external_id, "uid" => SecureRandom.uuid } }
                 ], position: 0)
  ...
  test "treats id-only files[] entries as keep-unchanged for existing files" do
  ...
  test "preserves rich-content embeds when id-only files[] entries match existing files" do
          file = create(:product_file, link: @product)
  ...
  test "rejects partial updates to an existing file that omit the canonical url" do
  ...
  test "rejects client-supplied modified flag on files[] entries" do
  ...
  test "preserves existing subtitle tracks when id-only files[] entry keeps a video file unchanged" do
  ...
  test "fails requests that reference a file deleted concurrently instead of resurrecting it" do
          file = create(:product_file, link: @product)
  ...
  test "supports round-tripping serialized file entries back through PUT using id only" do
  ...
  test "reorders covers via cover_ids" do
  ...
  test "runs SavePostPurchaseCustomFieldsService after rich content changes" do
  ...
  test "recomputes is_licensed after rich content changes" do
  ...
  test "returns the updated product in the response" do
  ...
  test "updates has_same_rich_content_for_all_variants to false" do
  ...
  test "updates has_same_rich_content_for_all_variants to true" do
  ...
  test "does not trigger content migration when has_same_rich_content_for_all_variants is sent unchanged alongside other flag changes" do
  ...
  test "recomputes is_licensed when has_same_rich_content_for_all_variants changes" do
          variant_category = create(:variant_category, link: @product)
          variant = create(:variant, variant_category: variant_category)
  ...
  test "runs SavePostPurchaseCustomFieldsService when has_same_rich_content_for_all_variants changes" do
          expect_any_instance_of(Product::SavePostPurchaseCustomFieldsService).to receive(:perform)
          put @action, params: @params.merge(has_same_rich_content_for_all_variants: true)
        end

  test "regenerates product file archives when has_same_rich_content_for_all_variants changes" do
          @product.update!(has_same_rich_content_for_all_variants: true)
          expect_any_instance_of(Link).to receive(:generate_product_files_archives!)
          put @action, params: @params.merge(has_same_rich_content_for_all_variants: false)
        end

  context_ "content migration when toggling has_same_rich_content_for_all_variants" do
  ...
  test "copies single variant content to product when switching to shared (true)" do
            variant1
            variant2
            @product.update!(has_same_rich_content_for_all_variants: false)
  ...
  test "rejects switching to shared when multiple variants have distinct content" do
            variant1
            variant2
            @product.update!(has_same_rich_content_for_all_variants: false)
  ...
  test "allows switching back to shared when all variants have identical content (round-trip)" do
            variant1
            variant2
            @product.update!(has_same_rich_content_for_all_variants: true)
  ...
  test "rejects switching to shared when both product and variant content exist" do
            variant1
            @product.update!(has_same_rich_content_for_all_variants: false)
  ...
  test "copies product content to all variants when switching to per-variant (false)" do
            variant1
            variant2
            @product.update!(has_same_rich_content_for_all_variants: true)
  ...
  test "rejects switching to per-variant when product has no variants" do
            @product.update!(has_same_rich_content_for_all_variants: true)
  ...
  test "rebinds variant.product_files from migrated file embeds when switching to per-variant" do
            variant1
  ...
  test "clears variant pages and writes replacement when switching to shared with rich_content" do
            variant1
            @product.update!(has_same_rich_content_for_all_variants: false)
  ...
  test "rejects switching to per-variant with rich_content in the same request" do
            variant1
            @product.update!(has_same_rich_content_for_all_variants: true)
  ...
  test "rejects product-level rich_content when already in per-variant mode" do
            variant1
            @product.update!(has_same_rich_content_for_all_variants: false)
  ...
  test "allows product-level rich_content when flag is false but no variants exist" do
            @product.update!(has_same_rich_content_for_all_variants: false)
  ...
  test "does not publish a product if it violates existing universal offer_codes" do
  ...
  test "does not publish the product" do
            put @action, params: @params
            ...
            expect(@product.purchase_disabled_at).not_to be_nil
          end
        end
  ...
  context_ "when a variant category has no alive variants" do
          before do
            @product.update!(purchase_disabled_at: 1.day.ago)
  ...
  test "returns a validation error instead of notifying error tracker" do
  ...
  test "tells you if a product can't be found" do
