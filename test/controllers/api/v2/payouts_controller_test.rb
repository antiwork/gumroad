...
class ApiV2PayoutsControllerTest < ActionController::TestCase
  self.described_class = Api::V2::PayoutsController
  tests Api::V2::PayoutsController



  context_ Api::V2::PayoutsController do
    before do
  ...
  context_ "when logged in with view_payouts scope" do
        before do
  ...
  test "returns a link to the next page if there are more than 10 payouts" do
  ...
  test "does not return payouts outside of date range" do
  ...
  test "returns a 400 error if after date format is incorrect" do
  ...
  test "returns a 400 error if before date format is incorrect" do
  ...
  test "returns a 400 error if page_key is invalid" do
  ...
  test "returns empty result set when no payouts exist in date range" do
  ...
  test "only returns payouts for the current seller" do
  ...
  test "filters by date correctly when both before and after are provided" do
  ...
  test "returns payouts in descending order by creation date" do
  ...
  context_ "upcoming payout functionality" do
          before do
  ...
  test "includes upcoming payout when no pagination and no date filtering" do
            get :index, params: @params
  ...
  test "indicates which payment processor will be used" do
  ...
  test "includes upcoming payout when end_date is after current payout end date" do
  ...
  test "does not include upcoming payout when include_upcoming is false" do
  ...
  test "does not include upcoming payout when using pagination" do
  ...
  test "does not include upcoming payout when end_date is before current payout end date" do
  ...
  test "positions upcoming payouts first in the results list" do
  ...
  test "includes upcoming payout along with completed payouts up to page limit" do
  ...
  test "does not include upcoming payout when user has no unpaid balance" do
  ...
  test "reflects current unpaid balance up to payout period end date" do
  ...
  test "does not include upcoming payout when user is not payable due to minimum threshold" do
            @seller.balances.delete_all
  ...
  test "includes upcoming payout with paused status when payouts are paused" do
  ...
  test "includes upcoming payout when the date range includes it" do
  ...
  test "handles multiple upcoming payouts correctly" do
  ...
  test "returns a payout that belongs to the seller" do
  ...
  test "includes sales in the payout response when sales exist" do
  ...
  test "includes sales array even when no sales exist" do
            get :show, params: @params
  ...
  test "excludes sales arrays if include_sales parameter is set to false" do
  ...
  test "excludes sales from the payout response" do
            product = create(:product, user: @seller)
            balance = create(:balance, user: @seller)
            @payout.balances = [balance]
            @payout.save!
  ...
  test "returns standard payout data without sales key" do
            get :show, params: @params
  ...
  test "does not return a payout that does not belong to the seller" do
  ...
  test "returns 404 for non-existent payout" do
  ...
  context_ "when include_transactions parameter is set to true", :vcr do
  ...
  test "includes the transactions array with all balance affecting transactions" do
          get :show, params: @params
  ...
  test "includes upcoming payout" do
