...
class ApiV2OfferCodesControllerTest < ActionController::TestCase
  self.described_class = Api::V2::OfferCodesController
  tests Api::V2::OfferCodesController



  context_ Api::V2::OfferCodesController do
    before do
      @user = create(:user)
  ...
  test "shows the 0 custom offers" do
          get @action, params: @params
          expect(response.parsed_body["offer_codes"]).to eq([])
        end

  test "returns a single offer code" do
  ...
  context_ "incorrect parameters" do
  ...
  test "creates a new cents offer code" do
  ...
  test "marks offer codes created from the CLI" do
  ...
  test "creates a new percent offer code" do
  ...
  test "creates a new cents offer code if amount_cents is passed in" do
  ...
  test "creates a percent offer code by ignoring amount_cents and using amount_off" do
  ...
  test "creates a new universal percent offer code" do
  ...
  test "persists a new offer code" do
            post @action, params: @params
  ...
  test "returns the correct response" do
          get @action, params: @params
  ...
  test "updates offer code max_purchase_count" do
  ...
  test "does not update the code or amount_cents" do
          put @action, params: @params
  ...
  test "works if offer code id passed in" do
          delete @action, params: @params
          expect(@product.reload.offer_codes.alive.count).to eq 0
        end

  test "deletes the universal offer code" do
