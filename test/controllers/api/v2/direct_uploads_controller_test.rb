...
class ApiV2DirectUploadsControllerTest < ActionController::TestCase
  self.described_class = Api::V2::DirectUploadsController
  tests Api::V2::DirectUploadsController



  context_ Api::V2::DirectUploadsController do
    before do
      @user = create(:user)
  ...
  test "creates a blob for direct upload and returns the signed blob token" do
          expect do
  ...
  test "returns a structured error for invalid blob parameters" do
          expect do
  ...
  test "returns structured errors when required blob parameters are omitted" do
  ...
  test "ignores client-supplied metadata" do
  ...
  test "rejects missing content type before creating a blob" do
          expect do
  ...
  test "rejects byte sizes above the upload maximum before creating a blob" do
          expect do
  ...
  test "rejects non-positive byte sizes before creating a blob" do
  ...
  test "rejects unsupported content types before creating a blob" do
          expect do
  ...
  test "rejects content types with extra trailing characters before creating a blob" do
          expect do
  ...
  test "rejects empty video subtypes before creating a blob" do
          expect do
  ...
  test "rejects non-string content types before creating a blob" do
          expect do
  ...
  test "rejects WebP images before creating a blob" do
          expect do
