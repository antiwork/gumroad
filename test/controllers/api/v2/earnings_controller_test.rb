...
class ApiV2EarningsControllerTest < ActionController::TestCase
  self.described_class = Api::V2::EarningsController
  tests Api::V2::EarningsController



  context_ Api::V2::EarningsController do
  ...
  test "returns zeroed totals for a valid year with no sales" do
          get :show, params: @params
  ...
  test "returns aggregated earnings in cents" do
  ...
  test "does not include sales from other sellers" do
          product = create(:product, user: seller, price_cents: 1000)
