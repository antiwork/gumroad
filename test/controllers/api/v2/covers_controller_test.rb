...
class ApiV2CoversControllerTest < ActionController::TestCase
  self.described_class = Api::V2::CoversController
  tests Api::V2::CoversController



  context_ Api::V2::CoversController do
    before do
      @user = create(:user)
  ...
  test "adds a file-based cover from signed_blob_id" do
  ...
  test "adds a URL-based cover", :vcr do
  ...
  test "returns a descriptive error for an unsupported file type" do
          blob = ActiveStorage::Blob.create_and_upload!(
  ...
  test "returns the correct main_cover_id when covers already exist" do
  ...
  test "returns error when neither signed_blob_id nor url is provided" do
  ...
  test "respects the maximum cover count" do
  ...
  test "returns the remaining covers and main_cover_id after deletion" do
  ...
  test "returns error when cover is not found" do
