...
class ApiInternalProductPublicFilesControllerTest < ActionController::TestCase
  self.described_class = Api::Internal::ProductPublicFilesController
  tests Api::Internal::ProductPublicFilesController



  context_ Api::Internal::ProductPublicFilesController do
  ...
  test "returns error if file fails to save" do
  ...
  test "returns 404 if product does not exist" do
  ...
  test "returns 404 if product does not belong to seller" do
