...
class ApiInternalAdminPurchasesControllerTest < ActionController::TestCase
  self.described_class = Api::Internal::Admin::PurchasesController
  tests Api::Internal::Admin::PurchasesController



  context_ Api::Internal::Admin::PurchasesController do
  context_ "GET lookup" do
  ...
  test "returns a bad request when no lookup key is provided" do
        get :lookup
  ...
  test "returns a bad request when the lookup key is blank" do
  ...
  test "returns a bad request when more than one lookup key is provided" do
  ...
  test "returns an empty purchase list when the lookup key matches nothing" do
  ...
  test "returns purchases sharing a stripe fingerprint ordered by created_at and id descending" do
  ...
  test "returns purchases sharing a browser GUID" do
        seller = create(:user)
  ...
  test "returns purchases sharing an IP address" do
        seller = create(:user)
  ...
  test "paginates lookup results with a cursor" do
        seller = create(:user)
  ...
  test "returns a bad request when the cursor is invalid" do
  ...
  test "preloads sellers instead of issuing one query per purchase row" do
  ...
  test "returns a bad request when no search parameters are provided" do
        get :search
  ...
  test "requires query when query-only modifiers are provided" do
  ...
  test "returns a bad request when purchase_status is invalid" do
  ...
  test "returns matching purchases as a capped list" do
  ...
  test "strips whitespace from query and product title search values" do
        buyer_email = "buyer@example.com"
  ...
  test "strips whitespace from exact-match search values" do
  ...
  test "preloads purchase associations before serializing search results" do
  ...
  test "preloads the affiliate_credit's affiliate_user so serialization does not fire one users SELECT per row" do
  ...
  test "uses preloaded refunds when serializing refund details" do
  ...
  test "computes amount_refundable_cents_in_currency from preloaded refunds without an extra SUM query" do
  ...
  test "does not crash when a purchase has a deleted product" do
  ...
  test "caps results and reports when more matches exist" do
  ...
  test "uses the requested limit without exceeding the hard cap" do
        stub_const("#{described_class}::MAX_SEARCH_RESULTS", 2)
        buyer_email = "buyer@example.com"
  ...
  test "returns an empty list when no purchases match" do
  ...
  test "returns a bad request when purchase_date is invalid" do
  ...
  test "returns purchase details for an exact purchase ID" do
  ...
  test "returns nil seller fields when the purchase has no seller" do
        purchase = create(:free_purchase)
  ...
  test "returns not found when the purchase ID does not exist" do
  ...
  test "does not coerce non-numeric purchase IDs" do
        purchase = create(:free_purchase)
  ...
  test "exposes the chargeback date when the purchase has been charged back" do
  ...
  test "returns the raw IP, IP country, billing country, and card country" do
        purchase = create(:free_purchase)
  ...
  test "computes country mismatch booleans across the production storage schemes (names for billing/ip, alpha-2 for card)" do
        purchase = create(:free_purchase)
  ...
  test "treats a billing/IP country name and a matching card alpha-2 as equal" do
        purchase = create(:free_purchase)
  ...
  test "treats blank country values as non-mismatches" do
        purchase = create(:free_purchase)
  ...
  test "ignores case when comparing alpha-2 codes" do
        purchase = create(:free_purchase)
        purchase.update_columns(country: "United States", ip_country: "United States", card_country: "us")
  ...
  test "returns card BIN, type, visual, and expiry" do
        purchase = create(:free_purchase)
        purchase.update_columns(
          card_bin: "424242",
          card_type: "visa",
  ...
  test "returns the charge processor and PayPal order ID" do
        purchase = create(:free_purchase)
  ...
  test "serializes the latest dispute when one exists" do
        purchase = create(:free_purchase)
  ...
  test "returns null dispute when the purchase has none" do
        purchase = create(:free_purchase)
  ...
  test "serializes the early fraud warning when present" do
        purchase = create(:free_purchase)
  ...
  test "returns null early fraud warning when the purchase has none" do
        purchase = create(:free_purchase)
  ...
  test "serializes the affiliate credit when the purchase used an affiliate" do
        affiliate_user = create(:user)
        affiliate = create(:direct_affiliate, affiliate_user:)
  ...
  test "returns null affiliate credit when none is attached" do
        purchase = create(:free_purchase)
  ...
  test "counts purchases sharing the same fingerprint, browser, and IP excluding the current one" do
  ...
  test "returns nil cluster counts when the source column is blank" do
        purchase = create(:free_purchase)
  ...
  test "omits clusters from the search response to avoid N+1 cluster queries" do
  ...
  context_ "when the purchase is not found or the email does not match" do
  test "returns 404 for a missing purchase" do
  ...
  test "returns 404 for a non-numeric purchase ID" do
  ...
  test "returns 404 when the email does not match the purchase email" do
  ...
  context_ "when the purchase exists" do
        before do
          allow(Purchase).to receive(:find_by_external_id_numeric).with(purchase.external_id_numeric).and_return(purchase)
          allow(purchase).to receive(:within_refund_policy_timeframe?).and_return(true)
          allow(purchase).to receive(:purchase_refund_policy).and_return(refund_policy)
  ...
  test "fully refunds the purchase when amount_cents is omitted" do
          expect(purchase).to receive(:refund!).with(refunding_user_id: admin_user.id, amount: nil).and_return(true)
  ...
  test "performs a partial refund when amount_cents is provided" do
  ...
  test "passes amount_cents equal to the full price through to refund! (model short-circuits to a full refund)" do
  ...
  test "returns 422 with the model error when amount_cents exceeds the refundable amount" do
  ...
  test "returns 422 when amount_cents is not a positive integer" do
  ...
  test "returns 422 when amount_cents is a decimal-like string" do
  ...
  test "returns 422 when amount_cents has trailing non-digit characters" do
  ...
  test "returns 422 when amount_cents is negative" do
  ...
  test "returns 422 when the purchase has no charge to refund" do
  ...
  test "returns 422 when the purchase has no remaining refundable amount" do
  ...
  test "returns 422 when the purchase is already fully refunded" do
  ...
  test "returns 422 without force" do
            post :refund, params: params
  ...
  test "succeeds with force=true" do
            expect(purchase).to receive(:refund!).with(refunding_user_id: admin_user.id, amount: nil).and_return(true)
  ...
  context_ "when the refund policy has fine print" do
          before do
  ...
  test "still surfaces an active chargeback error even when force=true" do
  ...
  context_ "with cancel_subscription=true" do
          let(:subscription) { instance_double(Subscription, deactivated?: false, cancelled_at: nil, price: nil) }

  test "cancels the subscription with admin/seller semantics after a successful refund" do
  ...
  test "succeeds with subscription_cancelled: false when there is no subscription" do
  ...
  test "does not re-cancel a subscription that is already deactivated" do
  ...
  test "does not re-cancel a subscription that is already pending cancellation" do
  ...
  test "still returns success with subscription_cancel_error when cancel! raises after a successful refund" do
            allow(purchase).to receive(:subscription).and_return(subscription)
            expect(purchase).to receive(:refund!).with(refunding_user_id: admin_user.id, amount: nil).and_return(true)
  ...
  context_ "with whitespace in the email parameter" do
  test "strips whitespace before comparing against the purchase email" do
            expect(purchase).to receive(:refund!).with(refunding_user_id: admin_user.id, amount: nil).and_return(true)
  ...
  context_ "POST resend_receipt" do
      let(:purchase) { create(:free_purchase, email: "buyer@example.com") }

      include_examples "admin api authorization required", :post, :resend_receipt, { id: "123" }

  test "resends the receipt for the given purchase" do
  ...
  test "records an audit log with the purchase target" do
  ...
  test "returns 404 when the purchase does not exist" do
  ...
  test "returns 404 when the id is not numeric" do
  ...
  context_ "POST resend_all_receipts" do
  ...
  test "returns 404 when no successful purchases exist for the email" do
  ...
  test "enqueues a grouped receipt for all successful purchases" do
        buyer_email = "buyer@example.com"
  ...
  test "returns 404 when the purchase is missing" do
  ...
  test "refunds taxes and returns the serialized purchase" do
  ...
  test "returns 422 with the purchase error when refund_gumroad_taxes! fails" do
  ...
  test "returns 422 with a generic message when there are no refundable taxes and no model errors" do
  ...
  test "returns 400 when from is missing" do
  ...
  test "returns 400 when to is missing" do
  ...
  test "returns 404 when no purchases match the from email" do
  ...
  test "reassigns purchases via Purchase::ReassignByEmailService and returns the result" do
  ...
  test "redacts the reassignment email addresses from the audit snapshot" do
        post :reassign, params: { from: from_email, to: to_email }
  ...
  test "returns 422 when every purchase save fails" do
  ...
  test "returns 422 when from and to emails are the same" do
  ...
  context_ "POST cancel_subscription" do
      let(:admin_user) { create(:admin_user) }
      let(:purchase) { create(:free_purchase, email: "buyer@example.com") }
      let(:params) { { id: purchase.external_id_numeric.to_s, email: purchase.email } }
  ...
  test "returns 422 when the purchase has no subscription" do
  ...
  context_ "when the purchase has a subscription" do
  ...
  test "cancels the subscription as buyer-initiated by default" do
  ...
  test "cancels with seller-initiated semantics when by_seller is true" do
          expect(subscription).to receive(:cancel!).with(by_seller: true, by_admin: true) do
            allow(subscription).to receive(:cancelled_at).and_return(Time.current)
  ...
  test "short-circuits when the subscription is already pending cancellation" do
  ...
  test "returns already_inactive with the termination reason when the subscription is deactivated via failed payment" do
  ...
  test "returns already_inactive when the subscription ended naturally" do
          allow(subscription).to receive(:deactivated?).and_return(true)
  ...
  test "returns 404 when the email does not match" do
        post :block_buyer, params: params.merge(email: "wrong@example.com")

        expect(response).to have_http_status(:not_found)
      end

  test "blocks the buyer and flips buyer_blocked? to true" do
  ...
  test "creates an audit comment with the provided comment_content" do
  ...
  test "creates a default audit comment when comment_content is omitted" do
  ...
  test "short-circuits when the buyer is already blocked by admin on this purchase" do
  ...
  test "does not short-circuit when the buyer was auto-blocked without admin attribution" do
  ...
  test "re-establishes the block when the admin flag is stale and PlatformBlock was cleared elsewhere" do
        purchase.block_buyer!(blocking_user_id: admin_user.id)
  ...
  context_ "POST unblock_buyer" do
      let(:admin_user) { create(:admin_user) }
      let(:purchase) { create(:free_purchase, email: "buyer@example.com") }
      let(:params) { { id: purchase.external_id_numeric.to_s, email: purchase.email } }
  ...
  test "unblocks the buyer, flips buyer_blocked? to false, and creates an audit comment" do
        purchase.block_buyer!(blocking_user_id: admin_user.id)
        expect(purchase.reload.buyer_blocked?).to be(true)
  ...
  test "creates an unblock comment on the purchaser when present" do
  ...
  test "short-circuits when the buyer is not blocked" do
  ...
  test "clears the stale admin flag when PlatformBlock was cleared elsewhere" do
        purchase.block_buyer!(blocking_user_id: admin_user.id)
        purchase.unblock_buyer!
        purchase.update!(is_buyer_blocked_by_admin: true)
        expect(purchase.reload.is_buyer_blocked_by_admin?).to be(true)
  ...
  context_ "POST refund_for_fraud" do
      let(:admin_user) { create(:admin_user) }
      let(:purchase) { create(:free_purchase, email: "buyer@example.com") }
      let(:params) { { id: purchase.external_id_numeric.to_s, email: purchase.email } }
  ...
  test "delegates to refund_for_fraud_and_block_buyer! and returns the serialized purchase" do
  ...
  test "returns subscription_cancelled: false when there is no subscription" do
          expect(purchase).to receive(:refund_for_fraud_and_block_buyer!).with(admin_user.id).and_return(true)
          allow(purchase).to receive(:subscription).and_return(nil)
  ...
  test "returns 422 with the model error when refund_for_fraud_and_block_buyer! fails" do
  ...
  test "returns 422 with a generic message when refund_for_fraud_and_block_buyer! fails without errors" do
