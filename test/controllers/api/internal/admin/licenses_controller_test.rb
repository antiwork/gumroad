...
class ApiInternalAdminLicensesControllerTest < ActionController::TestCase
  self.described_class = Api::Internal::Admin::LicensesController
  tests Api::Internal::Admin::LicensesController



  context_ Api::Internal::Admin::LicensesController do
