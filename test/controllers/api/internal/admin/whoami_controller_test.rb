...
class ApiInternalAdminWhoamiControllerTest < ActionController::TestCase
  self.described_class = Api::Internal::Admin::WhoamiController
  tests Api::Internal::Admin::WhoamiController



  context_ Api::Internal::Admin::WhoamiController do
  context_ "GET show" do
  test "returns the authenticated admin actor and token metadata" do
  ...
  test "returns a placeholder actor for the legacy admin token" do
        actor = create(:admin_user, name: "Admin User", email: "admin@example.com")
