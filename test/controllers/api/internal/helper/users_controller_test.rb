...
class ApiInternalHelperUsersControllerTest < ActionController::TestCase
  self.described_class = Api::Internal::Helper::UsersController
  tests Api::Internal::Helper::UsersController



  context_ Api::Internal::Helper::UsersController do
  ...
  context_ "when authorization is invalid" do
  ...
  test "returns empty customer info" do
  ...
  context_ "when user info is retrieved" do
  test "returns success response with customer info" do
  ...
  context_ "when user is found but not suspended" do
  test "returns compliant status" do
  ...
  test "returns suspended status with details" do
  ...
  context_ "POST create_appeal" do
  ...
  context_ "when reason parameter is missing" do
  test "returns a bad request error" do
  ...
  context_ "when user is not found on Gumroad" do
  test "returns an error message" do
  ...
  test "bypasses adult keyword validation for appeal comments" do
  ...
  context_ "when the user is neither suspended nor flagged" do
  test "returns an error_message response" do
  ...
  context_ "when neither email nor external_id is provided" do
  test "returns a bad request error" do
  ...
  context_ "when content parameter is missing" do
  test "returns a bad request error" do
  ...
  context_ "when idempotency_key parameter is missing" do
  test "returns a bad request error" do
  ...
  context_ "when external_id parameter is used" do
  test "creates a comment when external_id matches an alive user" do
  ...
  test "returns 422 when external_id does not match any user" do
  ...
  test "returns 422 when external_id matches a soft-deleted user" do
          user.mark_deleted!
  ...
  context_ "when user is soft-deleted" do
  test "returns an error message" do
          user.mark_deleted!
  ...
  context_ "when all parameters are valid" do
  test "creates a comment and returns it" do
  ...
  test "uses GUMROAD_ADMIN_ID as author" do
          post :create_comment, params: { email: user.email, content: "Test", idempotency_key: SecureRandom.uuid }
  ...
  context_ "when content exceeds maximum length" do
  test "returns a validation error" do
  ...
  context_ "idempotency" do
  test "returns existing comment when same key and content are sent" do
          idempotency_key = SecureRandom.uuid
  ...
  test "returns conflict when same key is used with different content" do
          idempotency_key = SecureRandom.uuid
  ...
  test "returns existing comment when content differs only by extra newlines" do
          idempotency_key = SecureRandom.uuid
  ...
  test "handles concurrent inserts via RecordNotUnique" do
          idempotency_key = SecureRandom.uuid
  ...
  context_ "POST send_reset_password_instructions" do
      include_examples "helper api authorization required", :post, :send_reset_password_instructions

  context_ "when email is valid and user exists" do
  test "sends reset password instructions and returns success message" do
  ...
  context_ "when email is valid but user does not exist" do
  test "returns an error message" do
  ...
  context_ "when email is invalid" do
  test "returns an error message" do
  ...
  context_ "when email is missing" do
  test "returns an error message" do
  ...
  context_ "when email is valid and user exists" do
  test "updates user email and returns success message" do
  ...
  context_ "when current email is invalid" do
  test "returns an error message" do
  ...
  context_ "when new email is invalid" do
  test "returns an error message" do
  ...
  context_ "when new email is already taken" do
  ...
  test "returns an error for missing emails" do
  ...
  context_ "POST update_two_factor_authentication_enabled" do
      include_examples "helper api authorization required", :post, :update_two_factor_authentication_enabled

  context_ "when email is valid and user exists" do
  test "enables two-factor authentication and returns success message" do
  ...
  test "disables two-factor authentication and returns success message" do
  ...
  context_ "when email is invalid or user does not exist" do
  test "returns an error message" do
  ...
  context_ "when required parameters are missing" do
  test "returns an error for missing email" do
  ...
  test "returns an error for missing enabled status" do
