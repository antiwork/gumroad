...
class ApiInternalProductReviewVideosRejectionsControllerTest < ActionController::TestCase
  self.described_class = Api::Internal::ProductReviewVideos::RejectionsController
  tests Api::Internal::ProductReviewVideos::RejectionsController



  context_ Api::Internal::ProductReviewVideos::RejectionsController do
  ...
  test "returns unauthorized when the user does not have permission to reject the video" do
          post :create, params: { product_review_video_id: product_review_video.external_id }, format: :json
