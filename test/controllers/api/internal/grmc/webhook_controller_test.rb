...
class ApiInternalGrmcWebhookControllerTest < ActionController::TestCase
  self.described_class = Api::Internal::Grmc::WebhookController
  tests Api::Internal::Grmc::WebhookController



  context_ Api::Internal::Grmc::WebhookController do
