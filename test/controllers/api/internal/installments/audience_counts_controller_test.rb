...
class ApiInternalInstallmentsAudienceCountsControllerTest < ActionController::TestCase
  self.described_class = Api::Internal::Installments::AudienceCountsController
  tests Api::Internal::Installments::AudienceCountsController



  context_ Api::Internal::Installments::AudienceCountsController do
  ...
  test "returns 404 when installment is not found" do
        get :show, params: { id: "nonexistent" }
        expect(response).to have_http_status(:not_found)
      end

  test "returns audience count" do
