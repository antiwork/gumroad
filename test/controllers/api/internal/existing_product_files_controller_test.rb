...
class ApiInternalExistingProductFilesControllerTest < ActionController::TestCase
  self.described_class = Api::Internal::ExistingProductFilesController
  tests Api::Internal::ExistingProductFilesController



  context_ Api::Internal::ExistingProductFilesController do
  ...
  test "returns 404 if the product does not belong to the signed in seller" do
        expect do
  ...
  test "returns existing files for the product" do
