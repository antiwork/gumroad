...
class ApiInternalAiProductDetailsGenerationsControllerTest < ActionController::TestCase
  self.described_class = Api::Internal::AiProductDetailsGenerationsController
  tests Api::Internal::AiProductDetailsGenerationsController



  context_ Api::Internal::AiProductDetailsGenerationsController do
  ...
  context_ "when user is authenticated and authorized" do
        before do
  ...
  test "sanitizes malicious prompts" do
          service_double = instance_double(Ai::ProductDetailsGeneratorService)
          allow(Ai::ProductDetailsGeneratorService).to receive(:new).and_return(service_double)
          allow(service_double).to receive(:generate_product_details).and_return({
                                                                                   name: "Test Product",
  ...
  test "returns error when prompt is blank" do
  ...
  test "returns error when prompt contains only characters removed by sanitization" do
  ...
  test "throttles requests when rate limit is exceeded" do
