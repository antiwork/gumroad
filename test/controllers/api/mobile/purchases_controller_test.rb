...
class ApiMobilePurchasesControllerTest < ActionController::TestCase
  self.described_class = Api::Mobile::PurchasesController
  tests Api::Mobile::PurchasesController



  context_ Api::Mobile::PurchasesController do
    before do
      @user = create(:user)
  ...
  context_ "successful response format" do
  test "returns product and file data" do
  ...
  test "returns the product files in the correct order based on how they appear in the rich content" do
  ...
  test "includes thumbnail url if available" do
        product = create(:product, user: @user, name: "The Works of Edgar Gumstein", description: "A collection of works spanning 1984 — 1994")
  ...
  test "falls back to asset preview for thumbnail url when no thumbnail exists" do
        product = create(:product, user: @user)
  ...
  test "displays subscription products" do
        # Alive Subscription
  ...
  test "does not return unsuccessful purchases" do
  ...
  test "does not return purchases that are expired rentals" do
  ...
  test "does not include purchases that are deleted by the buyer" do
  ...
  test "returns purchases that are archived" do
        @mobile_friendly_movie_product.update!(rental_price_cents: 0)
  ...
  test "does not accept tokens without the mobile_api scope" do
  ...
  test "applies default pagination when no pagination params are provided" do
  ...
  context_ "show all products" do
  test "displays products without files in the api" do
          created_at_minute_advance = 0
  ...
  test "includes mobile unfriendly products" do
          created_at_minute_advance = 0
  ...
  test "includes preorder products", :vcr do
          created_at_minute_advance = 0
  ...
  test "paginates results when pagination params are given" do
          created_at_minute_advance = 0
          purchases = [@mobile_friendly_pdf_product, @mobile_friendly_movie_product, @mobile_zip_file_product].map do |product|
            create(:purchase_with_balance, link: product, purchaser: @purchaser, seller: @user,
  ...
  context_ "POST archive" do
  test "archives a product" do
  ...
  test "archives a refunded subscription" do
  ...
  test "does not archive an unsuccessful purchase" do
  ...
  test "archives a live subscription purchase" do
          post :archive, params: @params.merge(id: purchase.external_id)
  ...
  test "archives a lapsed subscription purchase" do
  ...
  context_ "when the purchase doesn't belong to the purchaser" do
  test "returns a 404 response" do
  ...
  context_ "POST unarchive" do
  test "unarchives an archived product" do
        purchase = create(:purchase_with_balance, purchaser: @purchaser)
  ...
  test "unarchives a refunded subscription" do
  ...
  test "does not unarchive an unsuccessful purchase" do
  ...
  test "marks a purchase as deleted by buyer" do
        purchase = create(:purchase_with_balance, purchaser: @purchaser)
  ...
  test "returns 404 for a purchase that doesn't belong to the purchaser" do
        purchase = create(:purchase_with_balance, purchaser: create(:user))
  ...
  context_ "purchase_attributes" do
  test "returns details for a successful product" do
  ...
  test "does not return details for an unsuccessful product" do
        purchase = create(:purchase, purchaser: @purchaser, purchase_state: "failed")
  ...
  test "returns details for a live subscription purchase" do
          get :purchase_attributes, params: @params.merge(id: purchase.external_id)

          expect(response.parsed_body).to eq({ success: true, product: purchase.reload.json_data_for_mobile }.as_json)
        end

  test "returns details for a lapsed subscription purchase" do
          purchase.subscription.update!(cancelled_at: 1.day.ago)
  ...
  test "returns purchases for a given user" do
  ...
  test "returns aggregation based on sellers" do
  ...
  context_ "filter by seller" do
  test "returns purchases for a given user and seller" do
          seller_1 = create(:named_user)
          seller_2 = create(:named_user)
  ...
  context_ "filter by archived" do
  test "returns archived purchases for a given user" do
          seller_1 = create(:named_user)
          seller_2 = create(:named_user)
  ...
  context_ "filter by purchase_ids" do
  test "returns purchases for the specified purchase IDs" do
  ...
  test "returns no purchases when all purchase IDs are invalid" do
          create(:purchase, purchaser: @purchaser, link: create(:product, user: create(:named_user)))
  ...
  test "returns purchases for a single purchase ID" do
          purchase_1 = create(:purchase, purchaser: @purchaser, link: create(:product, user: create(:named_user)))
          create(:purchase, purchaser: @purchaser, link: create(:product, user: create(:named_user)))
  ...
  test "returns correct pagination count when purchases have multiple url redirects" do
  ...
  test "excludes purchases deleted by buyer" do
        purchase = create(:purchase, purchaser: @purchaser)
  ...
  test "excludes expired rental purchases" do
        purchase = create(:purchase, purchaser: @purchaser)
  ...
  context_ "query by product details" do
  test "returns purchases matching product name or seller name" do
  ...
  context_ "ordering" do
  test "returns purchases sorted by the requested order" do
  ...
  test "defaults to date-desc ordering" do
          purchase_1 = create(:purchase, purchaser: @purchaser)
          purchase_2 = create(:purchase, purchaser: @purchaser)
