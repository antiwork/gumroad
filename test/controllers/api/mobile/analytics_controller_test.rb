...
class ApiMobileAnalyticsControllerTest < ActionController::TestCase
  self.described_class = Api::Mobile::AnalyticsController
  tests Api::Mobile::AnalyticsController



  context_ Api::Mobile::AnalyticsController do
    before do
  ...
  test "returns 504 when Elasticsearch times out" do
  ...
  test "returns data generated by the service" do
        get :data_by_date, params: @params.merge(range: "month")
  ...
  test "passes the query parameter to the service when provided" do
  ...
  test "passes nil query parameter to the service when not provided" do
        expect(SellerMobileAnalyticsService).to receive(:new).with(
          @user,
          range: "month",
          fields: [:sales_count, :purchases],
  ...
  test "handles empty query parameter" do
        expect(SellerMobileAnalyticsService).to receive(:new).with(
          @user,
          range: "week",
          fields: [:sales_count, :purchases],
  ...
  test "returns empty data when no matching purchases are found" do
        expect(SellerMobileAnalyticsService).to receive(:new).with(
          @user,
          range: "week",
          fields: [:sales_count, :purchases],
  ...
  context_ "GET revenue_totals" do
      before do
  ...
  test "parses :date_range and assigns @start_date and @end_date" do
  ...
  test "parses :start_date and end_date and assigns @start_date and @end_date" do
  ...
  test "automatically assigns @start_date and @end_date if they're not set" do
  ...
  context_ "GET by_referral" do
      before { create(:product, user: @user) }

  test "returns 504 when Rack::Timeout::RequestTimeoutException is raised" do
  ...
  test "parses short date ranges without clamping" do
        @user.update!(timezone: "Eastern Time (US & Canada)")
        travel_to Time.utc(2021, 6, 16) do
  ...
  test "clamps date_range=all to 365 days" do
        @user.update!(timezone: "Eastern Time (US & Canada)")
        travel_to Time.utc(2021, 6, 16) do
  ...
  test "clamps custom date ranges exceeding 365 days" do
  ...
  test "parses :start_date and :end_date within 365 days without clamping" do
  ...
  test "returns list of product ids, ordered by the most recent" do
