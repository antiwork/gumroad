...
class ApiMobileSubscriptionsControllerTest < ActionController::TestCase
  self.described_class = Api::Mobile::SubscriptionsController
  self.rspec_metadata = { vcr: true }
  tests Api::Mobile::SubscriptionsController



  context_ Api::Mobile::SubscriptionsController, :vcr do
    before do
  ...
  test "returns an error response for a dead subscription" do
  ...
  test "returns the correct information if the subscription is still alive" do
      get :subscription_attributes, params: { id: @subscription.external_id, mobile_token: Api::Mobile::BaseController::MOBILE_TOKEN }
      assert_response 200
