...
class ApiMobileConsumptionAnalyticsControllerTest < ActionController::TestCase
  self.described_class = Api::Mobile::ConsumptionAnalyticsController
  tests Api::Mobile::ConsumptionAnalyticsController



  context_ Api::Mobile::ConsumptionAnalyticsController do
