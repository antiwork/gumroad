...
class UserInvalidateActiveSessionsControllerTest < ActionController::TestCase
  self.described_class = User::InvalidateActiveSessionsController
  tests User::InvalidateActiveSessionsController



  context_ User::InvalidateActiveSessionsController do
  ...
  test "updates user's 'last_active_sessions_invalidated_at' field and signs out the user" do
