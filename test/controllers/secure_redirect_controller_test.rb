...
class SecureRedirectControllerTest < ActionController::TestCase
  self.described_class = SecureRedirectController
  tests SecureRedirectController



  context_ SecureRedirectController, type: :controller, inertia: true do
  ...
  test "renders the Inertia page" do
          get :new, params: {
  ...
  test "uses default values when optional params are missing" do
          get :new, params: {
            encrypted_payload: encrypted_payload
          }
  ...
  test "includes flash alert in props when present" do
          get :new, params: {
            encrypted_payload: encrypted_payload
  ...
  test "does not include flash in props when not present" do
          get :new, params: {
            encrypted_payload: encrypted_payload
          }
  ...
  context_ "with missing required params" do
  test "redirects to root when encrypted_payload is missing" do
          get :new
  ...
  context_ "with valid confirmation text" do
  test "redirects to the decrypted destination" do
          post :create, params: valid_params

          expect(response).to redirect_to(destination_url)
        end

  context_ "with send_confirmation_text parameter" do
  ...
  test "appends confirmation_text to destination URL when send_confirmation_text is true" do
  ...
  test "does not append confirmation_text when send_confirmation_text is false or missing" do
            post :create, params: valid_params

            expect(response).to redirect_to(destination_url)
          end

  test "handles URLs that already have query parameters" do
  ...
  context_ "with multiple confirmation texts" do
  ...
  test "accepts confirmation text that matches any of the allowed texts" do
  ...
  test "rejects confirmation text that doesn't match any allowed text" do
          post :create, params: valid_params.merge(
            encrypted_payload: encrypted_payload_multiple,
  ...
  test "works with single confirmation text (backward compatibility)" do
          post :create, params: valid_params
  ...
  test "appends confirmation_text to destination URL when multiple texts are provided" do
            post :create, params: valid_params.merge(
  ...
  context_ "with blank confirmation text" do
  test "redirects back with errors" do
  ...
  test "redirects back when confirmation text is nil" do
  ...
  test "redirects back when confirmation text is whitespace only" do
          post :create, params: valid_params.merge(confirmation_text: "   ")
  ...
  context_ "with incorrect confirmation text" do
  test "redirects back with custom error message" do
  ...
  context_ "with tampered encrypted data" do
  test "redirects back with error when encrypted_payload is tampered" do
  ...
  test "redirects back with error when encrypted_payload is invalid JSON" do
  ...
  context_ "with expired payload" do
  ...
  test "redirects back with error when payload is expired" do
  ...
  context_ "when destination is empty" do
  ...
  test "redirects back with invalid destination error" do
