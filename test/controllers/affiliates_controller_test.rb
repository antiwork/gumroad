...
class AffiliatesControllerTest < ActionController::TestCase
  self.described_class = AffiliatesController
  tests AffiliatesController



  context_ AffiliatesController, type: :controller, inertia: true do
  ...
  test "renders the affiliates page" do
  ...
  context_ "when creator does not have any affiliates" do
  test "redirects to the onboarding page" do
            get :index
  ...
  context_ "GET onboarding" do
  test "renders the onboarding page" do
          get :onboarding
  ...
  test "renders the new affiliate page" do
          get :new
  ...
  test "renders the edit affiliate page" do
  ...
  test "returns 404 for non-existent affiliate" do
  ...
  test "creates an affiliate and redirects" do
  ...
  test "redirects back with errors on invalid params" do
  ...
  test "surfaces save failures when save returns false" do
  ...
  test "updates the affiliate and redirects" do
  ...
  test "updates per-product commissions when apply_to_all_products is false" do
  ...
  test "deletes the affiliate and redirects" do
  ...
  test "deletes the affiliate even when the affiliate user has a Brazilian Stripe account" do
  ...
  context_ "when export is synchronous" do
  test "sends data as CSV file" do
            get :export
  ...
  context_ "when export is asynchronous" do
          before do
            stub_const("Exports::AffiliateExportService::SYNCHRONOUS_EXPORT_THRESHOLD", 0)
          end

  test "queues sidekiq job and redirects back" do
            get :export
  ...
  context_ "GET subscribe_posts" do
        before do
  ...
  test "successfully marks current user's all affiliate records for this creator as subscribed" do
  ...
  context_ "GET unsubscribe_posts" do
        before do
  ...
  test "successfully marks current user's all affiliate records for this creator as unsubscribed" do
          sign_in(affiliate_user)
