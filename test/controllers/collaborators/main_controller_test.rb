...
class CollaboratorsMainControllerTest < ActionController::TestCase
  self.described_class = Collaborators::MainController
  tests Collaborators::MainController



  context_ Collaborators::MainController, type: :controller, inertia: true do
  ...
  test "renders the index template with correct props" do
  ...
  test "renders the edit template with correct props" do
  ...
  context_ "when records are faulty" do
  ...
  test "renders the new template with correct props" do
        get :new
  ...
  test "creates a collaborator and redirects" do
        expect do
  ...
  test "redirects to new collaborator page with errors when creation fails" do
  ...
  test "deletes the collaborator, sends the appropriate email, and redirects to the collaborators page" do
        expect do
  ...
  test "updates a collaborator and redirects to collaborators page" do
        expect do
  ...
  test "redirects to edit collaborator page with errors when update fails" do
  ...
  test "redirects to edit collaborator page with errors when percent_commission is invalid" do
