...
class BalanceControllerTest < ActionController::TestCase
  self.described_class = BalanceController
  tests BalanceController



  context_ BalanceController, type: :controller, inertia: true do
  ...
  test "assigns the correct instance variables and renders template" do
  ...
  context_ "with scheduled payout" do
  test "returns nil when seller is not suspended" do
  ...
  test "returns pending payout props" do
  ...
  test "returns executed payout props" do
  ...
  test "returns the most recent scheduled payout" do
  ...
  test "returns nil when no active scheduled payout exists" do
  ...
  test "returns correct payouts for subsequent pages" do
