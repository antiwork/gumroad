...
class OnetimeResolveStuckDisputeEvidenceTest < ActiveSupport::TestCase
  self.described_class = Onetime::ResolveStuckDisputeEvidence



  context_ Onetime::ResolveStuckDisputeEvidence do
  context_ ".process" do
      let!(:stuck_lost) do
  ...
  test "resolves only unresolved evidence whose dispute reached a terminal state" do
