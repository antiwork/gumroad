...
class PushNotificationServiceIosTest < ActiveSupport::TestCase
  self.described_class = PushNotificationService::Ios



  context_ PushNotificationService::Ios do
  context_ "creator app" do
  test "creates an APNS notification" do
        app = double("apns_app")
  ...
  context_ "empty body"  do
  test "sets proper alert message" do
          app = double("apns_app")
          allow(PushNotificationService::Ios).to receive(:consumer_app).and_return(app)
