...
class SavePublicFilesServiceTest < ActiveSupport::TestCase
  self.described_class = SavePublicFilesService



  context_ SavePublicFilesService do
  ...
  context_ "#process" do
  test "updates existing files and returns cleaned content" do
        files_params = [
  ...
  test "handles empty files_params" do
