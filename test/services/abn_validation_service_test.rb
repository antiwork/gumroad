...
class AbnValidationServiceTest < ActiveSupport::TestCase
  self.described_class = AbnValidationService



  context_ AbnValidationService do
    before do
      @vatstack_response = {
        "active" => true,
  ...
  test "returns false when valid abn is provided, but government services are down" do
      abn_id = "51824753556"
