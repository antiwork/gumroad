...
class AdminRelatedUsersServiceTest < ActiveSupport::TestCase
  self.described_class = Admin::RelatedUsersService



  context_ Admin::RelatedUsersService, :benchmark do
  ...
  test "runs the related-users lookup under 500ms with realistic fan-out; run with bundle exec rspec --tag benchmark spec/services/admin/related_users_service_benchmark_spec.rb" do
      target = create(:user,
