...
class PdfStampingServiceStampForPurchaseTest < ActiveSupport::TestCase
  self.described_class = PdfStampingService::StampForPurchase



  context_ PdfStampingService::StampForPurchase do
  context_ ".perform!" do
  ...
  context_ "with stampable PDFs" do
  ...
  test "creates stamp_pdf and updates url_redirect" do
  ...
  context_ "with encrypted stampable PDFs" do
  ...
  test "stamps all files and raises" do
            url_redirect = purchase.url_redirect
  ...
  context_ "when the product doesn't have stampable PDFs" do
