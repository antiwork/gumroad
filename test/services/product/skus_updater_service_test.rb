...
class ProductSkusUpdaterServiceTest < ActiveSupport::TestCase
  self.described_class = Product::SkusUpdaterService



  context_ Product::SkusUpdaterService do
  context_ ".perform" do
      before do
  ...
  test "creates the proper skus" do
        subject.perform
  ...
  context_ "invalid SKU id in params" do
