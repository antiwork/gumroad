...
class ProductVariantsUpdaterServiceTest < ActiveSupport::TestCase
  self.described_class = Product::VariantsUpdaterService



  context_ Product::VariantsUpdaterService do
  context_ ".perform" do
  context_ "for products with variants" do
        before :each do
  ...
  test "updates the variants and variant categories" do
  ...
  context_ "missing category name" do
  test "sets the category title to nil" do
  ...
  context_ "with empty categories" do
  test "deletes all categories" do
            Product::VariantsUpdaterService.new(
              product: @product,
              variants_params: {}
            ).perform
  ...
  test "updates new SKUs and deletes old ones" do
          Product::VariantsUpdaterService.new(
            product: @product,
            variants_params: @variants_params,
  ...
  context_ "deleting categories" do
        before :each do
          @product = create(:product)
          @size_category = create(:variant_category, link: @product, title: "Size")
  ...
  test "marks a category deleted if not included in variant_category_params" do
          Product::VariantsUpdaterService.new(
            product: @product,
            variants_params: @variant_categories
          ).perform
  ...
  test "does not mark a category deleted if it has purchases and files" do
