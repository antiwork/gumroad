...
class CreatorAnalyticsCachingProxyFormattersByDateTest < ActiveSupport::TestCase
  self.described_class = CreatorAnalytics::CachingProxy::Formatters::ByDate



  context_ CreatorAnalytics::CachingProxy::Formatters::ByDate do
    before do
      @service = CreatorAnalytics::CachingProxy.new(build(:user))
    end

  context_ "#merge_data_by_date" do
  test "returns data merged by date" do
        day_one = {
  ...
  context_ "#group_date_data_by_day" do
  ...
  context_ "#group_date_data_by_month" do
