...
class CreatorAnalyticsCachingProxyFormattersByReferralTest < ActiveSupport::TestCase
  self.described_class = CreatorAnalytics::CachingProxy::Formatters::ByReferral



  context_ CreatorAnalytics::CachingProxy::Formatters::ByReferral do
    before do
      @user = create(:user)
  ...
  context_ "#merge_data_by_referral" do
  test "returns data merged by referral" do
  ...
  context_ "#group_referral_data_by_day" do
  test "reformats the data by day" do
        data = {
          dates_and_months: [
            { date: "Friday, January 1st", month: "January 2021", month_index: 0 },
            { date: "Saturday, January 2nd", month: "January 2021", month_index: 0 }
  ...
  context_ "#group_referral_data_by_month" do
  test "reformats the data by month" do
        data = {
          dates_and_months: [
