...
class CreatorAnalyticsChurnProductScopeTest < ActiveSupport::TestCase
  self.described_class = CreatorAnalytics::Churn::ProductScope



  context_ CreatorAnalytics::Churn::ProductScope do
  ...
  context_ "#subscription_products" do
  ...
  test "returns only recurring billing and tiered membership products" do
  ...
  test "returns a hash mapping product id to product info" do
  ...
  context_ "#earliest_analytics_date" do
  context_ "when seller has a first sale" do
  ...
  test "returns the first sale date in seller's timezone" do
  ...
  test "returns seller created_at date in seller's timezone" do
  ...
  test "returns the date in Pacific Time" do
          expect(service.earliest_analytics_date).to eq(date_in_seller_timezone(first_sale_time))
        end
      end
  ...
  context_ "when seller has multiple sales" do
  ...
  test "returns the earliest sale date" do
