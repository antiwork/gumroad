...
class SslCertificatesRenewTest < ActiveSupport::TestCase
  self.described_class = SslCertificates::Renew



  context_ SslCertificates::Renew do
    before do
  ...
  test "enques job for generating SSL certificate" do
