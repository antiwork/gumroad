...
class SaveContentUpsellsServiceTest < ActiveSupport::TestCase
  self.described_class = SaveContentUpsellsService


  context_ SaveContentUpsellsService do
  ...
  context_ "when removing an upsell" do
  ...
  test "marks upsell and offer code as deleted" do
          service.from_html
  ...
  test "adds id to the upsell node" do
