...
class OrderResponseHelpersTest < ActiveSupport::TestCase
  self.described_class = Order::ResponseHelpers


  context_ Order::ResponseHelpers do
  ...
  test "returns formatted price using USD total transaction cents" do
  ...
  test "sets is_tax_mismatch to true when error_code is TAX_VALIDATION_FAILED" do
  ...
  test "handles CN card country code correctly" do
