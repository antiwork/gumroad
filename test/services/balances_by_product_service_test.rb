...
class BalancesByProductServiceTest < ActiveSupport::TestCase
  self.described_class = BalancesByProductService



  context_ BalancesByProductService do
