...
class CommunityChatRecapGeneratorServiceTest < ActiveSupport::TestCase
  self.described_class = CommunityChatRecapGeneratorService



  context_ CommunityChatRecapGeneratorService do
    let(:seller) { create(:user) }
    let(:community) { create(:community, seller:) }

  context_ "#process" do
  context_ "when recap is already finished" do
  ...
  context_ "when generating daily recap" do
  ...
  test "generates a summary from chat messages" do
  ...
  test "handles no messages in the given period" do
  ...
  context_ "when generating weekly recap" do
  ...
  test "generates a weekly summary from daily recaps" do
  ...
  test "handles no daily recaps in the given period" do
  ...
  context_ "when OpenAI API fails" do
        let(:community) { create(:community, seller:) }
