...
class ServicesSubscriptionUpdaterServiceTieredMembershipVariantAndPriceUpdateTest < ActiveSupport::TestCase
  self.rspec_metadata = { vcr: true }



  context_ "Subscription::UpdaterService – Tiered Membership Variant And Price Update Scenarios", :vcr do
  ...
  context_ "when variant has not changed" do
  context_ "nor has recurrence period" do
  test "does not change the variant or price" do
  ...
  context_ "but recurrence period has changed" do
  context_ "to a price that is the same as or less than the current price" do
  test "does not change the price on the original subscription" do
                result = Subscription::UpdaterService.new(
                  subscription: @subscription,
                  gumroad_guid: @gumroad_guid,
  ...
  test "records that the user should be downgraded" do
                expect do
                  Subscription::UpdaterService.new(
                    subscription: @subscription,
                    gumroad_guid: @gumroad_guid,
  ...
  context_ "to a price that is greater than the current price" do
  test "creates a new 'original' subscription purchase and archives the old one" do
                result = Subscription::UpdaterService.new(
                  subscription: @subscription,
                  gumroad_guid: @gumroad_guid,
  ...
  test "charges the user on a pro-rated basis and upgrades them immediately" do
                expect do
                  Subscription::UpdaterService.new(
                    subscription: @subscription,
                    gumroad_guid: @gumroad_guid,
  ...
  context_ "when variant has changed" do
  context_ "but has the same recurrence period" do
  context_ "and is more expensive" do
  test "creates a new 'original' subscription purchase with the new variant and archives the old one" do
                Subscription::UpdaterService.new(
                  subscription: @subscription,
                  gumroad_guid: @gumroad_guid,
  ...
  test "keeps a deleted original offer code without discounting the new plan",
  ...
  context_ "and recurrence period has changed" do
  context_ "to a more expensive one" do
              let(:params) do
                {
                  price_id: @yearly_product_price.external_id,
                  variants: [@new_tier.external_id],
  ...
  test "creates a new 'original' subscription purchase with the new variant and price and archives the old one" do
                result = Subscription::UpdaterService.new(
                  subscription: @subscription,
                  gumroad_guid: @gumroad_guid,
                  params:,
  ...
  context_ "to a less expensive one" do
              let(:params) do
                {
                  price_id: @monthly_product_price.external_id,
                  variants: [@new_tier.external_id],
  ...
  context_ "when purchase is taxable" do
  test "records the taxes due" do
  ...
  context_ "when original price has changed in the interim" do
          before :each do
  ...
  test "charges the correct price difference" do
              Subscription::UpdaterService.new(
                subscription: @subscription,
                gumroad_guid: @gumroad_guid,
                params:,
  ...
  context_ "downgrading" do
  test "does not change the price or charge the user" do
              params = {
                price_id: @monthly_product_price.external_id,
                variants: [@original_tier.external_id],
                use_existing_card: true,
  ...
  context_ "when original purchase is not associated with a tier" do
          before :each do
            @original_purchase.variant_attributes = []
            @original_purchase.save!
          end

  test "does not treat it as a plan change if the default tier and original recurrence are selected" do
            expect do
              result = Subscription::UpdaterService.new(
                subscription: @subscription,
                gumroad_guid: @gumroad_guid,
  ...
  context_ "upgrading" do
  test "treats it as an upgrade if a more expensive tier is selected" do
              Subscription::UpdaterService.new(
                subscription: @subscription,
                gumroad_guid: @gumroad_guid,
                params: upgrade_tier_params,
  ...
  test "treats it as an upgrade if a more expensive recurrence is selected" do
              Subscription::UpdaterService.new(
                subscription: @subscription,
                gumroad_guid: @gumroad_guid,
                params: upgrade_recurrence_params,
  ...
  context_ "default tier is sold out" do
  ...
  context_ "downgrading" do
  test "treats it as a downgrade if a less expensive tier is selected" do
              expect do
                result = Subscription::UpdaterService.new(
                  subscription: @subscription,
                  gumroad_guid: @gumroad_guid,
  ...
  test "treats it as a downgrade if a less expensive recurrence is selected" do
              expect do
                result = Subscription::UpdaterService.new(
                  subscription: @subscription,
                  gumroad_guid: @gumroad_guid,
  ...
  context_ "when the original purchase was not charged VAT" do
  test "does not charge VAT even if has EU IP address" do
              result = Subscription::UpdaterService.new(
                subscription: @subscription,
                gumroad_guid: @gumroad_guid,
                params:,
  ...
  context_ "when the original purchase was charged VAT" do
  test "uses the original purchase's country and VAT" do
              travel_back
  ...
  context_ "updating at different times" do
          let(:params) do
  ...
  test "charges the correct amount a day into the current period" do
  ...
  test "charges the correct amount halfway through the current period" do
  ...
  test "charges the correct amount 3/4 through the current period" do
  ...
  test "charges the correct amount a day before the current period ends" do
  ...
  test "charges the correct amount when the user upgrades within 3 minutes of purchase" do
  ...
  context_ "updating when prorated upgrade charge is less than product minimum price" do
  test "rounds up to the minimum product price ($0.99)" do
  ...
  context_ "for a product in non-USD currency" do
  test "rounds up to the minimum product price in that currency" do
              currency = "eur"
  ...
  context_ "not updating variant, but current variant is no longer available" do
          let(:params) do
            {
              price_id: @yearly_product_price.external_id,
              variants: [@original_tier.external_id],
  ...
  context_ "because it has been deleted" do
  test "still allows the user to select that variant" do
  ...
  context_ "because it is sold out" do
  test "still allows the user to select that variant" do
  ...
  context_ "when current recurrence is no longer available" do
          before :each do
            @quarterly_product_price.mark_deleted!
            @original_tier_quarterly_price.mark_deleted!
          end

  context_ "and user is not updating recurrence" do
  test "still allows the user to select that recurrence" do
              params = {
                price_id: @quarterly_product_price.external_id,
                variants: [@original_tier.external_id],
                quantity: 1,
  ...
  context_ "and user is updating recurrence" do
  test "does not error" do
              params = {
                price_id: @yearly_product_price.external_id,
                variants: [@original_tier.external_id],
  ...
  test "creates purchase events when upgrading" do
            Subscription::UpdaterService.new(
              subscription: @subscription,
              gumroad_guid: @gumroad_guid,
              params: upgrade_tier_params,
  ...
  test "does not create a purchase event when not changing plan" do
            expect do
              Subscription::UpdaterService.new(
                subscription: @subscription,
                gumroad_guid: @gumroad_guid,
  ...
  test "does not create a purchase event when downgrading" do
            expect do
              Subscription::UpdaterService.new(
                subscription: @subscription,
                gumroad_guid: @gumroad_guid,
