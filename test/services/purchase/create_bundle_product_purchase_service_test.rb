...
class PurchaseCreateBundleProductPurchaseServiceTest < ActiveSupport::TestCase
  self.described_class = Purchase::CreateBundleProductPurchaseService

  # frozen_string_literal: false

  context_ Purchase::CreateBundleProductPurchaseService do
  context_ "#perform" do
  ...
  test "creates a bundle product purchase" do
  ...
  test "creates a bundle product purchase with the correct is_gift_sender_purchase flag" do
  ...
  test "creates a bundle product purchase with the correct is_gift_receiver_purchase flag" do
