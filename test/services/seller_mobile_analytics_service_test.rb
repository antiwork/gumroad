...
class SellerMobileAnalyticsServiceTest < ActiveSupport::TestCase
  self.described_class = SellerMobileAnalyticsService



  context_ SellerMobileAnalyticsService do
    before do
  ...
  context_ "#process" do
  test "returns the proper purchase data for all time" do
        valid_purchases = []
  ...
  test "returns the proper purchase data for the year" do
        valid_purchases = []
  ...
  test "returns the proper purchase data for current month" do
        valid_purchases = []
        travel_to(1.year.ago) do
          create(:purchase, link: @product)
        end
  ...
  test "returns the proper purchase data for the current week" do
        valid_purchases = []
        travel_to(1.year.ago) do
          create(:purchase, link: @product)
        end
  ...
  test "returns the proper purchase data for the current day" do
        valid_purchases = []
        travel_to(1.year.ago) do
          create(:purchase, link: @product)
        end
  ...
  context_ "when not requesting optional fields" do
  test "only returns revenue" do
          create(:purchase, link: @product)
  ...
  context_ "when requesting optional fields" do
  context_ "when requesting :purchases" do
  test "returns purchases records as json" do
  ...
  test "limits purchases returned to SALES_LIMIT" do
  ...
  context_ "with query parameter" do
  test "passes seller_query to search options when query is provided" do
  ...
  test "does not pass seller_query when query is nil" do
              create(:purchase, link: @product)
              index_model_records(Purchase)
  ...
  test "does not pass seller_query when query is empty" do
              create(:purchase, link: @product)
              index_model_records(Purchase)
  ...
  test "does not pass seller_query when query is whitespace only" do
              create(:purchase, link: @product)
              index_model_records(Purchase)
  ...
  context_ "when requesting :sales_count" do
  test "returns the total count of sales" do
  ...
  context_ "with query parameter" do
  test "does not pass seller_query to search options when only requesting sales_count" do
              create(:purchase, link: @product)
              index_model_records(Purchase)
  ...
  context_ "with an invalid range" do
