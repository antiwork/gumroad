...
class ExportsAffiliateExportServiceTest < ActiveSupport::TestCase
  self.described_class = Exports::AffiliateExportService



  context_ Exports::AffiliateExportService do
  context_ "#perform" do
      before do
  ...
  test "generates affiliates CSV tempfile with proper data" do
  ...
  test "returns performed service when the affiliates count is below the threshold" do
  ...
  test "enqueues job and returns false when the affiliates count is above the threshold" do
