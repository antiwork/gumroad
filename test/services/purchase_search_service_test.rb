...
class PurchaseSearchServiceTest < ActiveSupport::TestCase
  self.described_class = PurchaseSearchService



  context_ PurchaseSearchService do
  context_ "#process" do
  test "can filter by seller" do
  ...
  test "can filter by product, and exclude product" do
  ...
  test "can filter by variant, and exclude variant" do
  ...
  test "can exclude purchasers of a product or a variant" do
        # Typical usage:
  ...
  test "can filter by affiliate user" do
        purchase_1 = create(:purchase)
  ...
  test "can filter by revenue sharing user" do
  ...
  test "can filter by multiple variants and products" do
  ...
  test "can exclude non-original subscription and archived original subscription purchases" do
  ...
  test "can exclude not_charged purchases that are not free trials" do
  ...
  test "can exclude deactivated subscriptions" do
        purchase_1 = create(:membership_purchase, created_at: 2.days.ago)
  ...
  test "can exclude cancelled subscriptions, or pending cancellation" do
  ...
  test "can exclude refunded-except-subscriptions" do
        purchase_1 = create(:purchase)
  ...
  test "can exclude unreversed charged back" do
        purchase_1 = create(:purchase)
  ...
  test "can exclude purchases from buyers that can't be contacted" do
        purchase_1 = create(:purchase)
  ...
  test "can exclude gifters or giftees" do
        purchase_1 = create(:purchase)
        gift = create(:gift)
        product = gift.link
  ...
  test "can exclude non-successful authorization purchases" do
        # Without preorder
        purchase_1 = create(:purchase)
  ...
  test "can filter by price ranges" do
  ...
  test "can filter by license uses" do
  ...
  test "can filter by date ranges" do
  ...
  test "can filter by archival state" do
        purchase_1 = create(:purchase)
  ...
  test "can filter by recommended state" do
        purchase_1 = create(:purchase)
  ...
  test "can filter by is_bundle_product_purchase" do
  ...
  test "can filter by is_commission_completion_purchase" do
  ...
  test "can filter by is_deleted_by_buyer" do
  ...
  test "can filter by is_additional_contribution" do
  ...
  test "can filter by is_access_revoked" do
  ...
  test "applies all library filters with for_library option" do
  ...
  test "can apply some native ES params" do
  ...
  test "supports fulltext/autocomplete search as seller" do
  ...
  test "supports fulltext/autocomplete search as a buyer" do
  ...
  context_ "#query" do
  test "is a shortcut to the query part of the request body" do
  ...
  context_ ".search" do
  test "is a shortcut to initialization + process" do
