...
class UserCreateAdminCommentServiceTest < ActiveSupport::TestCase
  self.described_class = User::CreateAdminCommentService



  context_ User::CreateAdminCommentService do
