...
class ContentModerationStrategiesBlocklistStrategyTest < ActiveSupport::TestCase
  self.described_class = ContentModeration::Strategies::BlocklistStrategy
  self.rspec_metadata = { vcr: true }



  context_ ContentModeration::Strategies::BlocklistStrategy, :vcr do
    before do
  ...
  test "reads words from the YAML file when present" do
