...
class IntegrationsDiscordIntegrationServiceTest < ActiveSupport::TestCase
  self.described_class = Integrations::DiscordIntegrationService



  context_ Integrations::DiscordIntegrationService do
  ...
  context_ "standalone product" do
  context_ "#deactivate" do
  test "removes member from the server specified in the integration" do
  ...
  test "does nothing if integration is not enabled" do
          purchase_without_integration = create(:purchase)

          expect_any_instance_of(DiscordApi).not_to receive(:remove_member)
          Integrations::DiscordIntegrationService.new.deactivate(purchase_without_integration)
        end

  test "does nothing if purchase does not have an activated integration" do
  ...
  test "does nothing if deactivation is disabled" do
          discord_purchase_integration = create(:discord_purchase_integration, integration:, discord_user_id: user_id)
  ...
  test "sends an email to the creator when the Gumroad bot role is lower than the member's highest role" do
          discord_purchase_integration = create(:discord_purchase_integration, integration:, discord_user_id: user_id)
  ...
  test "sends an email to the creator when the Gumroad bot role is lower than the member's highest of multiple roles" do
          discord_purchase_integration = create(:discord_purchase_integration, integration:, discord_user_id: user_id)
  ...
  test "sends an email to the creator when the Gumoroad bot role is equal to the member's highest role" do
          discord_purchase_integration = create(:discord_purchase_integration, integration:, discord_user_id: user_id)
  ...
  test "propagates the NoPermission error if it is raised when the Gumroad bot role removes a member with the default @everyone role" do
          discord_purchase_integration = create(:discord_purchase_integration, integration:, discord_user_id: user_id)
  ...
  test "propagates the NoPermission error if it is raised when the Gumroad bot role is higher than the member's highest role" do
          discord_purchase_integration = create(:discord_purchase_integration, integration:, discord_user_id: user_id)
  ...
  test "propagates the NoPermission error if it is raised when the Gumroad bot is assigned a role higher than the member's highest role" do
          discord_purchase_integration = create(:discord_purchase_integration, integration:, discord_user_id: user_id)
  ...
  test "marks the purchase integration as deleted when the Discord server is deleted" do
          discord_purchase_integration = create(:discord_purchase_integration, integration:, discord_user_id: user_id)
  ...
  context_ "product with variants" do
  ...
  context_ "#deactivate" do
  test "removes member from the server if variant has integration" do
  ...
  test "does nothing if variant does not have integration enabled" do
  ...
  test "removes member from the server if product has integration and purchase does not have a variant specified" do
  ...
  context_ "#deactivate" do
  test "removes member from the server if tier has integration" do
  ...
  test "does nothing if tier does not have integration enabled" do
  ...
  context_ "#update_on_tier_change" do
  test "does nothing if new tier has integration and old tier did not" do
          purchase_without_integration = create(:membership_purchase, link: membership_product, variant_attributes: [tier_without_integration])
  ...
  test "deactivates integration if old tier had integration and new tier does not" do
          purchase_with_integration = create(:membership_purchase, link: membership_product, variant_attributes: [tier_with_integration])
          purchase_integration = create(:purchase_integration, integration:, purchase: purchase_with_integration, discord_user_id: user_id)
  ...
  test "does nothing if old tier had integration and new tier does not but the integration was not activated" do
          purchase_with_integration = create(:membership_purchase, link: membership_product, variant_attributes: [tier_with_integration])
          subscription_with_integration = purchase_with_integration.subscription
          subscription_with_integration.update_current_plan!(
            new_variants: [tier_without_integration],
  ...
  test "does nothing if old tier had integration and new tier does not but deactivation is disabled" do
          purchase_with_integration = create(:membership_purchase, link: membership_product, variant_attributes: [tier_with_integration])
          purchase_integration = create(:purchase_integration, integration:, purchase: purchase_with_integration, discord_user_id: user_id)
  ...
  test "does nothing if new and old tier have integration" do
          purchase_with_integration = create(:membership_purchase, link: membership_product, variant_attributes: [tier_with_integration])
          purchase_integration = create(:purchase_integration, integration:, purchase: purchase_with_integration, discord_user_id: user_id)
  ...
  test "does nothing if new and old tier do not have integration" do
          purchase_without_integration = create(:membership_purchase, link: membership_product, variant_attributes: [tier_without_integration])
