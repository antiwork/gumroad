...
class ApiV2SalesSummaryTest < ActiveSupport::TestCase
  self.described_class = Api::V2::SalesSummary



  context_ Api::V2::SalesSummary do
  context_ "#as_json" do
  test "returns totals for the requested date range" do
  ...
  test "returns product breakdowns sorted by gross sales" do
        seller = create(:user, timezone: "UTC")
  ...
  test "paginates breakdown buckets" do
  ...
  test "groups date breakdowns in the seller's timezone" do
  ...
  test "groups monthly breakdowns" do
        seller = create(:user, timezone: "UTC")
        product = create(:product, user: seller, price_cents: 10_00)
  ...
  test "groups weekly breakdowns" do
        seller = create(:user, timezone: "UTC")
        product = create(:product, user: seller, price_cents: 10_00)
