...
class ReceiptPresenterTest < ActiveSupport::TestCase
  self.described_class = ReceiptPresenter



  context_ ReceiptPresenter do
  ...
  context_ "#charge_info" do
  test "returns a ChargeInfo object" do
  ...
  context_ "#payment_info" do
  test "returns a PaymentInfo object" do
  ...
  test "includes sales tax breakdown for Canada", :vcr do
  ...
  context_ "#shipping_info" do
  test "returns a ShippingInfo object" do
  ...
  context_ "#recommended_products_info" do
  test "returns a RecommendedProductsInfo object" do
  ...
  context_ "#mail_subject" do
  test "returns mail subject" do
          expect(presenter.mail_subject).to eq("You bought The Works of Edgar Gumstein!")
        end
      end

  context_ "#footer_info" do
  test "returns a FooterInfo object" do
  ...
  context_ "#giftee_manage_subscription" do
  test "returns a GifteeManageSubscription object" do
