...
class UtmLinkPresenterTest < ActiveSupport::TestCase
  self.described_class = UtmLinkPresenter



  context_ UtmLinkPresenter do
  ...
  context_ "#utm_link_props" do
  test "returns the UTM link props" do
  ...
  test "returns correct 'destination_option' depending on the 'target_resource_type'" do
  ...
  test "returns the form context props" do
  ...
  test "returns 'utm_link' in the props when 'copy_from' is provided" do
  ...
  test "returns empty arrays for utm_fields_values when no UTM links exist" do
  ...
  test "returns the form context props and the UTM link props" do
