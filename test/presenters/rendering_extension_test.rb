...
class PresentersRenderingExtensionTest < ActiveSupport::TestCase



  context_ "RenderingExtension" do
  context_ "#custom_context" do
  ...
  test "generates correct context" do
  ...
  context_ "with admin role for seller" do
