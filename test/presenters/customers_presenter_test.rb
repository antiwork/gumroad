...
class CustomersPresenterTest < ActiveSupport::TestCase
  self.described_class = CustomersPresenter


  context_ CustomersPresenter do
  ...
  test "returns license_uses_filter_enabled as true" do
