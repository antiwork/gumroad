...
class WorkflowsPresenterTest < ActiveSupport::TestCase
  self.described_class = WorkflowsPresenter



  context_ WorkflowsPresenter do
  context_ "#workflows_props" do
  ...
  test "returns alive workflows ordered by created at descending" do
