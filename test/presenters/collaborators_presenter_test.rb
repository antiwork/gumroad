...
class CollaboratorsPresenterTest < ActiveSupport::TestCase
  self.described_class = CollaboratorsPresenter



  context_ CollaboratorsPresenter do
  ...
  test "returns the seller's live collaborators" do
  ...
  test "returns if the seller has any incoming collaborations" do
