...
class PaginatedProductPostsPresenterTest < ActiveSupport::TestCase
  self.described_class = PaginatedProductPostsPresenter


  context_ PaginatedProductPostsPresenter do
  ...
  test "returns paginated posts for the first page" do
  ...
  test "returns paginated posts for the specified page" do
          result = presenter.index_props
