...
class ReceiptPresenterGifteeManageSubscriptionTest < ActiveSupport::TestCase
  self.described_class = ReceiptPresenter::GifteeManageSubscription



  context_ ReceiptPresenter::GifteeManageSubscription do
  ...
  context_ "when the chargeable is not a purchase" do
  ...
  context_ "when the subscription is not a gift" do
        before do
  ...
  context_ "when the chargeable is a subscription and gift" do
        before do
  ...
  test "returns the expected note" do
