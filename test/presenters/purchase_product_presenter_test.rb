...
class PurchaseProductPresenterTest < ActiveSupport::TestCase
  self.described_class = PurchaseProductPresenter



  context_ PurchaseProductPresenter, :versioning do
  ...
  context_ "when the product was updated after the purchase" do
          before do
  ...
  test "returns the product props at the time of purchase" do
