...
class DiscoverTaxonomyPresenterTest < ActiveSupport::TestCase
  self.described_class = Discover::TaxonomyPresenter



  context_ Discover::TaxonomyPresenter do
    subject(:presenter) { Discover::TaxonomyPresenter.new }

  context_ "#taxonomies_for_nav" do
  test "converts the taxonomy into a list of categories, with keys as strings" do
  ...
  test "returns 'other' taxonomy last" do
  ...
  context_ "when logged_in_user is present" do
  test "sorts taxonomies based on recommended products" do
