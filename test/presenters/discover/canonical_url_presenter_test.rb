...
class DiscoverCanonicalUrlPresenterTest < ActiveSupport::TestCase
  self.described_class = Discover::CanonicalUrlPresenter



  context_ Discover::CanonicalUrlPresenter do
    let(:discover_domain_with_protocol) { UrlService.discover_domain_with_protocol }
  context_ "#canonical_url" do
