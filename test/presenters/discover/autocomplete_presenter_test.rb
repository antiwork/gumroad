...
class DiscoverAutocompletePresenterTest < ActiveSupport::TestCase
  self.described_class = Discover::AutocompletePresenter



  context_ Discover::AutocompletePresenter do
  ...
  context_ "#props" do
  context_ "when query is blank" do
        let(:query) { "" }
  ...
  test "returns top products and recent searches" do
  ...
  context_ "when not logged in but has viewed products in this browser" do
          before do
  ...
  context_ "when query is present" do
        let(:query) { "test" }
        let!(:searches) do
          [
  ...
  test "returns matching products and filtered recent searches" do
          result = presenter.props
  ...
  context_ "when user is nil" do
        let(:user) { nil }
        let!(:thumbnail) { create(:thumbnail, product:) }

  test "returns matching products" do
  ...
  test "does not return recent searches" do
  ...
  test "finds searches by user when user is present" do
  ...
  context_ "when both user and browser_guid are nil" do
        let(:query) { "" }

  test "returns top products without querying page views" do
  ...
  test "finds searches by browser_guid when user is nil" do
