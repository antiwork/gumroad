...
class ProductPresenterCardTest < ActiveSupport::TestCase
  self.described_class = ProductPresenter::Card



  context_ ProductPresenter::Card do
  ...
  test "returns the necessary properties for a product card" do
  ...
  test "returns the URL with the offer code" do
  ...
  context_ "when compute_inventory is true (default)" do
          let(:product) { create(:product, unique_permalink: "test", name: "hello", user: creator, max_purchase_count: 10) }

  test "computes quantity_remaining and is_sales_limited" do
  ...
  test "includes the lowest tier price for the default subscription duration" do
  ...
  test "applies the discount to the price_cents" do
  ...
  test "does not show original price for zero discount" do
  ...
  test "does not apply the discount when the offer code has expired" do
  ...
  test "does not apply the discount when the offer code is not yet active" do
  ...
  test "does not apply existing-customer-only discounts to anonymous cards" do
  ...
  context_ "#for_email" do
  test "returns the necessary properties for an email product card" do
