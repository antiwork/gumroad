...
class AdminScheduledPayoutPresenterTest < ActiveSupport::TestCase
  self.described_class = Admin::ScheduledPayoutPresenter



  context_ Admin::ScheduledPayoutPresenter do
  context_ "#props" do
  test "returns the existing scheduled payout shape without enrichment" do
  ...
  test "adds enrichment without changing existing keys" do
