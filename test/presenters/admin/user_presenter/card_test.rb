...
class AdminUserPresenterCardTest < ActiveSupport::TestCase
  self.described_class = Admin::UserPresenter::Card



  context_ Admin::UserPresenter::Card do
  context_ "#props" do
  ...
  context_ "blocking information" do
  context_ "when user is not blocked by form_email" do
  test "returns nil for blocked_by_form_email_object" do
            expect(props[:blocked_by_form_email_object]).to be_nil
          end
        end

  context_ "when user is blocked by form_email" do
  ...
  test "returns the blocking information" do
  ...
  context_ "when user is not blocked by form_email_domain" do
  test "returns nil for blocked_by_form_email_domain_object" do
            expect(props[:blocked_by_form_email_domain_object]).to be_nil
          end
        end

  context_ "when user is blocked by form_email_domain" do
  ...
  test "includes membership attributes" do
  ...
  test "includes seller information" do
            membership_data = props[:admin_manageable_user_memberships].first
  ...
  context_ "compliance info" do
  context_ "when user has no compliance info" do
          before do
  ...
  context_ "when user has compliance info" do
  ...
  test "returns a hash with compliance information" do
