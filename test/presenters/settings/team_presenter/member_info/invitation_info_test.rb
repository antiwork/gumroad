...
class SettingsTeamPresenterMemberInfoInvitationInfoTest < ActiveSupport::TestCase
  self.described_class = Settings::TeamPresenter::MemberInfo::InvitationInfo



  context_ Settings::TeamPresenter::MemberInfo::InvitationInfo do
  ...
  context_ ".build_invitation_info" do
  ...
  context_ "when invitation has wip role" do
          before do
  ...
  test "includes only the current role" do
          info = Settings::TeamPresenter::MemberInfo.build_invitation_info(pundit_user:, team_invitation:)
