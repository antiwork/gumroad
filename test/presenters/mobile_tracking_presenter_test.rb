...
class MobileTrackingPresenterTest < ActiveSupport::TestCase
  self.described_class = MobileTrackingPresenter



  context_ MobileTrackingPresenter do
  ...
  context_ "when the seller has third party analytics on the product page" do
        before do
  ...
  context_ "when the seller has third party analytics on the receipt page" do
        before do
