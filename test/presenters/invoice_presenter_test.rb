...
class InvoicePresenterTest < ActiveSupport::TestCase
  self.described_class = InvoicePresenter


  context_ InvoicePresenter do
  ...
  context_ "#supplier_info" do
  test "returns a SupplierInfo object" do
  ...
  context_ "#seller_info" do
  test "returns a SellerInfo object" do
  ...
  test "returns an OrderInfo object" do
  ...
  context_ "#invoice_generation_form_data_props" do
  test "returns the form data" do
  ...
  context_ "#invoice_generation_form_metadata_props" do
  test "returns the form metadata" do
