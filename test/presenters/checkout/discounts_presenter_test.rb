...
class CheckoutDiscountsPresenterTest < ActiveSupport::TestCase
  self.described_class = Checkout::DiscountsPresenter


  context_ Checkout::DiscountsPresenter do
  ...
  test "exposes ownership products and tiers for existing-customers codes" do
