...
class CheckoutUpsellsPresenterTest < ActiveSupport::TestCase
  self.described_class = Checkout::UpsellsPresenter


  context_ Checkout::UpsellsPresenter do
  context_ "#upsells_props" do
