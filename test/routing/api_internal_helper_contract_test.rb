...
class RoutingApiInternalHelperContractTest < ActionDispatch::IntegrationTest



  context_ "legacy internal helper admin routes" do
  ...
  test "routes #{method.to_s.upcase} #{path}" do
