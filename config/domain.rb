...
configuration_by_env = {
  ...
  test: {
    protocol: "http",
    domain: "lvh.me:31337",
    asset_domain: "lvh.me:31337",
    root_domain: "lvh.me:31337",
    short_domain: "short-domain.lvh.me:31337",
    discover_domain: "lvh.me:31337",
    api_domain: "api.lvh.me:31337",
    third_party_analytics_domain: "analytics.lvh.me",
    valid_request_hosts: ["127.0.0.1", "localhost", "lvh.me"],
    valid_api_request_hosts: ["api.lvh.me"],
    valid_discover_host: "lvh.me",
    valid_cors_origins: ["help.lvh.me", "customers.lvh.me"],
    internal_gumroad_domain: "test.gumroad.net",
    default_email_domain: "lvh.me", # unused
    anycable_host: "cable.lvh.me",
  },
  development: {
    protocol: "https",
    domain: "gumroad.dev",
