...
module Gumroad
  class Application < Rails::Application
    ...
    config.middleware.insert_before(ActionDispatch::Cookies, ActionDispatch::SSL, redirect: { exclude: ->(request) { request.host != DOMAIN || Rails.env.test? || Rails.env.development? } })
