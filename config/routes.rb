...
Rails.application.routes.draw do
  ...
  constraints GumroadDomainConstraint do
    ...
    scope "/communities/:seller_id/:community_id" do
      post "/messages", to: "communities#create_message", as: :community_messages
      put "/messages/:message_id", to: "communities#update_message", as: :community_message
      delete "/messages/:message_id", to: "communities#destroy_message"
      post "/mark_read/:message_id", to: "communities#mark_message_read", as: :community_mark_read
    end
