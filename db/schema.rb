...
ActiveRecord::Schema[7.1].define(version: 2025_06_19_215442) do
  ...
  create_table "users", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.decimal "custom_direct_fee_percentage", precision: 10
    t.decimal "custom_discover_fee_percentage", precision: 10
