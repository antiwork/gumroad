...
ActiveRecord::Schema[7.1].define(version: 2025_07_13_155443) do
  ...
  create_table "social_proof_widget_events", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.index ["social_proof_widget_id", "event_type", "created_at"], name: "idx_on_social_proof_widget_id_event_type_created_at_b961584c59"
    t.index ["social_proof_widget_id"], name: "index_social_proof_widget_events_on_social_proof_widget_id"
  end

  create_table "social_proof_widget_purchases", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.bigint "social_proof_widget_id", null: false
    t.bigint "purchase_id", null: false
  ...
  create_table "social_proof_widgets", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.integer "revenue_cents", default: 0, null: false
    t.index ["clicks_count"], name: "index_social_proof_widgets_on_clicks_count"
    t.index ["impressions_count"], name: "index_social_proof_widgets_on_impressions_count"
    t.index ["published"], name: "index_social_proof_widgets_on_published"
    t.index ["revenue_cents"], name: "index_social_proof_widgets_on_revenue_cents"
    t.index ["user_id"], name: "index_social_proof_widgets_on_user_id"
    t.index ["visibility"], name: "index_social_proof_widgets_on_visibility"
  end
