...
ActiveRecord::Schema[7.1].define(version: 2026_12_16_120001) do
  ...
  create_table "affiliate_credits", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.index ["link_id", "affiliate_id", "affiliate_credit_chargeback_balance_id", "affiliate_credit_refund_balance_id", "amount_cents"], name: "idx_affiliate_credits_on_link_affiliate_balances_amount"
  ...
  create_table "marketing_actions", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.datetime "reconnect_notified_at"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "user_instagram_identities", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.string "instagram_user_id", null: false
    t.string "handle"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["instagram_user_id"], name: "index_user_instagram_identities_on_instagram_user_id"
    t.index ["user_id"], name: "index_user_instagram_identities_on_user_id", unique: true
  end
