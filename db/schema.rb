...
ActiveRecord::Schema[7.1].define(version: 2025_12_10_053000) do
  ...
  create_table "subscriptions", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.string "business_vat_id", limit: 191
    t.index ["business_vat_id"], name: "index_subscriptions_on_business_vat_id", where: "business_vat_id IS NOT NULL"
