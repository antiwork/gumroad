...
class AddUniqueIndexToSentAbandonedCartEmails < ActiveRecord::Migration[7.1]
  def change
    ...
    # insert — this index is what makes that rescue actually fire.
    # Run Onetime::DedupeSentAbandonedCartEmails.process first; existing duplicate rows
    # fail the index build.
