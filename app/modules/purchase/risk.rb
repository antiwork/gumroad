...
module Purchase::Risk
  ...
  private
    ...
    def check_for_past_fraudulent_ips
      ...
      return if PlatformBlock.find_active_objects(ip_addresses_to_check).count == 0
      return if PlatformBlock.find_active_objects(ip_addresses_to_check[0..2]).present? && seller.compliant?
    ...
    def past_blocked_object(object)
      object.present? && PlatformBlock.find_active_object(object).present?
    end
end
