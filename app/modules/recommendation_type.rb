...
module RecommendationType
  ...
  GUMROAD_RECENTLY_VIEWED_RECOMMENDATION = "recently_viewed"
  ...
  ALL = [
    ...
    GUMROAD_RECENTLY_VIEWED_RECOMMENDATION,
  ...
  def self.is_free_recommendation_type?(rec_typ)
    [GUMROAD_LIBRARY_RECOMMENDATION, GUMROAD_MORE_LIKE_THIS_RECOMMENDATION, WISHLIST_RECOMMENDATION, GUMROAD_RECENTLY_VIEWED_RECOMMENDATION].include?(rec_typ)
  end
end
