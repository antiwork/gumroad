...
const BlockedUserTooltip = ({ user, position = "bottom" }: Props) => {
  ...
  const content = () => (
    <div className="paragraphs">
      {blocked_by_form_email_object && blocked_by_form_email_object.blocked_at && (
      ...
      {blocked_by_form_email_domain_object && blocked_by_form_email_domain_object.blocked_at && (
