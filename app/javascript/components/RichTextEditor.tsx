...
const MenuItemTooltip = ({ tip, children, tooltipPosition }: { tip: string; children: React.ReactNode; tooltipPosition?: Position; }) => {
  ...
  return (
    <WithTooltip position={tooltipPosition} tip={showTooltip ? tip : null}>
...
export const MenuItem = ({
  ...
  <MenuItemTooltip tip={name} tooltipPosition={ tooltipPosition ?? "bottom" }>
    <button
      type="button"
