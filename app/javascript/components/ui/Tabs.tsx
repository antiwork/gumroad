...
const tabVariants = cva("", {
  ...
  compoundVariants: [
    ...
    },
    {
      variant: "buttons",
      active: true,
      // The important modifier is required: Tab wraps Button via asChild, so both class strings are
      // joined and Button's `border-border` can otherwise win the CSS-order fight.
