...
export const Layout: React.FC<{
  ...
  const logoLink = (
    <a
      ...
      className="logo-full aspect-157/22 w-[245px]! flex shrink-0 items-center"
      aria-label="Gumroad"
    />
  );
  const searchBar = (
  ...
  return (
    <div className={cx("discover", className)}>
      <header
        className="hero border-border bg-body relative z-20 border-b border-t-0 px-4 py-8 lg:pe-16 lg:ps-16"
