      ...
      <fieldset>
        ...
        <div className="input">
          ...
          <CopyToClipboard text={discoverUrl} tooltipPosition="bottom">
            <Button className="inline-block align-middle !px-3 !py-2 bg-background text-foreground border border-border !rounded-[10rem] truncate">Copy link</Button>
          </CopyToClipboard>
        </div>
        <small>
    ...
    <section className="p-4! md:p-8!">
      ...
      <fieldset className={cx({ danger: hasError })}>
        ...
        <div className="input">
          ...
          />
          <Button
            className="inline-block align-middle !px-3 !py-2 bg-background text-foreground border border-border !rounded-[10rem] truncate shrink-0 -mr-2"
            onClick={() => {
              try {
