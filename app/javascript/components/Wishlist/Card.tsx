    ...
    <ProductCard className="lg:flex-row">
      <ProductCardFigure
        className={classNames(
          ...
          // A backdrop behind thumbnails, with no text on it, so it uses the accent exactly as saved.
          wishlist.thumbnails.length > 0 && "grid gap-1 bg-accent-plain !bg-none p-2",
