  ...
  return (
    <NavFramework footer={<NavbarFooter />} {...props}>
      ...
      <NavSection>
        ...
        <ClientNavLink
          text="Workflows"
          icon={<NetworkChart pack="filled" />}
          href={Routes.workflows_url(routeParams)}
        />
        <ClientNavLink text="Sales" icon={<DollarCircle pack="filled" />} href={Routes.customers_url(routeParams)} />
        <ClientNavLink
          text="Analytics"
