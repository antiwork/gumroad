    ...
    <SectionReducerContext.Provider value={reducer}>
      <ImageUploadSettingsContext.Provider value={imageUploadSettings}>
        {sections.map((section, i) => (
          <section key={section.id} id={section.id} className="border-border border-b px-4 py-8 lg:py-16">
...
export const Layout = (
  ...
  const mainSection = (
    <section className={classNames("border-border border-b lg:py-16", props.sections.length > 0 ? "px-4 py-8" : "p-4")}>
      {productView}
    </section>
  );
