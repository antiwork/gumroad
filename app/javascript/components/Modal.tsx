    ...
    <>
      <Dialog.Content
        ...
        className={classNames(
          "bg-background fixed top-[50%] left-[50%] z-51 flex max-h-[90vh] max-w-175 min-w-80 translate-[-50%] flex-col gap-4 overflow-y-auto rounded border border-border p-8 shadow-lg dark:shadow-none",
          className,
        )}
        onOpenAutoFocus={(e) => {
