        ...
        <h2 id={id} className={classNames("flex justify-between gap-4 items-start")}>
          ...
          {allowClose ? (
            <button
              ...
              aria-label="Close"
              className={classNames(
                "text-base/[1.4rem] after:icon-x after:text-base after:content-['\u00a0'] after:inline after:bg-current after:min-h-[max(1lh,1em)] after:w-[1em] after:mask-center after:mask-size-[120%] after:mask-no-repeat after:shrink-0",
              )}
