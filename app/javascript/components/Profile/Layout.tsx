    ...
    <div className="flex min-h-screen flex-col">
      <header className="z-20 border-border bg-background text-lg lg:border-b lg:px-4 lg:py-6">
        <div className="mx-auto flex max-w-6xl flex-wrap lg:flex-nowrap lg:items-center lg:gap-6">
          <div className="relative flex grow items-center gap-3 border-b border-border px-6 py-8 lg:flex-1 lg:border-0 lg:p-0">
          ...
          {!hideFollowForm ? (
            <div className="flex basis-full items-center gap-3 border-b border-border px-6 py-8 lg:basis-auto lg:border-0 lg:p-0">
