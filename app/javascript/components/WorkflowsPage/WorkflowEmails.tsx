      ...
      {expanded ? (
        <RowDetails asChild>
          <form className="flex flex-col gap-4">
            ...
            <RichTextEditor
              id={email.id}
              className="textarea bg-background block w-full rounded border border-border px-4 py-3 text-foreground placeholder:text-muted focus-within:outline-2 focus-within:outline-offset-0 focus-within:outline-accent"
