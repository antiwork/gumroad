  ...
  return (
    ...
    >
      <button
        ...
        onClick={onClick}
        className="hover:bg-pink dark:bg-pink dark:hover:bg-pink flex items-center justify-center gap-1 overflow-hidden rounded-full border border-solid bg-black px-3 py-1.5 text-xs font-bold text-white hover:border-black hover:text-black hover:shadow-[4px_4px_#000] focus:outline-hidden dark:border-black dark:text-black dark:hover:shadow-[4px_4px_#fff]"
      >
