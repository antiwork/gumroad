...
export const SubscribePreview = ({ avatar_url, title }: Props) => (
  <div className="w-full h-full grid items-center p-8 gap-8" style={{ gridTemplateColumns: '27.5% 1fr' }}>
    ...
    <div className="grid gap-3">
      ...
      <h1 className="text-3xl leading-tight overflow-hidden" style={{ display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', fontSize: '2rem' }}>{title}</h1>
