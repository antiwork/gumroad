    ...
    {opted_in_to_au_backtax ? (
      <div className="flex flex-col gap-4">
        ...
        <p>
          ...
          <b>
            The Australian government is requiring that we go back to collect and remit these back taxes. Going forward,
            we will collect and remit these taxes on your behalf.
          </b>
        </p>
        {are_au_backtaxes_paid ? (
          <p>
