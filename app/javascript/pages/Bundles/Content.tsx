...
import { BundleEditProvider, useBundleEditProvider } from "./_BundleEditProvider";

const RESULTS_PER_PAGE = 10;

function BundleContentContent() {
  const { bundle, updateBundle, id, productsCount, hasOutdatedPurchases } = useBundleEditProvider();
  ...
  return (
    <InertiaLayout currentTab="content" preview={preview}>
