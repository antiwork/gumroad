...
function BundleShareContent() {
  const { bundle, updateBundle, uniquePermalink, taxonomies, profileSections } = useBundleEditProvider();
  ...
  return (
    <InertiaLayout currentTab="share" preview={<ProductPreview />}>
      <form>
