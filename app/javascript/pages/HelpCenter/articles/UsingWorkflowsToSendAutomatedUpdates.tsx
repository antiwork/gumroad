  ...
  return (
    <>
      <div>
        ...
        <ul>
          <li><a href="#Create-a-workflow-HRsUU">Create a workflow</a></li>
          <li><a href="#Add-emails-to-your-workflows-CWCkU">Add emails to your workflow</a>
            <ul>
              <li><a href="#Send-abandoned-cart-emails-UYdro">Send abandoned cart emails</a></li>
            </ul>
          </li>
          <li><a href="#Testing-your-workflow-z6ml8" target="_blank" rel="noreferrer">Testing your workflow</a></li>
          <li><a href="#Your-audiences-experience-ZpRZS">Your audience's experience</a></li>
        </ul>
        <hr role="separator" />
        ...
        <div className="bg-red-100 text-red-700 p-4 rounded-sm my-4">
        ...
        <ol>
          <li>Go to your <a href="https://gumroad.com/workflows">Workflows dashboard</a> and click ‘New workflow’ on the top right.</li>
        ...
        <figure><img src="https://d33v4339jhl8k0.cloudfront.net/docs/assets/5c4657ad2c7d3a66e32d763f/images/664433f2340e4261ee1c4cfe/file-yd2jarFnSR.png" alt="" /></figure>
        ...
        <figure><img src="https://lh7-us.googleusercontent.com/V99cN8giCfPK0WdNsJMiQkuR22tAQrHfz6fwV37pLFQMLzz4556b_bu3B4hItWo_36_PbfZ-yWXQqOu5LjMLz-DO_8VTbbQhfNEYXKhDp0KZqV8CekgI4q3KHj5485xdEtX457EsrGjPzxBwC3jUEuE" alt="" /></figure>
        ...
        <figure><img src="https://lh7-us.googleusercontent.com/qVayE-qc1_wcsnseHJP4ZuusXbaflRKe8TpyjC4OYYVP9La7rO8p37gw54VxjLnXBNz_tq_Bva0bndXmFkzimLZYSbLB6Enrr_gMMv7BMJXkQVMhEOTjyH89csDaoSc5QrjBACV_eu2zV9nHWApqF9o" alt="" /></figure>
        ...
        <figure><img src="https://d33v4339jhl8k0.cloudfront.net/docs/assets/5c4657ad2c7d3a66e32d763f/images/664b407972987f726dc81b5e/file-zEj6Ze1xcY.jpg" alt="" /></figure>
        ...
        <p>You can't test a workflow as part of a <a href="/help/article/62-testing-a-purchase">test purchase</a>. As a test purchase isn't a real transaction, the workflow won't be triggered.</p>
        <p>Instead, you can test the workflow by creating a 100% <a href="/help/article/128-discount-codes">Discount Code</a> and purchasing using another email address.</p>
        ...
        <p>The emails will be addressed from you (specifically, the name you have entered in your <a href="https://gumroad.com/settings/profile">profile settings</a>), but with a @gumroad.com email. Unfortunately, it is not possible to use a custom email here as of now, but any replies to these emails will be sent to your support email.</p>
        ...
        <figure><img src="https://lh7-us.googleusercontent.com/EwlQjb0XnTNv4PNpPNujb9XIUyVSZYeDMwxrElXjAab6TVgmaXdPb5s2vh6z2KM8ke7Byv0_HIAw6nJcLLF7NK4qpmXQlFETMoCjURy8bcb9fPqOKQu-sbry41KLleaqoM08DjPLb6T4wAhDLTn8XWg" alt="" /></figure>
        <p>Please follow <a href="/help/article/54-not-receiving-updates" target="_blank" rel="noreferrer">this article</a> if your customers report about not receiving workflow emails, or if you'd like to resend them.</p>
      </div>
      <div>
        <h3>Related Articles</h3>
        <ul>
          <li><a href="/help/article/82-membership-products"><span>Selling memberships and subscriptions</span></a></li>
