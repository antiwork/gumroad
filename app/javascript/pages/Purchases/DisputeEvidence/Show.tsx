...
export default function Show() {
    ...
    const { dispute_evidence, disputable, products } = pageProps;
    ...
    const handleSubmit = asyncVoid(async () => {
        try {
            ...
            const response = await request({
                method: "PUT",
                accept: "json",
                url: Routes.purchase_dispute_evidence_path(disputable.purchase_for_dispute_evidence_id),
                data: {
                    dispute_evidence: {
                        reason_for_winning:
...
function Files({
    ...
    blobs: Blobs;
    updateBlobs: React.Dispatch<React.SetStateAction<Blobs>>;
    updateSellerDisputeEvidence: (update: { customerCommunicationFileSignedBlobId: null }) => void;
    ...
    const handleFileRemove = () => {
        ...
        updateBlobs((prevBlobs) => ({ ...prevBlobs, customer_communication_file: null }));
