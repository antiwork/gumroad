...
const GumroadBlogShowPage = () => {
  const { external_id, subject, published_at, message, call_to_action } = cast<PageProps>(usePage().props);
...
GumroadBlogShowPage.loggedInUserLayout = true;

export default GumroadBlogShowPage;
