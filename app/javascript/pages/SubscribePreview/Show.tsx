...
function SubscribePreviewPage() {
  const { avatar_url, title, custom_styles } = cast<Props>(usePage().props);
...
SubscribePreviewPage.disableLayout = true;
export default SubscribePreviewPage;
