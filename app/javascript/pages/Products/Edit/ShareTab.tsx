// app/javascript/pages/Products/Edit/ShareTab.tsx
//
// Inertia page for the Share tab of the edit flow.
// Wraps the existing ShareTab component with ProductEditContext.
...
export default function ShareTabPage() {
