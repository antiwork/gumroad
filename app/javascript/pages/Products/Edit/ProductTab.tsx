// app/javascript/pages/Products/Edit/ProductTab.tsx
//
// Inertia page for the Product tab of the edit flow.
// Wraps the existing ProductTab component with ProductEditContext.
...
export default function ProductTabPage() {
