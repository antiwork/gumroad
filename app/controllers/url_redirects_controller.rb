...
class UrlRedirectsController < ApplicationController
  ...
  private
    ...
    def redirect_bundle_purchase_to_library_if_needed
      ...
      # with no member purchases would land the buyer on an empty filtered library. Let the
      # download page render the bundle's own content instead — this mirrors LibraryPresenter,
      # which shows the bundle row itself in exactly this case (gumroad-private#1585).
      return if @url_redirect.purchase.product_purchases.none?
