...
class PurchasesController < ApplicationController
  ...
  def send_invoice
    ...
    if raw_vat_id
      business_vat_id = TaxIdValidatorService.new(raw_vat_id, @chargeable.purchase_sales_tax_info.country_code, @chargeable.purchase_sales_tax_info.state_code).process ? raw_vat_id : nil
    end
