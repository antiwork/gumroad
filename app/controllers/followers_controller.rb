...
class FollowersController < ApplicationController
  ...
  def create
    ...
    return redirect_to custom_domain_subscribe_path, alert: "Sorry, something went wrong.", status: :see_other if follower.nil?
    return redirect_to custom_domain_subscribe_path, alert: follower.errors.full_messages.to_sentence, status: :see_other if follower.errors.present?
