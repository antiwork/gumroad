  ...
  def update
    ...
    begin
      ActiveRecord::Base.transaction do
        ...
        @product.save_receipt_additional_text(product_permitted_params[:receipt_additional_text]) unless product_permitted_params[:receipt_additional_text].nil?
