...
class LinksController < ApplicationController
  ...
  def show
    ...
    discount_code_from_params = params[:offer_code] || params[:code]
    presenter_props = { recommended_by: params[:recommended_by], discount_code: discount_code_from_params, quantity: (params[:quantity] || 1).to_i, layout: params[:layout], seller_custom_domain_url: }
