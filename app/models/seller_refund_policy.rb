...
class SellerRefundPolicy < RefundPolicy
  ...
  before_validation :forbid_no_refunds_on_account_policy
  ...
  private
    ...
    # a window shorter than 7 days. This lives in the model so both the settings
    # UI and the public API are covered.
    def refund_period_meets_enforcement_minimum
      return if max_refund_period_in_days.present? && max_refund_period_in_days >= MINIMUM_DIGITAL_REFUND_PERIOD_IN_DAYS
