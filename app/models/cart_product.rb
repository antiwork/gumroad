...
class CartProduct < ApplicationRecord
  ...
  validates :recurrence, presence: { if: :fixed_duration_months?, message: "is required when a fixed duration is set" }
  ...
  private
    ...
    def fixed_duration_must_be_multiple_of_recurrence_period
      ...
      if period_months && !fixed_duration_months.multiple_of?(period_months)
