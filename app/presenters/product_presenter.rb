    ...
    cancellation_discount = product.cancellation_discount_offer_code
    {
      product: {
        ...
        **ProductPresenter::InstallmentPlanProps.new(product:).props,
        ...
        available_offer_codes: product.product_and_universal_offer_codes.reject(&:is_cancellation_discount?).map do |offer_code|
          {
            id: offer_code.external_id,
            code: offer_code.code,
            display_amount: offer_code.displayed_amount_off(product.price_currency_type, with_symbol: true),
