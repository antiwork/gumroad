    ...
    default_offer_code = product.default_offer_code
    {
      product: {
        ...
        **ProductPresenter::InstallmentPlanProps.new(product:).props,
        ...
        taxonomy_attribute_values: product.seller_taxonomy_attribute_values,
        inferred_taxonomy_attribute_values: product.inferred_taxonomy_attribute_values,
      ...
      autosave_enabled: Feature.active?(:product_editor_autosave, product.user),
