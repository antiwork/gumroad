...
class ReceiptPresenter::PaymentInfo
  ...
  private
    ...
    def credit_card_note
      ...
      # Non-card methods: PayPal/Link wallets, local bank-transfer methods (UPI, iDEAL, Pix),
      # buy-now-pay-later (Klarna) and the Alipay wallet. None of them produce a credit card
      # statement line, so the note would be wrong.
      return if orderable.card_type.in?([CardType::PAYPAL, CardType::LINK, CardType::UPI, CardType::IDEAL, CardType::PIX, CardType::KLARNA, CardType::ALIPAY])
