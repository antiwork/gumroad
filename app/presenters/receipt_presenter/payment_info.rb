...
class ReceiptPresenter::PaymentInfo
  ...
  private
    ...
    def credit_card_note
      ...
      # Non-card methods: PayPal/Link wallets, local bank methods (UPI, iDEAL, Bancontact) and
      # buy-now-pay-later (Klarna). None of them produce a credit card statement line, so
      # the note would be wrong.
      return if orderable.card_type.in?([CardType::PAYPAL, CardType::LINK, CardType::UPI, CardType::IDEAL, CardType::BANCONTACT, CardType::KLARNA])
