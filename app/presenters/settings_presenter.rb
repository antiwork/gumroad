    ...
    def user_details(user_compliance_info)
      {
        ...
        individual_tax_id_entered: user_compliance_info.read_attribute(:individual_tax_id).present?,
        business_tax_id_entered: user_compliance_info.read_attribute(:business_tax_id).present?,
