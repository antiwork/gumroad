...
class UserPolicy < ApplicationPolicy
  ...
  # seller can chat with the agent, since it can read store data and propose store changes — and
  # only once the seller has earned their way in (see User#eligible_for_store_agent?).
  def use_store_agent?
    seller.eligible_for_store_agent? &&
