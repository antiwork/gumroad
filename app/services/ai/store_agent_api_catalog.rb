...
module Ai::StoreAgentApiCatalog
  ...
  ENDPOINTS = [
    ...
    ep("create_offer_code", :post, "/products/:link_id/offer_codes", "Create a discount code. universal controls product coverage, not buyer eligibility. This endpoint cannot enforce subscriber-only redemption; anyone with the code can redeem it subject to its purchase limits.", scope: "edit_products",
