...
class DisputeEvidence::GenerateUncategorizedTextService
  ...
  private
    ...
    def submission_safe_tracking_url
      # Same gate as CreateFromDisputeService#shipment_for: a shipment row predating that
      # validation can hang off a digital purchase, and its URL is shipping evidence too.
