  ...
  private
    ...
    def build_purchase(params_for_purchase)
      ...
      if purchase.offer_code.present? &&
         product.default_discount_code.present? &&
         purchase.discount_code.downcase.strip == product.default_discount_code.downcase &&
         params[:code].blank? && params[:offer_code].blank?
