  ...
  private
    ...
    def build_purchase(params_for_purchase)
      ...
      if purchase.discount_code.present?
        ...
        purchase.discount_source = "url" if purchase.offer_code.present?
      elsif (default_offer_code = product.effective_default_offer_code)
        purchase.offer_code = default_offer_code
        purchase.discount_source = "default"
        purchase.used_default_discount = true
      end
