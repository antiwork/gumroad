...
class Exports::PurchaseExportService
  PURCHASE_FIELDS = [
    ...
    "Affiliate", "Affiliate commission ($)", "Discover?", "Date of Cancellation", "Subscription End Date", "Rating", "Review",
  ...
  private
    def purchase_data(purchase)
      ...
      data = {
        ...
        "Date of Cancellation" => purchase.subscription&.user_requested_cancellation_at&.to_s,
