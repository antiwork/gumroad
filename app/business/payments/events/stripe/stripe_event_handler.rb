...
class StripeEventHandler
  ...
  ALL_HANDLED_EVENTS = %w{account.application.deauthorized account.updated capability.updated payout. charge. capital. radar. refund. payment_intent.payment_failed payment_intent.processing payment_intent.succeeded}.freeze
  ...
  private
    ...
    def handle_event_for_connected_account(stripe_connect_account_id:)
      ...
      if stripe_event["type"].start_with?("charge.", "radar.", "refund.", "payment_intent.payment_failed",
