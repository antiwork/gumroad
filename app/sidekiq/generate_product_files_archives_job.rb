...
# that changed them has returned. lock: :until_executing so a save that commits while
# a rebuild is running enqueues a follow-up; with_lock serializes the pass against saves
