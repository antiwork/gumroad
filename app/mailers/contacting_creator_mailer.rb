...
class ContactingCreatorMailer < ApplicationMailer
  ...
  def notify(purchase_id, is_preorder = false, email = nil, link_id = nil, price_cents = nil, variants = nil,
    ...
    @seller = @product.user
    @unsub_link = user_unsubscribe_url(secure_id: @seller.secure_external_id(scope: "email_unsubscribe"), email_type: :notify)
  ...
  def remind(user_id)
    ...
    @unsub_link = user_unsubscribe_url(secure_id: @seller.secure_external_id(scope: "email_unsubscribe"), email_type: :product_update)
  ...
  def seller_update(user_id)
    ...
    @unsub_link = user_unsubscribe_url(secure_id: @seller.secure_external_id(scope: "email_unsubscribe"), email_type: :seller_update)
